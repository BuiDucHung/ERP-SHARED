...
const FormSelectInfinite = (_ref, ref) => {
  ...
  return /*#__PURE__*/React.createElement(_FormSelect.default, _extends({
    onEnter: onLoadMore,
    loading: loading,
