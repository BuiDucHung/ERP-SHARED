...
!function (t, e) {
  "object" == typeof exports && "object" == typeof module ? module.exports = e(require("react-dom"), require("react"), require("lodash")) : "function" == typeof define && define.amd ? define(["react-dom", "react", "lodash"], e) : "object" == typeof exports ? exports.ChartsUtils = e(require("react-dom"), require("react"), require("lodash")) : t.ChartsUtils = e(t.ReactDOM, t.React, t._);
}(self, (t, e, r) => (() => {
  "use strict";
  ...
  function u() {
    ...
    function L(t, e) {
      function r(o, i, a, u) {
        ...
        if ("throw" !== l.type) {
          var f = l.arg,
            s = f.value;
          return s && "object" == c(s) && n.call(s, "__await") ? e.resolve(s.__await).then(function (t) {
            r("next", t, a, u);
          }, function (t) {
            r("throw", t, a, u);
    ...
    return x.prototype = w, o(_, "constructor", {
      value: w,
      configurable: !0
    }), o(w, "constructor", {
      value: x,
      configurable: !0
    }), x.displayName = s(w, f, "GeneratorFunction"), e.isGeneratorFunction = function (t) {
      var e = "function" == typeof t && t.constructor;
      return !!e && (e === x || "GeneratorFunction" === (e.displayName || e.name));
    }, e.mark = function (t) {
      return Object.setPrototypeOf ? Object.setPrototypeOf(t, w) : (t.__proto__ = w, s(t, f, "GeneratorFunction")), t.prototype = Object.create(_), t;
    }, e.awrap = function (t) {
      return {
        __await: t
      };
    }, S(L.prototype), s(L.prototype, l, function () {
      return this;
    ...
    }, S(_), s(_, f, "Generator"), s(_, a, function () {
      return this;
      ...
      constructor: C,
      reset: function (e) {
        if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(N), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t);
      },
      stop: function () {
        this.done = !0;
  ...
  var d,
    ...
    v = y.version,
    m = y.render,
    g = y.unmountComponentAtNode;
  try {
    Number((v || "").split(".")[0]) >= 18 && (d = y.createRoot);
  } catch (t) {}
  function b(t) {
    var e = y.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    e && "object" === c(e) && (e.usingClientEntryPoint = t);
  }
  ...
  function E() {
    return (E = f(u().mark(function t(e) {
      return u().wrap(function (t) {
        for (;;) switch (t.prev = t.next) {
          case 0:
            return t.abrupt("return", Promise.resolve().then(function () {
              var t;
              null === (t = e[x]) || void 0 === t || t.unmount(), delete e[x];
            }));
          case 1:
          case "end":
            return t.stop();
  ...
  function S() {
    return (S = f(u().mark(function t(e) {
      return u().wrap(function (t) {
        for (;;) switch (t.prev = t.next) {
          case 0:
            if (void 0 === d) {
  ...
  var L = new Map();
  "undefined" != typeof document && L.set("tooltip", document.createElement("div"));
  var P = function (t) {
      var e = null;
      if (arguments.length > 1 && void 0 !== arguments[1] && arguments[1]) e = L.get("tooltip");else if (e = document.createElement("div"), null != t && t.key) {
        var r = L.get(t.key);
        r ? e = r : L.set(t.key, e);
      }
      return w(t, e), e;
    ...
    T = i.n(k),
    N = function (t) {
      var e = t.loadingTemplate,
        r = t.theme,
        n = void 0 === r ? "light" : r,
        o = T().useRef(null);
      return T().useEffect(function () {
        !e && o.current && function (t) {
          if ("undefined" == typeof document) return "loading";
          var e = t.attachShadow({
              mode: "open"
            }),
            r = document.createElement("div"),
            n = document.createElement("style");
          n.innerHTML = ".loading {\n    display: inline-block;\n    position: relative;\n    width: 80px;\n    height: 80px;\n  }\n  .loading div {\n    position: absolute;\n    top: 33px;\n    width: 13px;\n    height: 13px;\n    border-radius: 50%;\n    background: #ccc;\n    animation-timing-function: cubic-bezier(0, 1, 1, 0);\n  }\n  .loading div:nth-child(1) {\n    left: 8px;\n    animation: loading1 0.6s infinite;\n  }\n  .loading div:nth-child(2) {\n    left: 8px;\n    animation: loading2 0.6s infinite;\n  }\n  .loading div:nth-child(3) {\n    left: 32px;\n    animation: loading2 0.6s infinite;\n  }\n  .loading div:nth-child(4) {\n    left: 56px;\n    animation: loading3 0.6s infinite;\n  }\n  @keyframes loading1 {\n    0% {\n      transform: scale(0);\n    }\n    100% {\n      transform: scale(1);\n    }\n  }\n  @keyframes loading3 {\n    0% {\n      transform: scale(1);\n    }\n    100% {\n      transform: scale(0);\n    }\n  }\n  @keyframes loading2 {\n    0% {\n      transform: translate(0, 0);\n    }\n    100% {\n      transform: translate(24px, 0);\n    }\n  }\n  ", r.classList.add("loading"), r.innerHTML = "<div></div><div></div><div></div><div></div>", e.appendChild(n), e.appendChild(r);
        }(o.current);
      }, []), T().createElement("div", {
        ...
        style: {
          ...
          top: 0,
          zIndex: 99,
          backgroundColor: "dark" === n ? "rgb(20, 20, 20)" : "rgb(255, 255, 255)"
        }
  ...
  var R = function (t) {
    function e() {
      ...
      return r = this, n = e, o = [].concat(a), n = A(n), (t = function (t, e) {
      ...
      }(r, D() ? Reflect.construct(n, o || [], A(r).constructor) : n.apply(r, o))).state = {
        hasError: !1
      }, t.renderError = function (e) {
        var r = t.props.errorTemplate;
        return "function" == typeof r ? r(e) : r || T().createElement("h5", null, "组件出错了，请核查后重试： ", e.message);
      }, t;
    }
    return function (t, e) {
      ...
      key: "render",
      value: function () {
        return this.state.hasError ? this.renderError(this.state.error) : T().createElement(k.Fragment, null, this.props.children);
      }
  ...
  var M,
    B = i(276),
    G = function () {
      return M || (M = document.createElement("canvas").getContext("2d")), M;
    },
    q = (0, B.memoize)(function (t) {
      var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
        ...
        c = e.fontVariant,
        u = G();
      return u.font = [a, i, c, "".concat(r, "px"), o].join(" "), u.measureText((0, B.isString)(t) ? t : "");
    }, function (t) {
      var e,
        r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
      return [t].concat((e = (0, B.values)(r), function (t) {
    ...
    U = function (t) {
      return q(t, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}).width;
    },
    z = function (t) {
      var e = q(t, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {});
