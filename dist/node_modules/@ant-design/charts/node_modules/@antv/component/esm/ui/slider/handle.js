...
var HandleIcon = /** @class */function (_super) {
  ...
  HandleIcon.prototype.render = function (attributes, container) {
    var x = attributes.x,
      ...
      iconStyle = __rest(attributes, ["x", "y", "size", "radius", "orientation", "classNamePrefix"]);
    // default handle
    var width = size;
    ...
    var rect = select(container).maybeAppendByClassName(CLASS_NAMES.iconRect, 'rect').attr('className', rectClassName).styles(__assign(__assign({}, iconStyle), {
      width: width,
      height: height,
      radius: radius,
      x: x - width / 2,
    ...
    rect.maybeAppendByClassName("".concat(CLASS_NAMES.iconLine, "-1"), 'line').attr('className', lineClassName(1)).styles(__assign({
      x1: x1,
      x2: x1,
      y1: y1,
      y2: y2
    }, iconStyle));
    rect.maybeAppendByClassName("".concat(CLASS_NAMES.iconLine, "-2"), 'line').attr('className', lineClassName(2)).styles(__assign({
      x1: x2,
      x2: x2,
      y1: y1,
      y2: y2
