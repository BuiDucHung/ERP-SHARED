...
var Navigator = /** @class */function (_super) {
  ...
  Navigator.prototype.renderController = function (container) {
    ...
    var _d = __read(splitStyle(style), 2),
      _e = _d[0],
      groupStyle = _d[1],
      size = _e.size,
      pathStyle = __rest(_e, ["size"]);
    ...
    if (classNamePrefix) {
      var prevBtnClassName = getLegendClassName(CLASS_NAMES.prevBtn.name, CLASSNAME_SUFFIX_MAP.prevBtn, classNamePrefix);
    ...
    if (classNamePrefix) {
      var nextBtnClassName = getLegendClassName(CLASS_NAMES.nextBtn.name, CLASSNAME_SUFFIX_MAP.nextBtn, classNamePrefix);
    ...
    if (classNamePrefix) {
      var pageInfoClassName = getLegendClassName(CLASS_NAMES.pageInfo.name, CLASSNAME_SUFFIX_MAP.pageInfo, classNamePrefix);
