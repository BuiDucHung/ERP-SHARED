...
var Checkbox = /** @class */function (_super) {
  ...
  function Checkbox(options) {
    return _super.call(this, options, tslib_1.__assign({
      labelText: '',
      spacing: 4,
      checked: false
    }, constant_1.LABEL_TEXT_STYLE)) || this;
  }
  Checkbox.prototype.render = function (attributes, container) {
    ...
    this.checkboxBoxShape = (0, util_1.maybeAppend)(group, '.checkbox-box', 'rect').styles(tslib_1.__assign({
      className: 'checkbox-box',
      zIndex: (group.style.zIndex || 0) - 1
    }, checkboxStyle)).node();
    (0, util_1.maybeAppend)(this.checkboxBoxShape, '.checkbox-checked', 'path').styles(tslib_1.__assign({
    ...
    var _a = getLablePosition(this.checkboxBoxShape, Number(spacing)),
      x = _a.x,
      y = _a.y;
    (0, util_1.maybeAppend)(group, '.checkbox-label', 'text').styles(tslib_1.__assign({
