...
var ChartModeHandle = /** @class */function (_super) {
  ...
  ChartModeHandle.prototype.renderBackground = function () {
    ...
    (0, util_1.select)(this).maybeAppend('background', 'rect').attr('className', 'background').styles(tslib_1.__assign({
      x: x - width / 2,
      y: y - height / 2,
      width: width,
      height: height
  ...
  ChartModeHandle.prototype.renderIcon = function () {
    ...
    (0, util_1.select)(this).maybeAppend('icon-left-line', 'line').attr('className', 'icon-left-line').styles(tslib_1.__assign({
      x1: x - diffX,
      y1: y - diffY,
      x2: x - diffX,
      y2: y + diffY
    }, style));
    (0, util_1.select)(this).maybeAppend('icon-right-line', 'line').attr('className', 'icon-right-line').styles(tslib_1.__assign({
      x1: x + diffX,
      y1: y - diffY,
      x2: x + diffX,
      y2: y + diffY
  ...
  ChartModeHandle.prototype.renderBorder = function () {
    ...
    (0, util_1.select)(this).maybeAppend('border', 'line').attr('className', 'border').styles(tslib_1.__assign({
      x1: x + xx,
      y1: y - height / 2,
      x2: x + xx,
      y2: y + height / 2
