...
exports.getDefaultTooltipStyle = getDefaultTooltipStyle;
...
function getDefaultTooltipStyle(prefixCls) {
  ...
  return _a = {}, _a[".".concat(CLASS_NAME.CONTAINER)] = {
    ...
    'align-items': 'center',
    'max-width': '216px'
  }, _a[".".concat(CLASS_NAME.NAME_LABEL)] = tslib_1.__assign({
    flex: 1
  }, TEXT_OVERFLOW_STYLE), _a[".".concat(CLASS_NAME.VALUE)] = tslib_1.__assign({
    display: 'inline-block',
    float: 'right',
    flex: 1,
    'text-align': 'right',
