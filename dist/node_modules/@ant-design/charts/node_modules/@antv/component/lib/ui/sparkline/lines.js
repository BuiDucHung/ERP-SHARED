...
var Lines = /** @class */function (_super) {
  ...
  function Lines(_a) {
    ...
    _this = _super.call(this, (0, util_1.deepMix)({}, {
      type: 'lines'
    }, tslib_1.__assign({
      style: style
    }, rest))) || this;
  ...
  Lines.prototype.renderLines = function (lines) {
    (0, util_2.select)(this.linesGroup).selectAll('.line').data(lines).join(function (enter) {
  ...
  Lines.prototype.renderAreas = function (areas) {
    (0, util_2.select)(this.linesGroup).selectAll('.area').data(areas).join(function (enter) {
