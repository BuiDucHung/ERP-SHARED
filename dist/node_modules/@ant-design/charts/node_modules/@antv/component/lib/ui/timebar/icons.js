...
var IconBase = /** @class */function (_super) {
  ...
  function IconBase(options) {
    var _this = _super.call(this, (0, util_2.deepAssign)({}, {
      style: {
  ...
  Object.defineProperty(IconBase.prototype, "iconSize", {
    get: function () {
      ...
      var _a = tslib_1.__read(this.padding, 4),
        top = _a[0],
        right = _a[1],
        bottom = _a[2],
        left = _a[3];
  ...
  IconBase.prototype.renderBackground = function () {
    ...
    this.background.attr(tslib_1.__assign({
      x: x - halfSize,
      y: y - halfSize,
      width: size,
      height: size
...
var Reset = /** @class */function (_super) {
  ...
  Reset.prototype.arcPath = function (cx, cy, radius) {
    ...
    var _b = tslib_1.__read(getPosByAngle(-5 / 4 * Math.PI), 2),
      x1 = _b[0],
      y1 = _b[1];
    var _c = tslib_1.__read(getPosByAngle(1 / 4 * Math.PI), 2),
      x2 = _c[0],
      y2 = _c[1];
  ...
  Reset.prototype.renderIcon = function () {
    ...
    (0, util_2.select)(this.icon).maybeAppend('.reset', 'path').styles({
      stroke: color,
      lineWidth: lineWidth,
...
var Range = /** @class */function (_super) {
  ...
  Range.prototype.renderIcon = function () {
    ...
    var gap = lineWidth;
    (0, util_2.select)(this.icon).maybeAppend('.left-line', 'line').styles({
      x1: x - size / 2,
      y1: y - size / 2,
      x2: x - size / 2,
      y2: y + size / 2,
    ...
    (0, util_2.select)(this.icon).maybeAppend('.right-line', 'line').styles({
      x1: x + size / 2,
      y1: y - size / 2,
      x2: x + size / 2,
      y2: y + size / 2,
    ...
    (0, util_2.select)(this.icon).maybeAppend('.left-arrow', 'line').styles({
      x1: x,
      y1: y,
      x2: x - size / 2 + gap * 2,
      y2: y,
    ...
    (0, util_2.select)(this.icon).maybeAppend('.right-arrow', 'line').styles({
      x1: x,
      y1: y,
      x2: x + size / 2 - gap * 2,
      y2: y,
...
var Value = /** @class */function (_super) {
  ...
  Value.prototype.renderIcon = function () {
    ...
    var _b = this,
      size = _b.iconSize,
      lineWidth = _b.lineWidth;
    (0, util_2.select)(this.icon).maybeAppend('.line', 'line').styles({
      x1: x,
      y1: y - size / 2,
      x2: x,
      y2: y + size / 2,
...
var LineChart = /** @class */function (_super) {
  ...
  LineChart.prototype.renderIcon = function () {
    ...
    var _c = tslib_1.__read([x - size / 2 + gap, y + size / 2 - gap * 2], 2),
      ox = _c[0],
      oy = _c[1];
    (0, util_2.select)(this.icon).maybeAppend('.coordinate', 'polyline').styles({
    ...
    (0, util_2.select)(this.icon).maybeAppend('.line', 'polyline').styles({
...
var BarChart = /** @class */function (_super) {
  ...
  BarChart.prototype.renderIcon = function () {
    ...
    var _c = tslib_1.__read([x - size / 2 + gap * 2, y + size / 2 - gap], 2),
      ox = _c[0],
      oy = _c[1];
    (0, util_2.select)(this.icon).maybeAppend('.coordinate', 'polyline').styles({
      points: getCoordinatePoints(size).map(function (_a) {
    ...
    (0, util_2.select)(this.icon).maybeAppend('.bars', 'g').selectAll('.column').data(this.data.map(function (value, index) {
      return {
        value: value,
        index: index
      };
...
var Split = /** @class */function (_super) {
  ...
  Split.prototype.renderIcon = function () {
    ...
    var _b = this,
      size = _b.iconSize,
      lineWidth = _b.lineWidth;
    (0, util_2.select)(this.icon).maybeAppend('.split', 'line').styles({
      x1: x,
      y1: y - size / 2,
      x2: x,
      y2: y + size / 2,
...
var SpeedSelect = /** @class */function (_super) {
  ...
  SpeedSelect.prototype.renderIcon = function () {
    ...
    var inheritStyle = (0, util_1.omit)(this.attributes, ['x', 'y', 'transform', 'transformOrigin', 'width', 'height', 'size', 'color', 'speed']);
    var width = (0, util_1.clamp)(iconSize, 20, Infinity);
    var height = 20;
    var style = tslib_1.__assign(tslib_1.__assign({}, inheritStyle), {
      x: x - width / 2,
      y: y - height / 2,
      width: width,
      height: height,
    ...
    (0, util_2.select)(this.icon).maybeAppend('.speed', function () {
      return new select_1.Select({
        style: style
      });
...
var ToggleIcon = /** @class */function (_super) {
  ...
  ToggleIcon.prototype.render = function () {
    ...
    var _a = this.attributes,
      ...
      restStyles = tslib_1.__rest(_a, ["onChange"]);
    (0, util_2.select)(this.icon).selectAll('.icon').data([this.currentType]).join(function (enter) {
