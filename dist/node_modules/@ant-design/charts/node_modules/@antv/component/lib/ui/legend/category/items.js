...
var CategoryItems = /** @class */function (_super) {
  ...
  CategoryItems.prototype.getGridLayout = function () {
    ...
    var _b = tslib_1.__read(this.navigatorShape, 1),
      navWidth = _b[0];
    var _c = tslib_1.__read(this.grid, 2),
      gridRow = _c[0],
      gridCol = _c[1];
  ...
  CategoryItems.prototype.getFlexLayout = function () {
    ...
    var _c = tslib_1.__read(this.grid, 2),
      gridRow = _c[0],
      gridCol = _c[1];
    var _d = tslib_1.__read([maxWidth - navWidth, maxHeight], 2),
      limitWidth = _d[0],
      limitHeight = _d[1];
    var _e = tslib_1.__read([0, 0, 0, 0, 0, 0, 0, 0], 8),
      x = _e[0],
      y = _e[1],
      page = _e[2],
      pageIndex = _e[3],
  ...
  CategoryItems.prototype.renderItems = function (container) {
    ...
    var itemClassName = (0, classname_1.getLegendClassName)(CLASS_NAMES.item.name, constant_1.CLASSNAME_SUFFIX_MAP.item, classNamePrefix);
    (0, util_2.select)(container).selectAll(CLASS_NAMES.item.class).data(this.renderData, function (d) {
      return d.id;
    }).join(function (enter) {
      return enter.append(function (_a) {
        var style = _a.style,
          rest = tslib_1.__rest(_a, ["style"]);
        return new item_1.CategoryItem({
          style: style
        }, rest);
  ...
  CategoryItems.prototype.relayoutNavigator = function () {
    ...
    var _c = tslib_1.__read(this.navigatorShape, 2),
      navWidth = _c[0],
      navHeight = _c[1];
  ...
  CategoryItems.prototype.adjustLayout = function () {
    ...
    itemsLayouts.forEach(function (_a) {
      ...
      var page = _this.pageViews.appendChild(new shapes_1.Group({
  ...
  CategoryItems.prototype.renderNavigator = function (container) {
    ...
    container.selectAll(CLASS_NAMES.navigator.class).data(['nav']).join(function (enter) {
      return enter.append(function () {
        return new navigator_1.Navigator({
          style: style
        });
