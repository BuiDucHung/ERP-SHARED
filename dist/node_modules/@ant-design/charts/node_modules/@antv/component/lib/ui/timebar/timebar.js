...
var Timebar = /** @class */function (_super) {
  ...
  function Timebar(options) {
    ...
    _this.handleSliderChange = function (values) {
      var prevValues = function () {
        ...
        if (Array.isArray(val)) return tslib_1.__spreadArray([], tslib_1.__read(val), false);
        return val;
      }();
  ...
  Timebar.prototype.setBySliderValues = function (val) {
    var _a, _b;
    var data = this.data;
    var _c = tslib_1.__read(Array.isArray(val) ? val : [0, val], 2),
      startRatio = _c[0],
      endRatio = _c[1];
  ...
  Timebar.prototype.setByTimebarValues = function (val) {
    var _a, _b, _c;
    var data = this.data;
    var _d = tslib_1.__read(Array.isArray(val) ? val : [undefined, val], 2),
      start = _d[0],
      end = _d[1];
  ...
  Object.defineProperty(Timebar.prototype, "sliderValues", {
    ...
    get: function () {
      var _a = this.states,
        values = _a.values,
        selectionType = _a.selectionType;
      var _b = tslib_1.__read(Array.isArray(values) ? values : [undefined, values], 2),
        start = _b[0],
        end = _b[1];
      var data = this.data;
      var length = data.length;
  ...
  Object.defineProperty(Timebar.prototype, "values", {
    get: function () {
      var _a = this.states,
        values = _a.values,
        selectionType = _a.selectionType;
      var _b = tslib_1.__read(Array.isArray(values) ? values : [this.data[0].time, values], 2),
        start = _b[0],
        end = _b[1];
  ...
  Object.defineProperty(Timebar.prototype, "chartHandleIconShape", {
    get: function () {
      ...
      if (selectionType === 'range') return function (type) {
        return new handle_1.ChartModeHandle({
          style: {
            type: type,
            height: height,
            iconSize: height / 6
  ...
  Timebar.prototype.getChartStyle = function (bbox) {
    ...
    var _c = (0, util_2.subStyleProps)(this.attributes, 'chart'),
      ignoreType = _c.type,
      userDefinedChartStyle = tslib_1.__rest(_c, ["type"]);
    var isRange = selectionType === 'range';
    if (type === 'time') {
      return tslib_1.__assign({
        handleIconShape: function () {
          return new handle_1.TimeModeHandle({});
        },
        ...
        formatter: function (value) {
          ...
          if (typeof time === 'number') return (0, utils_1.parseBySeries)(time);
  ...
  Timebar.prototype.getAxisStyle = function (bbox) {
    ...
    var x = bbox.x,
      ...
      width = bbox.width;
    // 需要补一个刻度
    var axisData = tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(data), false), [{
      time: 0
  ...
  Timebar.prototype.renderController = function (bbox) {
    ...
    var that = this;
    var style = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, bbox), {
      iconSize: 20,
      speed: speed,
      state: state,
      selectionType: selectionType,
  ...
  Timebar.prototype.dispatchOnChange = function (prevValues) {
    ...
    var _a = this.states,
      values = _a.values,
      selectionType = _a.selectionType;
    var _b = tslib_1.__read(values, 2),
      start = _b[0],
      end = _b[1];
  ...
  Timebar.prototype.moveSelection = function (direction, preventEvent) {
    ...
    var normalizeIndexes = function (indexes) {
      // 先进行排序
      var _a = tslib_1.__read(indexes.sort(function (a, b) {
          return a - b;
        }), 2),
        start = _a[0],
        end = _a[1];
      ...
      var clampIndex = function (index) {
        return (0, util_1.clamp)(index, 0, length);
      };
      // 如果 end 超出最大值
      if (end > length) {
        // value 模式下，重置到 0
