...
var Indicator = /** @class */function (_super) {
  ...
  Indicator.prototype.renderBackground = function () {
    ...
    var _a = this.attributes,
      ...
      padding = _a.padding;
    var _b = tslib_1.__read((0, util_1.parseSeriesAttr)(padding), 4),
      t = _b[0],
      r = _b[1],
      b = _b[2],
      l = _b[3];
    ...
    this.background = (0, util_1.select)(this.group).maybeAppendByClassName(CLASS_NAMES.background, 'path').styles(tslib_1.__assign(tslib_1.__assign({}, style), {
      d: path
    }));
  ...
  Indicator.prototype.renderLabel = function () {
    ...
    var _b = tslib_1.__read((0, util_1.splitStyle)(style), 2),
      ...
      groupStyle = _b[1],
      rawText = _c.text,
      textStyle = tslib_1.__rest(_c, ["text"]);
  ...
  Indicator.prototype.createCorner = function (edge, size) {
    ...
    var _a = tslib_1.__read(edge, 2),
      ...
      x1 = _c[0],
      y1 = _c[1];
    var _d = tslib_1.__read(isH ? [x1 - x0, [x0, x1]] : [y1 - y0, [y0, y1]], 2),
      len = _d[0],
      _e = tslib_1.__read(_d[1], 2),
      b0 = _e[0],
      b1 = _e[1];
    var hL = len / 2;
    ...
    var _f = tslib_1.__read([b0, b0 + hL - hCL, b0 + hL, b0 + hL + hCL, b1], 5),
      a0 = _f[0],
      a1 = _f[1],
      a2 = _f[2],
      a3 = _f[3],
  ...
  Indicator.prototype.applyVisibility = function () {
    ...
    if (visibility === 'hidden') (0, util_1.hide)(this);else (0, util_1.show)(this);
  };
