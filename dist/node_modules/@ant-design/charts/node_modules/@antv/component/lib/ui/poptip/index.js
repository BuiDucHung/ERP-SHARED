...
Object.defineProperty(exports, "getPositionXY", {
  enumerable: true,
  get: function () {
    return utils_2.getPositionXY;
  }
});
var Poptip = /** @class */function (_super) {
  tslib_1.__extends(Poptip, _super);
  function Poptip(options) {
    var _this = _super.call(this, (0, util_1.deepMix)({
      style: {
        id: constant_1.POPTIP_ID
      }
    ...
    var onmousemove = function (e) {
      ...
      if (callback) {
        var _a = typeof callback === 'function' ? callback.call(null, e) : callback,
          html = _a.html,
          ele = _a.target,
          restOptions = tslib_1.__rest(_a, ["html", "target"]);
      ...
      if (target) {
        var _b = e,
          clientX = _b.clientX,
          clientY = _b.clientY;
        var _c = tslib_1.__read((0, utils_1.getPositionXY)(clientX, clientY, target, position, arrowPointAtCenter, follow), 2),
          x = _c[0],
          y = _c[1];
        _this.showTip(x, y, {
          text: text,
  ...
  Poptip.prototype.unbind = function (element) {
    if (this.map.has(element)) {
      var _a = tslib_1.__read(this.map.get(element) || [], 2),
        listener1 = _a[0],
        listener2 = _a[1];
  ...
  Poptip.prototype.destroy = function () {
    var _this = this;
    var _a;
    tslib_1.__spreadArray([], tslib_1.__read(this.map.keys()), false).forEach(function (ele) {
  ...
  Poptip.prototype.setOffsetPosition = function (x, y, offset) {
    ...
    var _a = tslib_1.__read(offset, 2),
      _b = _a[0],
