...
var Component = /** @class */function (_super) {
  ...
  function Component(options, defaultStyleProps) {
    ...
    var _this = _super.call(this, (0, util_1.deepAssign)({}, {
  ...
  Object.defineProperty(Component.prototype, "offscreenGroup", {
    get: function () {
      if (!this._offscreen) this._offscreen = (0, util_1.createOffscreenGroup)(this);
  ...
  Component.prototype.getSubShapeStyle = function (attributes) {
    var x = attributes.x,
      ...
      style = tslib_1.__rest(attributes, ["x", "y", "transform", "transformOrigin", "class", "className", "zIndex"]);
    return style;
  };
  return Component;
