...
function getDefaultStyle(position, points, value, coordinate) {
  ...
  const inferDefaultStyle = (0, coordinate_1.isRadial)(coordinate) ? inferRadialStyle : (0, coordinate_1.isCircular)(coordinate) ? inferInnerCircularStyle : inferNonCircularStyle;
