...
const Slider = options => {
  ...
  return context => {
    ...
    const formatter = typeof labelFormatter === 'string' ? (0, d3_format_1.format)(labelFormatter) : labelFormatter;
...
function inferSparklineData(options, context) {
  ...
  if ((0, util_1.isArray)(options.sparklineData)) return options.sparklineData;
