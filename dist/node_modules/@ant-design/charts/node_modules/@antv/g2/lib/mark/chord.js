...
const Chord = (options, context) => {
  ...
  const {
    nodes: nodeData,
    edges: linkData
  } = (0, arc_1.Arc)(Object.assign(Object.assign(Object.assign(Object.assign({}, DEFAULT_LAYOUT_OPTIONS), {
    id: (0, utils_1.field)(nodeKey),
  ...
  const _a = (0, helper_1.subObject)(style, 'label'),
    {
      text = nodeKey
    } = _a,
  ...
  return [(0, util_1.deepMix)({}, DEFAULT_LINK_OPTIONS, {
    ...
    }, (0, helper_1.subObject)(style, 'link')),
    tooltip: linkTooltip,
