...
const dataTransform = (data, layout, encode) => {
  ...
  const root = (0, util_1.isArray)(data) ? (0, d3_hierarchy_1.stratify)().path(layout.path)(data) : (0, d3_hierarchy_1.hierarchy)(data);
...
const Pack = (markOptions, context) => {
  ...
  return (0, util_1.deepMix)({}, DEFAULT_OPTIONS, Object.assign(Object.assign({
