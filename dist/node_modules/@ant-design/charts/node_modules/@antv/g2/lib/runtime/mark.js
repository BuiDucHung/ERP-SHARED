...
function initializeMark(partialMark, partialProps, context) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const nameChannels = (0, d3_array_1.rollups)(Object.entries(encode).filter(([, value]) => (0, helper_1.defined)(value)), values => values.map(([key, options]) => Object.assign({
      name: key
    }, options)), ([key]) => {
      var _a;
...
function applyMarkTransform(mark, props, context) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const transforms = [transform_1.applyDefaults, transform_1.applyDataTransform, transform_1.flatEncode, transform_1.inferChannelsType, transform_1.maybeVisualChannel, transform_1.extractColumns, transform_1.maybeArrayField, transform_1.maybeNonAnimate, transform_1.addGuideToScale, transform_1.normalizeTooltip, transform_1.appendMarkScaleKey, ...preInference.map(useTransform), ...transform.map(useTransform), ...postInference.map(useTransform), transform_1.extractTooltip];
    let index = [];
