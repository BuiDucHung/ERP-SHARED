...
function elementSelect(root, {
  ...
  state = {},
  region = false,
  regionEleFilter = el => utils_1.VALID_FIND_BY_X_MARKS.includes(el.markType)
}) {
  var _a;
  ...
  const [appendLink, removeLink] = (0, utils_1.renderLink)(Object.assign({
    ...
    valueof,
    coordinate
  }, (0, helper_1.subObject)(state.selected, 'link')));
  const [appendBackground, removeBackground] = (0, utils_1.renderBackground)(Object.assign({
    document: root.ownerDocument,
    background,
    coordinate,
    scale,
    valueof
  }, (0, helper_1.subObject)(state.selected, 'background')));
...
function ElementSelect(_a) {
  ...
  return (context, _, emitter) => {
    ...
    return elementSelect(plotArea, Object.assign({
      ...
      coordinate,
      scale,
      state: (0, utils_1.mergeState)(options, [['selected', background ? {} : {
        lineWidth: '1',
        stroke: '#000'
      }], 'unselected']),
      background,
