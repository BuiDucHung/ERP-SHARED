...
const AxisRadar = options => {
  ...
  return context => {
    ...
    return (0, axis_1.LinearAxis)(Object.assign(Object.assign(Object.assign({}, restOptions), inferTitleTransform(options.orientation)), {
...
exports.AxisRadar.props = Object.assign(Object.assign({}, axis_1.LinearAxis.props), {
