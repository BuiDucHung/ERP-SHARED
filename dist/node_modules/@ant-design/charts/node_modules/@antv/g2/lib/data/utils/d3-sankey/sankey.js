...
function Sankey() {
  ...
  sankey.nodeId = function (_) {
    return arguments.length ? (id = typeof _ === 'function' ? _ : (0, constant_1.constant)(_), sankey) : id;
  };
  sankey.nodeAlign = function (_) {
    return arguments.length ? (align = typeof _ === 'function' ? _ : (0, constant_1.constant)(_), sankey) : align;
  };
  ...
  sankey.nodes = function (_) {
    return arguments.length ? (nodes = typeof _ === 'function' ? _ : (0, constant_1.constant)(_), sankey) : nodes;
  };
  sankey.links = function (_) {
    return arguments.length ? (links = typeof _ === 'function' ? _ : (0, constant_1.constant)(_), sankey) : links;
  };
  ...
  function computeNodeValues({
    ...
    for (const node of nodes) {
      node.value = node.fixedValue === undefined ? Math.max((0, d3_array_1.sum)(node.sourceLinks, value), (0, d3_array_1.sum)(node.targetLinks, value)) : node.fixedValue;
    }
  }
