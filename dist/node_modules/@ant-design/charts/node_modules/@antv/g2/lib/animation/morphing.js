...
function shapeToShape(from, to, timeEffect) {
  ...
  }, (0, utils_1.attributeOf)(from, keys, true)), Object.assign({
    transform: toTransform !== null && toTransform !== void 0 ? toTransform : 'none'
  }, (0, utils_1.attributeOf)(to, keys, true))];
...
function maybePath(node, d) {
  ...
  const path = new g_1.Path({
    style: Object.assign(Object.assign({}, (0, utils_1.attributeOf)(node, utils_1.attributeKeys)), {
      d
    })
  });
...
function oneToOne(shape, from, to, timeEffect) {
  ...
  const fromKeyframes = Object.assign(Object.assign({}, (0, utils_1.attributeOf)(from, utils_1.attributeKeys)), {
    opacity: fromOpacity,
    strokeOpacity: fromStrokeOpacity,
    fillOpacity: fromFillOpacity
  });
  const toKeyframes = Object.assign(Object.assign({}, (0, utils_1.attributeOf)(to, utils_1.attributeKeys)), {
    opacity: toOpacity,
...
function oneToMultiple(from, to, timeEffect, split) {
  ...
  return to.map((shape, i) => {
    const path = new g_1.Path({
      style: Object.assign({
        d: D[i]
      }, (0, utils_1.attributeOf)(from, utils_1.attributeKeys))
    });
