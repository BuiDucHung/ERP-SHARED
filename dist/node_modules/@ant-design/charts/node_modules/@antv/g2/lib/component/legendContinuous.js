...
function createColorScale(scale, defaultColor) {
  ...
  newScale.update(Object.assign(Object.assign({}, options), {
    range: [(0, g_1.parseColor)(defaultColor).toString()]
  }));
  return newScale;
}
function getLinearConfig(shape, colorScale, sizeScale, opacityScale, scales, theme) {
  ...
  const [domainMin, domainMax] = rangeOf([colorScale, sizeScale, opacityScale].filter(d => d !== undefined).find(d => !(d instanceof scale_1.Constant)));
  return Object.assign(Object.assign({}, shape), {
...
const LegendContinuous = options => {
  ...
  return ({
    ...
    const finalStyle = (0, utils_1.adaptor)(Object.assign({}, legendTheme, Object.assign(Object.assign(Object.assign({
      titleText: (0, utils_1.titleContent)(title),
      labelAlign: 'value',
      labelFormatter: typeof labelFormatter === 'string' ? d => (0, d3_format_1.format)(labelFormatter)(d.label) : labelFormatter
    }, inferContinuousConfig(scales, scale, value, options, exports.LegendContinuous, theme)), style), {
