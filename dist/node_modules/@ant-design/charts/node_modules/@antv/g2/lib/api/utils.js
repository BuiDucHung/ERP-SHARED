...
exports.MIN_CHART_HEIGHT = exports.MIN_CHART_WIDTH = exports.CALLBACK_NODE = exports.REMOVE_FLAG = exports.VIEW_KEYS = void 0;
...
exports.VIEW_KEYS = ['width', 'height', 'depth', 'padding', 'paddingLeft', 'paddingRight', 'paddingBottom', 'paddingTop', 'inset', 'insetLeft', 'insetRight', 'insetTop', 'insetBottom', 'margin', 'marginLeft', 'marginRight', 'marginTop', 'marginBottom', 'autoFit', 'theme', 'title', 'interaction'];
...
function normalizeRoot(node) {
  ...
  for (const key of exports.VIEW_KEYS) root.attr(key, node.attr(key));
  return root;
}
...
function sizeOf(options, container) {
  ...
  if (autoFit) {
    ...
    } = (0, size_1.getContainerSize)(container);
