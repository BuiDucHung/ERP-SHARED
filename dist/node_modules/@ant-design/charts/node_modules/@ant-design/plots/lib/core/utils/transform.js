...
var transformOptions = function (params) {
  ...
  var rest = (0, index_1.omit)(options, [].concat(constants_1.VIEW_OPTIONS, constants_1.CONFIG_SHAPE.map(function (item) {
    return item.key;
  })));
  var getCustomTransform = function (key) {
    var _a;
    return (_a = constants_1.SPECIAL_OPTIONS.find(function (option) {
  ...
  var transformShape = function (config) {
    Object.keys(config).forEach(function (key) {
      ...
      var exist = constants_1.CONFIG_SHAPE.find(function (item) {
        return item.key === key;
      });
      if (exist) {
        var type = exist.type,
        ...
        if (type) {
          ...
          children.push(transformConfig((0, index_1.mergeWithArrayCoverage)({}, (0, index_1.pick)(config, extendedProperties), defaultShapeConfig, {
            type: type
          }, config[key], {
