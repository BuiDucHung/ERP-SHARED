    ...
    if ((0, utils_1.isArray)(data) && data.length > 0) {
      ...
      if (sum === 0) {
        ...
        if (label) {
          ...
          (0, utils_1.set)(options, 'label', __assign(__assign({}, label), isColorField ? {} : {
            formatter: function () {
              return 0;
            }
          }));
        ...
        if (tooltip !== false) {
          if ((0, utils_1.isFunction)(tooltip)) {
            ...
            (0, utils_1.set)(options, 'tooltip', __assign(__assign({}, tooltip), {
        ...
        // 恢复默认配置
        (0, utils_1.set)(options, 'tooltip', tooltip);
        (0, utils_1.set)(options, 'label', label);
      }
    }
    return params;
  };
