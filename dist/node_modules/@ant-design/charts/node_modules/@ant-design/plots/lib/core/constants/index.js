...
/** new Chart options */
exports.CHART_OPTIONS = ['renderer', 'plugins'];
/** There is only the view layer, no need to pass it down to children */
exports.VIEW_OPTIONS = ['width', 'height', 'autoFit', 'theme', 'inset', 'insetLeft', 'insetRight', 'insetTop', 'insetBottom', 'padding', 'paddingTop', 'paddingRight', 'paddingBottom', 'paddingLeft', 'margin', 'marginTop', 'marginRight', 'marginBottom', 'marginLeft', 'depth', 'title', 'clip', 'children', 'type', 'data', 'direction', 'plugins'];
