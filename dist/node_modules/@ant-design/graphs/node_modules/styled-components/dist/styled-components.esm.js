...
var a = "undefined" != typeof process && void 0 !== process.env && (process.env.REACT_APP_SC_ATTR || process.env.SC_ATTR) || "data-styled",
  ...
  m = {},
  y = "production" !== process.env.NODE_ENV ? {
...
function g(t) {
  ...
  return "production" === process.env.NODE_ENV ? new Error("An error occurred. See https://github.com/styled-components/styled-components/blob/main/packages/styled-components/src/utils/errors.md#".concat(t, " for more information.").concat(n.length > 0 ? " Args: ".concat(n.join(", ")) : "")) : new Error(v.apply(void 0, e([y[t]], n, !1)).trim());
}
var S = 1 << 30,
  w = new Map(),
  b = new Map(),
    ...
    if ("production" !== process.env.NODE_ENV) {
      ...
      try {
        ...
        console.error = function (t) {
          for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
          _.test(t) ? (a = !1, A.delete(s)) : i.apply(void 0, e([t], n, !1));
        }, "function" == typeof r.useState && r.useState(null), a && !A.has(s) && (console.warn(s), A.add(s));
      } catch (e) {
...
var Y = "function" == typeof Symbol && Symbol.for,
  W = Y ? Symbol.for("react.memo") : 60115,
  q = Y ? Symbol.for("react.forward_ref") : 60112,
  H = {
    childContextTypes: !0,
    contextType: !0,
    contextTypes: !0,
...
function le(e, t, n) {
  ...
  if (Array.isArray(t)) for (var r = 0; r < t.length; r++) e[r] = le(e[r], t[r]);else if (ue(t)) for (var r in t) e[r] = le(e[r], t[r]);
  return e;
}
function pe(e, t) {
...
var de = function () {
  ...
  fe = new RegExp("^".concat(a, '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)')),
  me = function (e) {
...
var be = function (e) {
  ...
  Ie = function () {
    function e(e, n, r) {
      ...
      var o = this;
      this.options = t(t({}, Ae), e), this.gs = n, this.names = new Map(r), this.server = !!e.isServer, !this.server && d && _e && (_e = !1, Se(this)), pe(this, function () {
        return function (e) {
    ...
    return e.registerId = function (e) {
      ...
      void 0 === r && (r = !0);
      var o = new e(t(t({}, this.options), n), this.gs, r && this.names || void 0);
...
function Te(e) {
  ...
  for (var t = e.length, n = 0, r = 0, o = !1, s = 0; s < t; s++) {
    ...
    if (0 !== r || o || i !== Oe || e.charCodeAt(s + 1) !== De) {
      if (o) i === De && e.charCodeAt(s + 1) === Oe && (o = !1, s++);else if (34 !== i && 39 !== i || 0 !== s && 92 === e.charCodeAt(s - 1)) {
...
function xe(e) {
  var t,
    ...
    p = u.slice();
  p.push(function (e) {
    e.type === s.RULESET && e.value.includes("&") && (r || (r = new RegExp("\\".concat(n, "\\b"), "g")), e.props[0] = e.props[0].replace(Pe, n).replace(r, l));
  }), a.prefix && p.push(s.prefixer), p.push(s.stringify);
  var d = [],
    h = s.middleware(p.concat(s.rulesheet(function (e) {
      return d.push(e);
    }))),
    f = function (e, o, i, c) {
      ...
      var u = function (e) {
          ...
          for (var t = e.length, n = "", r = 0, o = 0, s = 0, i = !1, a = 0; a < t; a++) {
            ...
            if (0 !== s || i || c !== Oe || e.charCodeAt(a + 1) !== De) {
              if (i) c === De && e.charCodeAt(a + 1) === Oe && (i = !1, a++);else if (34 !== c && 39 !== c || 0 !== a && 92 === e.charCodeAt(a - 1)) {
          ...
          for (var t = e.length, n = [], r = 0, o = 0, s = 0, i = 0; o < t;) {
            ...
            if (34 !== a && 39 !== a || 0 !== o && 92 === e.charCodeAt(o - 1)) {
              if (0 === s) {
                if (a === Oe && o + 1 < t && e.charCodeAt(o + 1) === De) {
                  for (o += 2; o + 1 < t && (e.charCodeAt(o) !== De || e.charCodeAt(o + 1) !== Oe);) o++;
                  o += 2;
                } else if (40 === a && o >= 3 && 108 == (32 | e.charCodeAt(o - 1)) && 114 == (32 | e.charCodeAt(o - 2)) && 117 == (32 | e.charCodeAt(o - 3))) i = 1, o++;else if (i > 0) 41 === a ? i-- : 40 === a && i++, o++;else if (a === De && o + 1 < t && e.charCodeAt(o + 1) === Oe) o > r && n.push(e.substring(r, o)), r = o += 2;else if (a === Oe && o + 1 < t && e.charCodeAt(o + 1) === Oe) {
        ...
        l = s.compile(i || o ? "".concat(i, " ").concat(o, " { ").concat(u, " }") : u);
      return a.namespace && (l = Re(l, a.namespace)), d = [], s.serialize(l, h), d;
    };
...
var qe = function (e) {
  ...
  He = function (t) {
    ...
    for (var r in t) {
      var o = t[r];
      t.hasOwnProperty(r) && !qe(o) && (Array.isArray(o) && o.isCss || se(o) ? n.push("".concat(We(r), ":"), o, ";") : ue(o) ? n.push.apply(n, e(e(["".concat(r, " {")], He(o), !1), ["}"], !1)) : n.push("".concat(We(r), ": ").concat($e(r, o), ";")));
    }
    return n;
  };
...
var Xe = z(l),
  Ze = function () {
    function e(e, t, n) {
      this.rules = e, this.staticRulesId = "", this.isStatic = "production" === process.env.NODE_ENV && (void 0 === n || n.isStatic) && Je(e), this.componentId = t, this.baseHash = G(Xe, t), this.baseStyle = n, Ie.registerId(t);
    }
    return e.prototype.generateAndInjectStyles = function (e, t, n) {
      var r = this.baseStyle ? this.baseStyle.generateAndInjectStyles(e, t, n).className : "";
      if (this.isStatic && !n.hash) {
        if (this.staticRulesId && t.hasNameForId(this.componentId, this.staticRulesId)) r = ae(r, this.staticRulesId);else {
          var o = ce(Ue(this.rules, e, t, n)),
        ...
        for (var a = G(this.baseHash, n.hash), c = "", u = 0; u < this.rules.length; u++) {
          var l = this.rules[u];
          if ("string" == typeof l) c += l, "production" !== process.env.NODE_ENV && (a = G(a, l));else if (l) {
            var p = ce(Ue(l, e, t, n));
      ...
      return {
        className: r,
        css: "undefined" == typeof window ? t.getTag().getGroup(C(this.componentId)) : ""
      };
    }, e;
  }(),
  Ke = h ? {
  ...
  Qe = Ke.Consumer;
function et() {
  var e = h ? void 0 : r.useContext(Ke);
  if (!e) throw g(18);
  return e;
}
function tt(e) {
  if (h) return e.children;
  var n = r.useContext(Ke),
    o = r.useMemo(function () {
      return function (e, n) {
        if (!e) throw g(14);
        if (se(e)) {
          var r = e(n);
          if ("production" !== process.env.NODE_ENV && (null === r || Array.isArray(r) || "object" != typeof r)) throw g(7);
          return r;
        }
  ...
  return e.children ? r.createElement(Ke.Provider, {
    value: o
  }, e.children) : null;
}
var nt = {},
...
function ot(s, i, a) {
  var c = ie(s),
    ...
    f = void 0 === d ? P : d,
    m = i.componentId,
    y = void 0 === m ? function (e, t) {
      var n = "string" != typeof e ? "sc" : j(e);
      nt[n] = (nt[n] || 0) + 1;
      var r = "".concat(n, "-").concat(B(l + n + nt[n]));
      return t ? "".concat(t, "-").concat(r) : r;
    }(i.displayName, i.parentComponentId) : m,
    v = i.displayName,
    g = void 0 === v ? function (e) {
      return $(e) ? "styled.".concat(e) : "Styled(".concat(L(e), ")");
    }(s) : v,
    S = i.displayName && i.componentId ? "".concat(j(i.displayName), "-").concat(i.componentId) : i.componentId || y,
    w = c && u.attrs ? u.attrs.concat(f).filter(Boolean) : f,
  ...
  function A(s, i) {
    return function (s, i, a) {
      var c = s.attrs,
        u = s.componentStyle,
        l = s.defaultProps,
        p = s.foldedComponentIds,
        d = s.styledComponentId,
        f = s.target,
        m = h ? void 0 : r.useContext(Ke),
        y = ze(),
        v = s.shouldForwardProp || y.shouldForwardProp;
      "production" !== process.env.NODE_ENV && r.useDebugValue && r.useDebugValue(d);
      var g = D(i, m, l) || (h ? void 0 : O),
        S = function (e, n, r) {
          for (var o, s = t(t({}, n), {
              className: void 0,
              theme: r
      ...
      var E = function (e, t) {
        ...
        _ = E.className;
      "production" !== process.env.NODE_ENV && s.warnTooManyClasses && s.warnTooManyClasses(_);
      var A = ae(p, d);
      ...
      if (h) {
        for (var P = [], R = u, x = function () {
            ...
            if (e) {
              var t = "",
                n = y.styleSheet.names.get(R.componentId);
              n && n.forEach(function (e) {
                t && (t += "_"), t += e;
              }), P.push(r.createElement("style", {
        ...
        if (P.length) return P.reverse(), r.createElement.apply(r, e(e([r.Fragment, null], P, !1), [I], !1));
      }
      return I;
    }(R, s, i);
  }
  ...
  }), "production" !== process.env.NODE_ENV && (I(g, S), R.warnTooManyClasses = function (e, t) {
    var n = {},
      r = !1;
    return function (o) {
...
function at(t) {
  for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
  if (se(t) || ue(t)) return it(Ue(st(P, e([t], n, !0))));
  var o = t;
...
function ct(n, r, o) {
  ...
  var s = function (t) {
    ...
    return n(r, o, at.apply(void 0, e([t], s, !1)));
  };
...
var pt = function () {
  ...
  return e.prototype.createStyles = function (e, t, n, r) {
    var o = r(ce(Ue(this.rules, t, n, r)), ""),
...
function dt(n) {
  ...
  var i = at.apply(void 0, e([n], o, !1)),
    a = "sc-global-".concat(B(JSON.stringify(i))),
    c = new pt(i, a);
  "production" !== process.env.NODE_ENV && I(a);
  var u = new WeakMap(),
    l = function (e) {
      var n = ze(),
        o = h ? void 0 : r.useContext(Ke),
        s = u.get(n.styleSheet);
      if (void 0 === s && (s = n.styleSheet.allocateGSInstance(a), u.set(n.styleSheet, s)), "production" !== process.env.NODE_ENV && r.Children.count(e.children) && console.warn("The global style component ".concat(a, " was given child JSX. createGlobalStyle does not render children.")), "production" !== process.env.NODE_ENV && i.some(function (e) {
        ...
        if (c.isStatic) c.renderStyles(e, m, r, s);else {
          var i = t(t({}, n), {
        ...
        var p = a + s,
          d = "undefined" == typeof window ? n.styleSheet.getTag().getGroup(C(p)) : "";
        if (d) return r.createElement("style", {
...
function ht(t) {
  ...
  var o = ce(at.apply(void 0, e([t], n, !1))),
    s = B(o);
  return new Le(s, o);
}
function ft(e) {
  var n = r.forwardRef(function (n, o) {
    var s = D(n, h ? void 0 : r.useContext(Ke), e.defaultProps);
    return "production" !== process.env.NODE_ENV && void 0 === s && console.warn('[withTheme] You are not using a ThemeProvider nor passing a theme prop or a theme in defaultProps in component class "'.concat(L(e), '"')), r.createElement(e, t(t({}, n), {
      theme: s,
      ref: o
    }));
  });
  ...
  yt = function () {
    function e() {
      ...
      this._emitSheetCSS = function () {
        ...
        if (!t) return "";
        var n = we(),
          r = ce([n && 'nonce="'.concat(n, '"'), "".concat(a, '="true"'), "".concat(u, '="').concat(l, '"')].filter(Boolean), " ");
        ...
        var s = ((n = {})[a] = "", n[u] = l, n.dangerouslySetInnerHTML = {
          ...
          i = we();
        return i && (s.nonce = i), [r.createElement("style", t({}, s, {
          key: "sc-0-0"
        }))];
      }, this.seal = function () {
        e.sealed = !0;
