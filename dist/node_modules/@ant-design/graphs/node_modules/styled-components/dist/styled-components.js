(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react')) : typeof define === 'function' && define.amd ? define(['react'], factory) : (global = global || self, global.styled = factory(global.React));
})(this, function (React) {
  'use strict';
  ...
  ***************************************************************************** */
  ...
  var isShadowRoot = function (node) {
    return typeof ShadowRoot !== 'undefined' && node instanceof ShadowRoot || 'host' in node &&
  ...
  var outputSheet = function (sheet) {
    ...
    var _loop_1 = function (group) {
      ...
      if (names === undefined || !names.size) return "continue";
      var rules = tag.getGroup(group);
      if (rules.length === 0) return "continue";
  ...
  function re(e) {
    while (J = U()) if (J < 33) T();else break;
    return X(e) > 2 || X(J) > 3 ? "" : " ";
  }
  function ce(e, r) {
  ...
  function ie(e, r, a, c, n, s, t, u, i) {
    ...
    while (w) switch (b = g, g = T()) {
      ...
      case 0:
        switch (g) {
          ...
          default:
            ...
            if (g === 123) if (o === 0) ie(z, r, j, j, x, s, l, u, y);else {
              switch (p) {
                case 99:
                  if (A(z, 3) === 110) break;
                case 108:
              ...
              if (o) ie(e, j, j, c && B(fe(e, j, j, 0, 0, n, u, k, n, x = [], l, y), y), n, y, l, u, c ? x : y);else ie(z, j, j, j, [""], y, 0, u, y);
            }
        }
      ...
      case 58:
        l = 1 + S(z), v = b;
      default:
        if (h < 1) if (g == 123) --h;else if (g == 125 && h++ == 0 && R() == 125) continue;
        switch (z += m(g), g * h) {
          case 38:
            d = o > 0 ? 1 : (z += "\f", -1);
            break;
      ...
      case n:
        if (c.length) return D(u = c.props, function (n) {
          switch (z(n, i = /(::plac\w+|:read-\w+)/)) {
            ...
            case "::placeholder":
              P(N(c, {
                props: [C(n, /:(plac\w+)/, ":" + a + "input-$1")]
              }));
              P(N(c, {
                props: [C(n, /:(plac\w+)/, ":" + r + "$1")]
              }));
              P(N(c, {
  ...
  function stripLineComments(css) {
    ...
    while (i < len) {
      ...
      if (code === OPEN_PAREN && i >= 3 && (css.charCodeAt(i - 1) | 32) === 108 &&
      // l
      ...
      if (urlDepth > 0) {
        if (code === CLOSE_PAREN) urlDepth--;else if (code === OPEN_PAREN) urlDepth++;
        i++;
        continue;
      }
  ...
  function createStylisInstance(_a) {
    ...
    var selfReferenceReplacer = function (match, offset, string) {
       ...
       */
      string.startsWith(_selector) && string.endsWith(_selector) && string.replaceAll(_selector, '').length > 0) {
    ...
    var _stack = [];
    var _middleware = he(middlewares.concat(we(function (value) {
  ...
  function StyleSheetManager(props) {
    ...
    var styleSheetContextValue = React.useMemo(function () {
      return {
  ...
  function isPlainObject(x) {
    return x !== null && typeof x === 'object' && x.constructor.name === Object.name && /* check for reasonable markers that the object isn't an element for react & preact/compat */
    !('props' in x && x.$$typeof);
  }
  ...
  function flatten(chunk, executionContext, styleSheet, stylisInstance, result) {
    ...
    if (isFunction(chunk)) {
      if (isStatelessFunction(chunk) && executionContext) {
        ...
        if (typeof fnResult === 'object' && !Array.isArray(fnResult) && !(fnResult instanceof Keyframes) && !isPlainObject(fnResult) && fnResult !== null) {
    ...
    if (isPlainObject(chunk)) {
      ...
      for (var i = 0; i < cssArr.length; i++) result.push(cssArr[i]);
      return result;
    }
  ...
  var ServerStyleSheet = /** @class */function () {
    function ServerStyleSheet() {
      ...
      this._emitSheetCSS = function () {
        ...
        if (!css) return '';
        var nonce = getNonce();
        var attrs = [nonce && "nonce=\"".concat(nonce, "\""), "".concat(SC_ATTR, "=\"true\""), "".concat(SC_ATTR_VERSION, "=\"").concat(SC_VERSION, "\"")];
      ...
      this.getStyleElement = function () {
        ...
        var css = _this.instance.toString();
        if (!css) return [];
        var props = (_a = {}, _a[SC_ATTR] = '', _a[SC_ATTR_VERSION] = SC_VERSION, _a.dangerouslySetInnerHTML = {
          __html: css
        }, _a);
        var nonce = getNonce();
        if (nonce) {
        ...
        return [React.createElement("style", __assign({}, props, {
          key: "sc-0-0"
        }))];
      };
      this.seal = function () {
  ...
  var ComponentStyle = /** @class */function () {
    ...
    ComponentStyle.prototype.generateAndInjectStyles = function (executionContext, styleSheet, stylis) {
      var names = this.baseStyle ? this.baseStyle.generateAndInjectStyles(executionContext, styleSheet, stylis).className : '';
      ...
      var generatedCSS = typeof window === 'undefined' ? styleSheet.getTag().getGroup(getGroupForId(this.componentId)) : '';
      return {
        className: names,
        css: generatedCSS
      };
  ...
  function useStyledComponentImpl(forwardedComponent, props, forwardedRef) {
    ...
    for (var key in context) {
      ...
      if (context[key] === undefined) ;else if (key[0] === '$' || key === 'as' || key === 'theme' && context.theme === theme) ;else if (key === 'forwardedAs') {
        propsForElement.as = context.forwardedAs;
      } else if (!shouldForwardProp || shouldForwardProp(key, elementToBeCreated)) {
        // @ts-expect-error context may have arbitrary properties from attrs
        propsForElement[key] = context[key];
        if (!shouldForwardProp && "development" === 'development' && !isPropValid(key) && !seenUnknownProps.has(key) &&
    ...
    var _a = useInjectedStyle(componentStyle, context),
      generatedClassName = _a.className;
    ...
    isTag(elementToBeCreated) && !domElements.has(elementToBeCreated) ? 'class' : 'className'] = classString;
  ...
  function createStyledComponent(target, options, rules) {
    ...
    var _a = options.attrs,
      attrs = _a === void 0 ? EMPTY_ARRAY : _a,
      _b = options.componentId,
      componentId = _b === void 0 ? generateId(options.displayName, options.parentComponentId) : _b,
      _c = options.displayName,
      displayName = _c === void 0 ? generateDisplayName(target) : _c;
    ...
    WrappedStyledComponent.foldedComponentIds = isTargetStyledComp ? joinStrings(styledComponentTarget.foldedComponentIds, styledComponentTarget.styledComponentId) : '';
    ...
    setToString(WrappedStyledComponent, function () {
