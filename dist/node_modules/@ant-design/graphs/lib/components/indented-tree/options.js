...
exports.DEFAULT_OPTIONS = {
  ...
  transforms: prev => [...prev, {
    ...
    iconRender: function (isCollapsed, data) {
      return react_1.default.createElement(ArrowCountIcon, {
        graph: this,
        data: data,
      ...
      node: {
        style: {
          component: function (data) {
            ...
            const {
              font
            } = (0, tree_1.getBoxedTextNodeStyle)(label, minWidth, maxWidth, depth);
            const props = {
            ...
            return react_1.default.createElement(TextNode, {
              ...props
            });
          },
          size: data => {
      ...
      node: {
        style: {
          component: function (data) {
            ...
            const {
              font
            } = (0, tree_1.getLinearTextNodeStyle)(label, minWidth, maxWidth, depth);
            const props = {
              text: label,
              color,
              maxWidth,
