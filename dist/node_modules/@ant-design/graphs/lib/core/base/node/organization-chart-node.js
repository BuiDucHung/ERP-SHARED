...
const OrganizationChartNode = props => {
  ...
  return react_1.default.createElement(StyledWrapper, {
    ...
    className: "org-chart-node-line"
  }), react_1.default.createElement("div", {
    className: "org-chart-node-content"
  }, react_1.default.createElement("div", {
    className: "org-chart-node-content-avatar"
  }, name.slice(0, 1)), react_1.default.createElement("div", {
    className: "org-chart-node-content-detail"
  }, react_1.default.createElement("div", {
    className: "org-chart-node-content-name"
  }, name), position && react_1.default.createElement("div", {
    className: "org-chart-node-content-post"
  }, position))));
};
