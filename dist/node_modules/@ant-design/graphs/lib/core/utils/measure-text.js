 ...
 */
function measureTextSize(text, offset = [0, 0], font = {
  fontSize: 16,
  fontFamily: 'PingFang SC'
}, minWidth = 0, maxWith = Infinity) {
  const height = (0, charts_util_1.measureTextHeight)(text, font);
  const width = (0, charts_util_1.measureTextWidth)(text, font) + 4;
