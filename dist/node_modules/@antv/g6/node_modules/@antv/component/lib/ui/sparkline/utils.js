...
function getRange(data) {
  ...
  return [(0, util_1.min)((0, util_1.minBy)(data, function (arr) {
    return (0, util_1.min)(arr) || 0;
  })), (0, util_1.max)((0, util_1.maxBy)(data, function (arr) {
    return (0, util_1.max)(arr) || 0;
  }))];
}
/**
 * 数据转换为堆叠数据
...
function getStackedData(_) {
  ...
  // 上一个堆叠的数据值，分别记录正负
  var _a = tslib_1.__read([Array(datumLen).fill(0), Array(datumLen).fill(0)], 2),
    positivePrev = _a[0],
    negativePrev = _a[1];
