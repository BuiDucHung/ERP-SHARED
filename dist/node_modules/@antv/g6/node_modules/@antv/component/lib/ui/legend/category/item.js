...
var CategoryItem = /** @class */function (_super) {
  ...
  Object.defineProperty(CategoryItem.prototype, "actualSpace", {
    get: function () {
      ...
      var _a = this.attributes,
        ...
        focus = _a.focus,
        focusMarkerSize = _a.focusMarkerSize;
      var _b = label.node().getBBox(),
        labelWidth = _b.width,
        labelHeight = _b.height;
      var _c = value.node().getBBox(),
        valueWidth = _c.width,
        valueHeight = _c.height;
  ...
  Object.defineProperty(CategoryItem.prototype, "span", {
    get: function () {
      ...
      if (!span) return [1, 1];
      var _a = tslib_1.__read((0, util_2.parseSeriesAttr)(span), 2),
        span1 = _a[0],
        innerSpan = _a[1];
  ...
  Object.defineProperty(CategoryItem.prototype, "spacing", {
    get: function () {
      ...
      var _b = tslib_1.__read((0, util_2.parseSeriesAttr)(spacing), 3),
        spacing1 = _b[0],
        spacing2 = _b[1],
        spacing3 = _b[2];
  ...
  Object.defineProperty(CategoryItem.prototype, "layout", {
    get: function () {
      var _a = this.shape,
        ...
        width = _a.width,
        height = _a.height;
      var _b = tslib_1.__read(this.spacing, 3),
        spacing1 = _b[0],
        spacing2 = _b[1],
        spacing3 = _b[2];
      return {
        ...
        valueWidth: valueWidth,
        focusWidth: focusWidth,
        position: [markerWidth / 2, markerWidth + spacing1, markerWidth + labelWidth + spacing1 + spacing2, markerWidth + labelWidth + valueWidth + spacing1 + spacing2 + spacing3 + focusWidth / 2]
      };
    },
    enumerable: false,
    configurable: true
  ...
  CategoryItem.prototype.renderMarker = function (container) {
    ...
    var style = (0, util_2.subStyleProps)(this.attributes, 'marker');
    ...
    (0, util_2.ifShow)(!!marker, this.markerGroup, function () {
      ...
      var markerClassName = (0, classname_1.getLegendClassName)(CLASS_NAMES.marker.name, constant_1.CLASSNAME_SUFFIX_MAP.marker, classNamePrefix);
      var newMarker = typeof marker === 'string' ? new marker_1.Marker({
        style: {
          symbol: marker
        },
      ...
      if (!oldMarker) {
        if (!(newMarker instanceof marker_1.Marker)) {
          var markerClassName_1 = (0, classname_1.getLegendClassName)(CLASS_NAMES.marker.name, constant_1.CLASSNAME_SUFFIX_MAP.marker, classNamePrefix);
          newMarker.className = markerClassName_1;
          (0, util_2.select)(newMarker).styles(style);
        }
        parent.appendChild(newMarker);
      } else if (newMarker.nodeName === oldMarker.nodeName) {
        if (oldMarker instanceof marker_1.Marker) oldMarker.update(tslib_1.__assign(tslib_1.__assign({}, style), {
          symbol: marker
        }));else {
          (0, util_2.copyAttributes)(oldMarker, newMarker);
          (0, util_2.select)(oldMarker).styles(style);
        }
      } else {
        oldMarker.remove();
        if (!(newMarker instanceof marker_1.Marker)) {
          var markerClassName_2 = (0, classname_1.getLegendClassName)(CLASS_NAMES.marker.name, constant_1.CLASSNAME_SUFFIX_MAP.marker, classNamePrefix);
      ...
      var scale = (0, util_2.scaleToPixel)(_this.markerGroup.node(), _this.scaleSize, true);
      _this.markerGroup.node().style._transform = "scale(".concat(scale, ")");
    });
  };
  CategoryItem.prototype.renderLabel = function (container) {
    var _a = (0, util_2.subStyleProps)(this.attributes, 'label'),
      label = _a.text,
      style = tslib_1.__rest(_a, ["text"]);
    ...
    var labelClassName = (0, classname_1.getLegendClassName)(CLASS_NAMES.label.name, constant_1.CLASSNAME_SUFFIX_MAP.label, classNamePrefix);
    var labelElement = this.labelGroup.maybeAppendByClassName(CLASS_NAMES.label, function () {
      return (0, util_2.renderExtDo)(label);
    });
  ...
  CategoryItem.prototype.renderValue = function (container) {
    var _this = this;
    var _a = (0, util_2.subStyleProps)(this.attributes, 'value'),
      value = _a.text,
      style = tslib_1.__rest(_a, ["text"]);
    var classNamePrefix = this.attributes.classNamePrefix;
    ...
    (0, util_2.ifShow)(this.showValue, this.valueGroup, function () {
      var valueClassName = (0, classname_1.getLegendClassName)(CLASS_NAMES.value.name, constant_1.CLASSNAME_SUFFIX_MAP.value, classNamePrefix);
      var valueElement = _this.valueGroup.maybeAppendByClassName(CLASS_NAMES.value, function () {
        return (0, util_2.renderExtDo)(value);
      });
  ...
  CategoryItem.prototype.createPoptip = function () {
    ...
    var _a = poptip || {},
      render = _a.render,
      poptipStyle = tslib_1.__rest(_a, ["render"]);
    var poptipGroup = new poptip_1.Poptip({
      style: (0, util_2.deepAssign)(DEFAULT_POPTIP_PROPS, poptipStyle)
    });
  ...
  CategoryItem.prototype.bindPoptip = function (node) {
    ...
    poptipGroup.bind(node, function () {
      ...
      if (typeof poptip.render === 'function') {
        return {
          html: poptip.render(tslib_1.__assign(tslib_1.__assign({}, _this.keyFields), {
            label: label,
            value: value,
            color: markerFill
          }))
  ...
  CategoryItem.prototype.renderFocus = function (ctn) {
    ...
    if ((0, util_1.isUndefined)(focus)) return;
    this.focusGroup = ctn.maybeAppendByClassName(CLASS_NAMES.focusGroup, 'g').style('zIndex', 0);
    (0, util_2.ifShow)(focus, this.focusGroup, function () {
      var focusClassName = (0, classname_1.getLegendClassName)(CLASS_NAMES.focus.name, constant_1.CLASSNAME_SUFFIX_MAP.focusIcon, classNamePrefix);
      var marker = new marker_1.Marker({
        style: tslib_1.__assign(tslib_1.__assign({}, defaultOptions), {
          symbol: 'focus'
        }),
        className: focusClassName
      });
      var interactiveCircle = new g_1.Circle({
        style: {
  ...
  CategoryItem.prototype.renderBackground = function (container) {
    var _a = this.shape,
      width = _a.width,
      height = _a.height;
    var style = (0, util_2.subStyleProps)(this.attributes, 'background');
    ...
    backgroundElement.styles(tslib_1.__assign({
      width: width,
      height: height
    }, style));
    var _b = this.attributes.classNamePrefix,
      classNamePrefix = _b === void 0 ? '' : _b;
    if (classNamePrefix) {
      var backgroundClassName = (0, classname_1.getLegendClassName)(CLASS_NAMES.background.name, constant_1.CLASSNAME_SUFFIX_MAP.background, classNamePrefix);
  ...
  CategoryItem.prototype.adjustLayout = function () {
    var _a = this.layout,
      ...
      valueWidth = _a.valueWidth,
      height = _a.height,
      _b = tslib_1.__read(_a.position, 4),
      markerX = _b[0],
      labelX = _b[1],
      valueX = _b[2],
      focusX = _b[3];
    ...
    (0, util_2.ellipsisIt)(this.labelGroup.select(CLASS_NAMES.label.class).node(), Math.ceil(labelWidth));
    if (this.showValue) {
      this.valueGroup.styles({
        transform: "translate(".concat(valueX, ", ").concat(halfHeight, ")")
      });
      (0, util_2.ellipsisIt)(this.valueGroup.select(CLASS_NAMES.value.class).node(), Math.ceil(valueWidth));
    }
  };
