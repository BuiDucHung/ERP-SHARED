...
exports.OverlapUtils = new Map([['hide', autoHide_1.default], ['rotate', autoRotate_1.default], ['ellipsis', autoEllipsis_1.default], ['wrap', autoWrap_1.default]]);
function canProcessOverlap(labels, attr, type) {
  if (attr.labelOverlap.length < 1) return false;
  if (type === 'hide') return !(0, util_1.isInOffscreenGroup)(labels[0]);
