...
var LineCrosshair = /** @class */function (_super) {
  ...
  Object.defineProperty(LineCrosshair.prototype, "crosshairPath", {
    get: function () {
      var _a = this.attributes,
        _b = tslib_1.__read(_a.startPos, 2),
        sx = _b[0],
        sy = _b[1],
        _c = tslib_1.__read(_a.endPos, 2),
        ex = _c[0],
        ey = _c[1];
  ...
  Object.defineProperty(LineCrosshair.prototype, "localPointer", {
    ...
    get: function () {
      ...
      var _a = tslib_1.__read(this.getPosition(), 2),
        bx = _a[0],
        by = _a[1];
      var _b = tslib_1.__read(this.pointer, 2),
        x = _b[0],
        y = _b[1];
      return [x - bx, y - by];
    },
  ...
  Object.defineProperty(LineCrosshair.prototype, "tagShapeSpace", {
    get: function () {
      var _a = (0, util_1.getShapeSpace)(this.tagShape),
        width = _a.width,
        height = _a.height;
      return {
        width: width,
  ...
  LineCrosshair.prototype.adjustPosition = function () {
    var _a = tslib_1.__read(this.localPointer, 2),
      lx = _a[0],
      ly = _a[1];
    var _b = tslib_1.__read(this.attributes.startPos, 2),
      sx = _b[0],
      sy = _b[1];
