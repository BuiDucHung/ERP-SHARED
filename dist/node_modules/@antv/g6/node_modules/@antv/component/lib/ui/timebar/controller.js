...
var Controller = /** @class */function (_super) {
  ...
  Controller.prototype.renderFunctions = function () {
    ...
    var _b = this.attributes,
      ...
      height = _b.height,
      align = _b.align;
    var _c = tslib_1.__read(this.padding, 4),
      right = _c[1],
      left = _c[3];
    ...
    components.forEach(function (name, index) {
      ...
      if (Ctor === icons_1.SpeedSelect) {
        ...
        if (Ctor === icons_1.PlayPause) style.type = _this.attributes.state === 'play' ? 'pause' : 'play';
        if (Ctor === icons_1.SelectionType) style.type = _this.attributes.selectionType === 'range' ? 'value' : 'range';
        if (Ctor === icons_1.ChartType) style.type = _this.attributes.chartType === 'line' ? 'column' : 'line';
      } else {
        // IconBase
      ...
      if (Ctor === icons_1.SpeedSelect) {
        ...
        if (canvas) {
          _this.speedSelect = new Ctor({
            style: tslib_1.__assign(tslib_1.__assign({}, style), {
              zIndex: 100
            })
          });
