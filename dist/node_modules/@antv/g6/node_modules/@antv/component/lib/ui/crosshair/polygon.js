...
var PolygonCrosshair = /** @class */function (_super) {
  ...
  PolygonCrosshair.prototype.setPointer = function (_a) {
    ...
    var _c = tslib_1.__read(this.localPointer, 2),
      lx = _c[0],
      ly = _c[1];
    var center = this.attributes.center;
    // 求交点
    var _d = tslib_1.__read(this.intersection([lx, ly]), 2),
      ix = _d[0],
      iy = _d[1];
    if (!ix || !iy) return;
  ...
  PolygonCrosshair.prototype.createPolygonPath = function (radius) {
    ...
    var path = this.points.map(function (_a, index) {
      var _b = tslib_1.__read(_a, 2),
        x = _b[0],
        y = _b[1];
      var _c = tslib_1.__read((0, util_1.scale)([x, y], radius || defaultRadius), 2),
        tx = _c[0],
        ty = _c[1];
  ...
  PolygonCrosshair.prototype.intersection = function (_a) {
    ...
    var _d = tslib_1.__read(this.attributes.center, 2),
      cx = _d[0],
      cy = _d[1];
    var ix;
    var iy;
    ...
    for (var i = 1; i <= points.length; i += 1) {
      var _e = tslib_1.__read(points[i - 1], 2),
        sx = _e[0],
        sy = _e[1];
      var _f = tslib_1.__read(points[i % points.length], 2),
        ex = _f[0],
        ey = _f[1];
