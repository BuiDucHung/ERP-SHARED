...
var Breadcrumb = /** @class */function (_super) {
  ...
  Breadcrumb.prototype.render = function (attributes, container) {
    ...
    var _b = tslib_1.__read((0, util_2.parseSeriesAttr)(padding), 3),
      top = _b[0],
      right = _b[1],
      left = _b[2];
    ...
    var _loop_1 = function (i) {
      ...
      var shape = new tag_1.Tag({
        ...
        style: tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({
          transform: "translate(".concat(cursorX, ", ").concat(cursorY, ")")
        }, tagStyle), {
          text: (0, util_1.isNil)(datum.text) ? datum.id : datum.text
        }), (0, util_1.pick)(datum, ['marker'])), {
          // 强制不需要背景
          padding: 0
        })
      });
      ...
      if (!(0, util_1.isNil)(width)) {
        ...
        if (cursorX > avaliableWidth) {
          shape.attr({
            transform: "translateY(".concat(cursorY + shapeH, ")")
          });
          // 更新光标
          cursorX = shapeW;
          cursorY += shapeH;
      ...
      if (i !== items.length - 1) {
        var shape_1 = new shapes_1.Text({
          ...
          style: tslib_1.__assign(tslib_1.__assign({
            x: cursorX + spacing,
            y: cursorY + shapeH / 2
          }, style), {
            text: text,
