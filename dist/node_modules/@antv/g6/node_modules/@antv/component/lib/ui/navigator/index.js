...
var classname_map_1 = require("../legend/classname-map");
var classname_1 = require("../legend/utils/classname");
...
var Navigator = /** @class */function (_super) {
  ...
  function Navigator(options) {
    ...
    _this.contentGroup = _this.appendChild(new shapes_1.Group({
      class: CLASS_NAMES.contentGroup.name
    }));
    _this.playWindow = _this.contentGroup.appendChild(new shapes_1.Group({
  ...
  Object.defineProperty(Navigator.prototype, "pageShape", {
    get: function () {
      ...
      var _a = tslib_1.__read((0, util_2.transpose)(pageViews.map(function (pageView) {
          ...
          return Math.max.apply(Math, tslib_1.__spreadArray([], tslib_1.__read(arr), false));
        }), 2),
        maxWidth = _a[0],
        maxHeight = _a[1];
  ...
  Navigator.prototype.goTo = function (pageNum) {
    ...
    var _b = tslib_1.__read(this.getFollowingPageDiff(pageNum), 2),
      dx = _b[0],
      dy = _b[1];
    this.playState = 'running';
    var animation = (0, animation_1.animate)(playWindow, [{
  ...
  Navigator.prototype.setVisiblePages = function (pages) {
    this.playWindow.children.forEach(function (page, index) {
      if (pages.includes(index)) (0, util_2.show)(page);else (0, util_2.hide)(page);
    });
  };
  Navigator.prototype.adjustControllerLayout = function () {
    ...
    var _c = pageNum.getBBox(),
      pW = _c.width,
      pH = _c.height;
    var _d = tslib_1.__read(orientation === 'horizontal' ? [-180, 0] : [-90, 90], 2),
      r1 = _d[0],
      r2 = _d[1];
    ...
    var _g = orientation === 'horizontal' ? {
      ...
      _h = tslib_1.__read(_g.offset, 3),
      _j = tslib_1.__read(_h[0], 2),
      o1x = _j[0],
      o1y = _j[1],
      _k = tslib_1.__read(_h[1], 2),
      o2x = _k[0],
      o2y = _k[1],
      _l = tslib_1.__read(_h[2], 2),
      o3x = _l[0],
      o3y = _l[1],
  ...
  Navigator.prototype.renderController = function (container) {
    ...
    var _a = this.attributes,
      spacing = _a.controllerSpacing,
      _b = _a.classNamePrefix,
      classNamePrefix = _b === void 0 ? '' : _b;
    var _c = this.pageShape,
    ...
    var _d = tslib_1.__read((0, util_2.splitStyle)(style), 2),
      _e = _d[0],
      groupStyle = _d[1],
      size = _e.size,
      pathStyle = tslib_1.__rest(_e, ["size"]);
    ...
    if (classNamePrefix) {
      var prevBtnClassName = (0, classname_1.getLegendClassName)(CLASS_NAMES.prevBtn.name, classname_map_1.CLASSNAME_SUFFIX_MAP.prevBtn, classNamePrefix);
    ...
    if (classNamePrefix) {
      var nextBtnClassName = (0, classname_1.getLegendClassName)(CLASS_NAMES.nextBtn.name, classname_map_1.CLASSNAME_SUFFIX_MAP.nextBtn, classNamePrefix);
      nextBtn.node().setAttribute('class', nextBtnClassName);
    }
    [prevBtn, nextBtn].forEach(function (btn) {
      btn.styles(tslib_1.__assign(tslib_1.__assign({}, pathStyle), {
    ...
    if (classNamePrefix) {
      var pageInfoClassName = (0, classname_1.getLegendClassName)(CLASS_NAMES.pageInfo.name, classname_map_1.CLASSNAME_SUFFIX_MAP.pageInfo, classNamePrefix);
  ...
  Navigator.prototype.bindEvents = function () {
    var _this = this;
    var render = (0, util_1.debounce)(function () {
