...
function renderTrack(container, attr) {
  ...
  var trackClassName = getLegendClassName(CLASS_NAMES.track.name, CLASSNAME_SUFFIX_MAP.track, classNamePrefix);
  container.maybeAppendByClassName(CLASS_NAMES.track, 'path').attr('className', trackClassName).styles(__assign({
    d: getTrackPath(attr)
  }, style));
}
function renderSelection(container, attr) {
  ...
  var classNamePrefix = attr.classNamePrefix;
  var selectionClassName = getLegendClassName(CLASS_NAMES.selection.name, CLASSNAME_SUFFIX_MAP.selection, classNamePrefix);
  var ribbon = container.maybeAppendByClassName(CLASS_NAMES.selection, 'path').attr('className', selectionClassName).styles(__assign({
