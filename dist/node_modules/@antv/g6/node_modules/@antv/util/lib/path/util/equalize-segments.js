...
function getCurveArray(segments) {
  return segments.map(function (segment, i, pathArray) {
    ...
    // @ts-ignore
    var curveLength = i ? (0, segment_cubic_factory_1.segmentCubicFactory)(segmentData[0], segmentData[1], segmentData[2], segmentData[3], segmentData[4], segmentData[5], segmentData[6], segmentData[7], segmentData[8], {
      bbox: false
    }).length : 0;
    var subsegs;
    if (i) {
