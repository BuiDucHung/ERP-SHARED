...
const createInterpolateValue = (a, b) => {
  if (typeof a === 'number' && typeof b === 'number') return (0, exports.createInterpolateNumber)(a, b);
  if (typeof a === 'string' && typeof b === 'string') return (0, exports.createInterpolateColor)(a, b);
  return () => a;
};
