...
export class BubbleSets extends BasePlugin {
  constructor(context, options) {
    ...
    this.getPath = forceUpdateId => {
      ...
      if (!forceUpdateId && this.path && isEqual(currMembers, prevMembers) && isEqual(currAvoidMembers, prevAvoidMembers)) {
        return this.path;
      }
      const {
