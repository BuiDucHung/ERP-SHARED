...
class ExtensionController {
  ...
  setExtensions(extensions) {
    ...
    const {
      ...
      exit,
      keep
    } = (0, diff_1.arrayDiff)(this.extensions, stdExtensions, extension => extension.key);
  ...
  createExtension(extension) {
    ...
    if (!Ctor) return print_1.print.warn(`The extension ${type} of ${category} is not registered.`);
