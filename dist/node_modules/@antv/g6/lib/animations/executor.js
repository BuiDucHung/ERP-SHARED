  ...
  const subResults = options.map(_a => {
    ...
    fields.forEach(attr => {
      ...
      Object.assign(keyframes[0], {
        [attr]: (_a = fromStyle[attr]) !== null && _a !== void 0 ? _a : (0, animation_1.inferDefaultValue)(attr)
      });
      Object.assign(keyframes[1], {
        [attr]: (_b = toStyle[attr]) !== null && _b !== void 0 ? _b : (0, animation_1.inferDefaultValue)(attr)
      });
    });
    // x/y -> translate
