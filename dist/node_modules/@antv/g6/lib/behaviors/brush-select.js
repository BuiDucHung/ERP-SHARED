...
class BrushSelect extends base_behavior_1.BaseBehavior {
  ...
  onPointerMove(event) {
    ...
    if (immediately && mode === 'default') this.updateElementsStates((0, point_1.getBoundingPoints)(this.startPoint, this.endPoint));
  }
  /**
  ...
  updateElementsStates(points) {
    ...
    if ((0, util_1.isFunction)(onSelect)) onSelect(states);
    graph.setElementState(states, this.options.animation);
  }
  /**
