...
class HoverActivate extends base_behavior_1.BaseBehavior {
  ...
  getActiveIds(event) {
    ...
    return degree ? (0, relation_1.getElementNthDegreeIds)(graph, event.targetType, elementId, typeof degree === 'function' ? degree(event) : degree, direction) : [elementId];
  }
  validate(event) {
    if (this.destroyed || this.isFrozen || (0, element_2.isToBeDestroyed)(event.target) ||
