...
class Cubic extends base_edge_1.BaseEdge {
  ...
  getControlPoints(sourcePoint, targetPoint, curvePosition, curveOffset, controlPoints) {
    return (controlPoints === null || controlPoints === void 0 ? void 0 : controlPoints.length) === 2 ? controlPoints : [(0, edge_1.getCurveControlPoint)(sourcePoint, targetPoint, curvePosition[0], curveOffset[0]), (0, edge_1.getCurveControlPoint)(sourcePoint, targetPoint, curvePosition[1], curveOffset[1])];
  }
}
exports.Cubic = Cubic;
