...
class HTML extends base_node_1.BaseNode {
  ...
  get events() {
    return [constants_1.CommonEvent.CLICK, constants_1.CommonEvent.POINTER_DOWN, constants_1.CommonEvent.POINTER_MOVE, constants_1.CommonEvent.POINTER_UP, constants_1.CommonEvent.POINTER_OVER, constants_1.CommonEvent.POINTER_LEAVE];
  }
  getDomElement() {
  ...
  getKeyStyle(attributes) {
    const _a = (0, util_1.pick)(attributes, ['dx', 'dy', 'innerHTML', 'pointerEvents', 'cursor']),
      {
        dx = 0,
        dy = 0
      } = _a,
  ...
  drawKeyShape(attributes, container) {
    ...
    const bounds = this.upsert('key-container', g_1.Rect, {
      x,
      y,
      width,
      height,
  ...
  normalizeToPointerEvent(event, canvas) {
    ...
    if (canvas.isTouchEvent(event)) {
      for (let i = 0; i < event.changedTouches.length; i++) {
        ...
        if ((0, util_1.isUndefined)(touch.button)) touch.button = 0;
        if ((0, util_1.isUndefined)(touch.buttons)) touch.buttons = 1;
        if ((0, util_1.isUndefined)(touch.isPrimary)) {
          touch.isPrimary = event.touches.length === 1 && event.type === 'touchstart';
        }
        if ((0, util_1.isUndefined)(touch.width)) touch.width = touch.radiusX || 1;
        if ((0, util_1.isUndefined)(touch.height)) touch.height = touch.radiusY || 1;
        if ((0, util_1.isUndefined)(touch.tiltX)) touch.tiltX = 0;
        if ((0, util_1.isUndefined)(touch.tiltY)) touch.tiltY = 0;
        if ((0, util_1.isUndefined)(touch.pointerType)) touch.pointerType = 'touch';
        // @see https://developer.mozilla.org/zh-CN/docs/Web/API/Touch/identifier
        if ((0, util_1.isUndefined)(touch.pointerId)) touch.pointerId = touch.identifier || 0;
        if ((0, util_1.isUndefined)(touch.pressure)) touch.pressure = touch.force || 0.5;
        if ((0, util_1.isUndefined)(touch.twist)) touch.twist = 0;
        if ((0, util_1.isUndefined)(touch.tangentialPressure)) touch.tangentialPressure = 0;
      ...
      if ((0, util_1.isUndefined)(tempEvent.isPrimary)) tempEvent.isPrimary = true;
      if ((0, util_1.isUndefined)(tempEvent.width)) tempEvent.width = 1;
      if ((0, util_1.isUndefined)(tempEvent.height)) tempEvent.height = 1;
      if ((0, util_1.isUndefined)(tempEvent.tiltX)) tempEvent.tiltX = 0;
      if ((0, util_1.isUndefined)(tempEvent.tiltY)) tempEvent.tiltY = 0;
      if ((0, util_1.isUndefined)(tempEvent.pointerType)) tempEvent.pointerType = 'mouse';
      if ((0, util_1.isUndefined)(tempEvent.pointerId)) tempEvent.pointerId = 1;
      if ((0, util_1.isUndefined)(tempEvent.pressure)) tempEvent.pressure = 0.5;
      if ((0, util_1.isUndefined)(tempEvent.twist)) tempEvent.twist = 0;
      if ((0, util_1.isUndefined)(tempEvent.tangentialPressure)) tempEvent.tangentialPressure = 0;
