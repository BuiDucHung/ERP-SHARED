...
class Contour extends base_shape_1.BaseShape {
  ...
  getLabelStyle(attributes) {
    ...
    const _a = (0, prefix_1.subStyleProps)(this.getGraphicStyle(attributes), 'label'),
      {
        maxWidth,
        offsetX,
        offsetY,
    ...
    return Object.assign((0, polygon_1.getPolygonTextStyleByPlacement)(keyBounds, placement, offsetX, offsetY, closeToPath, attributes.d, autoRotate), {
      wordWrapWidth: (0, text_1.getWordWrapWidthByBox)(keyBounds, maxWidth)
    }, labelStyle);
  }
