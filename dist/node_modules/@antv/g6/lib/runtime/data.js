...
class DataController {
  ...
  pushChange(change) {
    ...
    if (type === constants_1.ChangeType.NodeUpdated || type === constants_1.ChangeType.EdgeUpdated || type === constants_1.ChangeType.ComboUpdated) {
      ...
      this.changes.push({
        value: (0, data_1.cloneElementData)(value),
        original: (0, data_1.cloneElementData)(original),
        type
      });
    } else {
      this.changes.push({
        value: (0, data_1.cloneElementData)(change.value),
        type
      });
    }
  }
  ...
  getNodeData(ids) {
    return this.model.getAllNodes().reduce((acc, node) => {
      ...
      if (this.isCombo((0, id_1.idOf)(data))) return acc;
      if (ids === undefined) acc.push(data);else ids.includes((0, id_1.idOf)(data)) && acc.push(data);
      return acc;
    }, []);
  }
  getEdgeDatum(id) {
  ...
  getNodeLikeData(ids) {
    return this.model.getAllNodes().reduce((acc, node) => {
      const data = (0, graphlib_2.toG6Data)(node);
      if (ids) ids.includes((0, id_1.idOf)(data)) && acc.push(data);else acc.push(data);
      return acc;
    }, []);
  }
  ...
  addNodeData(nodes = []) {
    ...
    this.model.addNodes(nodes.map(node => {
      this.pushChange({
        value: node,
        type: constants_1.ChangeType.NodeAdded
      });
  ...
  addEdgeData(edges = []) {
    ...
    this.model.addEdges(edges.map(edge => {
      this.pushChange({
        value: edge,
        type: constants_1.ChangeType.EdgeAdded
      });
  ...
  addComboData(combos = []) {
    ...
    model.addNodes(combos.map(combo => {
      ...
      this.pushChange({
        value: combo,
        type: constants_1.ChangeType.ComboAdded
      });
  ...
  computeZIndex(data, type, force = false) {
    ...
    this.batch(() => {
      ...
      combos.forEach(combo => {
        ...
        if (type === 'add' && (0, util_1.isNumber)((_a = combo.style) === null || _a === void 0 ? void 0 : _a.zIndex)) return;
      ...
      nodes.forEach(node => {
        ...
        if (type === 'add' && (0, util_1.isNumber)((_a = node.style) === null || _a === void 0 ? void 0 : _a.zIndex)) return;
      ...
      edges.forEach(edge => {
        var _a, _b, _c, _d, _e;
        if ((0, util_1.isNumber)((_a = edge.style) === null || _a === void 0 ? void 0 : _a.zIndex)) return;
        let {
          id,
          source,
          target
        } = edge;
        if (!id) id = (0, id_1.idOf)(edge);else {
  ...
  updateNodeLikeHierarchy(data) {
    ...
    data.forEach(datum => {
      ...
      if (parent !== undefined) {
        if (!model.hasTreeStructure(constants_1.COMBO_KEY)) model.attachTreeStructure(constants_1.COMBO_KEY);
      ...
      if (children.length) {
        if (!model.hasTreeStructure(constants_1.TREE_KEY)) model.attachTreeStructure(constants_1.TREE_KEY);
  ...
  updateNodeData(nodes = []) {
    ...
    this.batch(() => {
      ...
      nodes.forEach(modifiedNode => {
        ...
        if ((0, data_1.isElementDataEqual)(originalNode, modifiedNode)) return;
        const value = (0, data_1.mergeElementsData)(originalNode, modifiedNode);
        this.pushChange({
          value,
          original: originalNode,
          type: constants_1.ChangeType.NodeUpdated
        });
  ...
  refreshData() {
    ...
    edges.forEach(edge => {
      this.pushChange({
        value: edge,
        original: edge,
        type: constants_1.ChangeType.EdgeUpdated
      });
    });
    combos.forEach(combo => {
      this.pushChange({
        value: combo,
        original: combo,
        type: constants_1.ChangeType.ComboUpdated
      });
    });
  }
  ...
  updateEdgeData(edges = []) {
    ...
    this.batch(() => {
      edges.forEach(modifiedEdge => {
        ...
        if ((0, data_1.isElementDataEqual)(originalEdge, modifiedEdge)) return;
  ...
  updateComboData(combos = []) {
    ...
    model.batch(() => {
      ...
      combos.forEach(modifiedCombo => {
        ...
        if ((0, data_1.isElementDataEqual)(originalCombo, modifiedCombo)) return;
    ...
    this.batch(() => {
      ids.forEach(id => {
        ...
        this.pushChange({
          ...
          type: constants_1.ChangeType.NodeRemoved
        });
  ...
  removeEdgeData(ids = []) {
    ...
    ids.forEach(id => this.pushChange({
      ...
      type: constants_1.ChangeType.EdgeRemoved
    }));
    ...
    this.batch(() => {
      ids.forEach(id => {
        this.pushChange({
          ...
          type: constants_1.ChangeType.ComboRemoved
        });
        this.removeNodeLikeHierarchy(id);
  ...
  removeNodeLikeHierarchy(id) {
    if (this.model.hasTreeStructure(constants_1.COMBO_KEY)) {
      ...
      if (!(0, util_1.isNil)(grandParent)) this.refreshComboData(grandParent);
    }
  }
  /**
   * <zh/> 获取元素的类型
