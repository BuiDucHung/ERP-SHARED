...
const executor_1 = require("../animations/executor");
...
class Animation {
  ...
  animate(localAnimation, callbacks, extendOptions) {
    ...
    const animations = this.getTasks().map(([context, cb]) => {
      ...
      const options = (0, animation_1.getElementAnimationOptions)(this.context.options, elementType, stage, localAnimation);
      (_a = cb === null || cb === void 0 ? void 0 : cb.before) === null || _a === void 0 ? void 0 : _a.call(cb);
      const animation = options.length ? (0, executor_1.executor)(element, this.inferStyle(context, extendOptions), options) : null;
      if (animation) {
    ...
    const animation = (0, animation_1.createAnimationsProxy)(animations);
    if (animation) {
  ...
  inferStyle(context, options) {
    ...
    if (stage === 'enter') {
      ...
      Object.assign(toStyle, {
        opacity: (_a = (0, cache_1.getCachedStyle)(element, 'opacity')) !== null && _a !== void 0 ? _a : (0, animation_1.inferDefaultValue)('opacity')
      });
    } else if (stage === 'hide') {
      Object.assign(fromStyle, {
        opacity: (_b = (0, cache_1.getCachedStyle)(element, 'opacity')) !== null && _b !== void 0 ? _b : (0, animation_1.inferDefaultValue)('opacity')
      });
      Object.assign(toStyle, {
        opacity: 0
      });
