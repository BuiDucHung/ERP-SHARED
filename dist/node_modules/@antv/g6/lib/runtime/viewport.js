...
class ViewportController {
  ...
  transform(options, animation) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if ((0, util_1.isNumber)(rotate)) Object.assign(landmarkOptions, this.getRotateOptions(options));
      if ((0, util_1.isNumber)(scale)) Object.assign(landmarkOptions, {
  ...
  focus(bbox, options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      yield this.transform({
        mode: 'relative',
        translate: (0, vector_1.add)(delta, this.paddingOffset)
      }, options.animation);
    });
  }
  /**
  ...
  isInViewport(target, complete = false, tolerance = 0) {
    ...
    return (0, is_1.isPoint)(target) ? (0, bbox_1.isPointInBBox)(target, viewportBBox) : !complete ? viewportBBox.intersects(target) : (0, bbox_1.isBBoxInside)(target, viewportBBox);
  }
  cancelAnimation() {
    var _a, _b;
