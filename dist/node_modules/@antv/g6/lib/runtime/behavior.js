...
class BehaviorController extends extension_1.ExtensionController {
  constructor(context) {
    ...
    this.forwardCanvasEvents = event => {
      ...
      if ('destroyed' in targetElement && ((0, element_1.isToBeDestroyed)(targetElement) || targetElement.destroyed)) return;
      const {
        type,
        detail,
        button
      ...
      if (type === constants_1.CommonEvent.POINTER_MOVE) {
        if (this.currentTarget !== targetElement) {
          if (this.currentTarget) {
            graph.emit(`${this.currentTargetType}:${constants_1.CommonEvent.POINTER_LEAVE}`, Object.assign(Object.assign({}, stdEvent), {
          ...
          if (targetElement) {
            Object.assign(stdEvent, {
              type: constants_1.CommonEvent.POINTER_ENTER
            });
      ...
      if (type === constants_1.CommonEvent.CLICK && detail === 2) {
        Object.assign(stdEvent, {
          type: constants_1.CommonEvent.DBLCLICK
        });
  ...
  forwardEvents() {
    ...
    if (canvas) {
      [constants_1.CommonEvent.CLICK, constants_1.CommonEvent.DBLCLICK, constants_1.CommonEvent.POINTER_OVER, constants_1.CommonEvent.POINTER_LEAVE, constants_1.CommonEvent.POINTER_ENTER, constants_1.CommonEvent.POINTER_MOVE, constants_1.CommonEvent.POINTER_OUT, constants_1.CommonEvent.POINTER_DOWN, constants_1.CommonEvent.POINTER_UP, constants_1.CommonEvent.CONTEXT_MENU, constants_1.CommonEvent.DRAG_START, constants_1.CommonEvent.DRAG, constants_1.CommonEvent.DRAG_END, constants_1.CommonEvent.DRAG_ENTER, constants_1.CommonEvent.DRAG_OVER, constants_1.CommonEvent.DRAG_LEAVE, constants_1.CommonEvent.DROP, constants_1.CommonEvent.WHEEL].forEach(name => {
