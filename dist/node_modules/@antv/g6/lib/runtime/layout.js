...
class LayoutController {
  ...
  preLayout(data) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      (0, event_1.emit)(graph, new event_1.GraphLifeCycleEvent(constants_1.GraphEvent.BEFORE_LAYOUT, {
        type: 'pre'
      }));
      ...
      (0, event_1.emit)(graph, new event_1.GraphLifeCycleEvent(constants_1.GraphEvent.AFTER_LAYOUT, {
        type: 'pre'
      }));
  ...
  postLayout() {
    return __awaiter(this, arguments, void 0, function* (layoutOptions = this.options) {
      ...
      for (let index = 0; index < pipeline.length; index++) {
        ...
        (0, event_1.emit)(graph, new event_1.GraphLifeCycleEvent(constants_1.GraphEvent.BEFORE_STAGE_LAYOUT, {
          options: opts,
          index
        }));
        const result = yield this.stepLayout(data, opts, index);
        (0, event_1.emit)(graph, new event_1.GraphLifeCycleEvent(constants_1.GraphEvent.AFTER_STAGE_LAYOUT, {
          options: opts,
          index
        }));
  ...
  stepLayout(data, options, index) {
    return __awaiter(this, void 0, void 0, function* () {
      if ((0, layout_2.isTreeLayout)(options)) return yield this.treeLayout(data, options, index);
  ...
  graphLayout(data, options, index) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (enableWorker) {
        ...
        this.supervisor = new layout_1.Supervisor(rawLayout.graphData2LayoutModel(data), rawLayout.instance, {
          iterations
        });
  ...
  getLayoutData(options) {
    ...
    const filterFn = preLayout ? node => {
      ...
      if (!isLayoutInvisibleNodes) {
        ...
        if (model.getAncestorsData(node.id, constants_1.TREE_KEY).some(collapsibility_1.isCollapsed)) return false;
        if (model.getAncestorsData(node.id, constants_1.COMBO_KEY).some(collapsibility_1.isCollapsed)) return false;
      }
      ...
      if ((0, element_1.isToBeDestroyed)(element)) return false;
      return nodeFilter(node);
    };
  ...
  initGraphLayout(options) {
    ...
    if (!Ctor) return print_1.print.warn(`The layout of ${type} is not registered.`);
    const STDCtor = Object.getPrototypeOf(Ctor.prototype) === layouts_1.BaseLayout.prototype ? Ctor : (0, layout_2.layoutAdapter)(Ctor, this.context);
