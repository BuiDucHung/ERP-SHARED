...
exports.REQUIRED_TRANSFORMS = ['update-related-edges', 'collapse-expand-node', 'collapse-expand-combo', 'get-edge-actual-ends', 'arrange-draw-order'];
class TransformController extends extension_1.ExtensionController {
  ...
  setTransforms(transforms) {
    this.setExtensions([...exports.REQUIRED_TRANSFORMS.slice(0, exports.REQUIRED_TRANSFORMS.length - 1), ...transforms, exports.REQUIRED_TRANSFORMS[exports.REQUIRED_TRANSFORMS.length - 1]]);
  }
