...
exports.getTextWatermark = getTextWatermark;
exports.getImageWatermark = getImageWatermark;
 ...
 * @returns 水印的 base64
 */
function getTextWatermark(width, height, text, style) {
 ...
 * @returns 水印的 base64
 */
function getImageWatermark(width, height, imageURL, style) {
  return __awaiter(this, void 0, void 0, function* () {
    const canvas = createCanvas(width, height);
    const ctx = canvas.getContext('2d');
    const {
