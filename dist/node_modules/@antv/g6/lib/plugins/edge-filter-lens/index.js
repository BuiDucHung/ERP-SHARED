...
class EdgeFilterLens extends base_plugin_1.BasePlugin {
  constructor(context, options) {
    ...
    this.onDragStart = event => {
      ...
      const origin = (_a = this.lens) === null || _a === void 0 ? void 0 : _a.getCenter();
      if (!this.isLensOn || (0, vector_1.distance)(dragOrigin, origin) > this.r) return;
  ...
  bindEvents() {
    ...
    if (scaleRBy === 'wheel') {
      (_a = this.graphDom) === null || _a === void 0 ? void 0 : _a.addEventListener(constants_1.CommonEvent.WHEEL, this.scaleRByWheel, {
        passive: false
      });
    }
  }
