...
class Hull extends base_plugin_1.BasePlugin {
  constructor(context, options) {
    ...
    this.updateHullPath = event => {
      ...
      if (!this.options.members.includes((0, id_1.idOf)(event.data))) return;
      this.shape.update({
    ...
    this.getHullPath = (forceUpdate = false) => {
      ...
      if ((0, util_1.isEqual)(hullMemberIds, this.hullMemberIds) && !forceUpdate) return this.path;
