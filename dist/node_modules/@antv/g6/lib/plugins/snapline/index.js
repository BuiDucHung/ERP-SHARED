  ...
  constructor(context, options) {
    ...
    this.initSnapline = () => {
      ...
      if (!this.horizontalLine) {
        this.horizontalLine = canvas.appendChild(new g_1.Line({
          style: Object.assign(Object.assign({}, defaultLineStyle), this.options.horizontalLineStyle)
        }));
      }
      if (!this.verticalLine) {
        this.verticalLine = canvas.appendChild(new g_1.Line({
    ...
    this.calcSnaplineMetadata = (target, nodeBBox) => {
      ...
      this.getNodes().some(snapNode => {
        if ((0, util_1.isEqual)(target.id, snapNode.id)) return false;
