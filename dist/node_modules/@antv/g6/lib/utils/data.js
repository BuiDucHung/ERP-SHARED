...
exports.OVERRIDE_KEY = '__internal_override__';
/**
 * <zh/> 判断元素数据是否允许被覆盖
 *
...
function isOverridable(datum) {
  return datum[exports.OVERRIDE_KEY] !== false;
}