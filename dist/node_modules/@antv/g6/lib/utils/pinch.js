...
class PinchHandler {
  ...
  bindEvents() {
    ...
    emitter.on(constants_1.CommonEvent.POINTER_DOWN, this.onPointerDown);
    emitter.on(constants_1.CommonEvent.POINTER_MOVE, this.onPointerMove);
    emitter.on(constants_1.CommonEvent.POINTER_UP, this.onPointerUp);
  }
  /**
   * <zh/> 更新指定指针的位置
   *
   ...
   */
  destroy() {
    this.emitter.off(constants_1.CommonEvent.POINTER_DOWN, this.onPointerDown);
    this.emitter.off(constants_1.CommonEvent.POINTER_MOVE, this.onPointerMove);
    this.emitter.off(constants_1.CommonEvent.POINTER_UP, this.onPointerUp);
...
exports.PinchHandler = PinchHandler;
/**
 * <zh/> 是否处于 Pinch 阶段
 *
