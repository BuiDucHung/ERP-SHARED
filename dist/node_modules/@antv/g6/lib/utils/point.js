...
function moveTo(p, ref, distance, reverse = false) {
  if ((0, util_1.isEqual)(p, ref)) return p;
...
function getRectIntersectPoint(p, bbox, useExtendedLine = false) {
  ...
  const corners = [(0, position_1.getXYByPlacement)(bbox, 'left-top'), (0, position_1.getXYByPlacement)(bbox, 'right-top'), (0, position_1.getXYByPlacement)(bbox, 'right-bottom'), (0, position_1.getXYByPlacement)(bbox, 'left-bottom')];
