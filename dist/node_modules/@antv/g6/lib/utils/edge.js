...
function getCurveControlPoint(sourcePoint, targetPoint, curvePosition, curveOffset) {
  if ((0, util_1.isEqual)(sourcePoint, targetPoint)) return sourcePoint;
...
function parseCurveOffset(curveOffset) {
  if ((0, util_1.isNumber)(curveOffset)) return [curveOffset, -curveOffset];
  return curveOffset;
}
/**
...
function parseCurvePosition(curvePosition) {
  if ((0, util_1.isNumber)(curvePosition)) return [curvePosition, 1 - curvePosition];
...
function getCubicLoopPath(node, placement, clockwise, dist, sourcePortKey, targetPortKey) {
  ...
  if (sourcePort) sourcePoint = (0, element_1.getPortConnectionPoint)(sourcePort, controlPoints[0]);
  if (targetPort) targetPoint = (0, element_1.getPortConnectionPoint)(targetPort, controlPoints.at(-1));
...
function getCubicLoopControlPoints(node, sourcePoint, targetPoint, dist) {
  ...
  return [(0, point_1.moveTo)(center, sourcePoint, (0, vector_1.distance)(center, sourcePoint) + dist), (0, point_1.moveTo)(center, targetPoint, (0, vector_1.distance)(center, targetPoint) + dist)];
}
/**
 * <zh/> 获取环形折线边的绘制路径
 *
