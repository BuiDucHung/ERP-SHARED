...
class PlaceRadialLabels extends base_transform_1.BaseTransform {
  ...
  afterLayout() {
    ...
    (_a = data.nodes) === null || _a === void 0 ? void 0 : _a.forEach(datum => {
      var _a;
      if ((0, id_1.idOf)(datum) === (0, id_1.idOf)(this.ref)) return;
      ...
      const labelTransform = [['translate', offset * Math.cos(radian), offset * Math.sin(radian)], ['rotate', isLeft ? (0, g_1.rad2deg)(radian) + 180 : (0, g_1.rad2deg)(radian)]];
