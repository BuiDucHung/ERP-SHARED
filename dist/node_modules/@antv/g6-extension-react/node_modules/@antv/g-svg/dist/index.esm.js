...
import { isDisplayObject, translatePathToString, UnitType, isCSSRGB, isPattern, isBrowser, GradientType, computeLinearGradient, computeRadialGradient, isCSSGradientValue, parseTransform, ElementEvent, RenderReason, Shape, propertyMetadataCache, AbstractRendererPlugin, AbstractRenderer, DomInteraction } from '@antv/g-lite';
export { DomInteraction } from '@antv/g-lite';
...
function updateTextElementAttribute($el, parsedStyle, text, runtime) {
  ...
  var _parsedStyle$lineWidt = parsedStyle.lineWidth,
    ...
    _parsedStyle$textDeco4 = parsedStyle.textDecorationThickness,
    textDecorationThickness = _parsedStyle$textDeco4 === void 0 ? 1 : _parsedStyle$textDeco4,
  ...
  if (textDecorationLine && textDecorationLine !== 'none') {
    ...
    styleCSSText += "text-decoration:".concat(textDecorationLine, " ").concat(textDecorationStyle, " ").concat(textDecorationColor, ";text-decoration-thickness:").concat(textDecorationThickness, ";");
  }
  if (styleCSSText) {
...
var index$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  CLIP_PATH_PREFIX: CLIP_PATH_PREFIX,
  DEFAULT_VALUE_MAP: DEFAULT_VALUE_MAP,
  DefaultElementLifeCycleContribution: DefaultElementLifeCycleContribution,
  ElementSVG: ElementSVG,
  G_SVG_PREFIX: G_SVG_PREFIX,
  Plugin: Plugin$1,
  SHAPE2TAGS: SHAPE2TAGS,
  SHAPE_UPDATE_DEPS: SHAPE_UPDATE_DEPS,
  SVGRendererPlugin: SVGRendererPlugin,
  SVG_ATTR_MAP: SVG_ATTR_MAP,
  TEXT_PATH_PREFIX: TEXT_PATH_PREFIX,
  createSVGElement: createSVGElement,
  updateImageElementAttribute: updateImageElementAttribute,
  updateLineElementAttribute: updateLineElementAttribute,
  updatePathElementAttribute: updatePathElementAttribute,
  updatePolylineElementAttribute: updatePolylineElementAttribute,
  updateRectElementAttribute: updateRectElementAttribute,
  updateTextElementAttribute: updateTextElementAttribute
});
  ...
  return _createClass(SVGContextService, [{
    ...
    value: function () {
      var _toDataURL = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _this = this;
        var cloneNode, doc, animationCounter, $style, svgDocType, svgDoc;
        return _regeneratorRuntime().wrap(function (_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
...
export { G_SVG_PREFIX, Renderer, index as SVGPicker, index$1 as SVGRenderer, createSVGElement };