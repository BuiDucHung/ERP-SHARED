...
function geometry(params) {
  ...
  var data = options.data,
    ...
    shape = options.shape;
  var percentData = isPercent && isGroup && isStack ? (0, percent_1.getDeepPercent)(data, yField, [xField, groupField], yField) : (0, percent_1.getDataWhetherPercentage)(data, yField, xField, yField, isPercent);
  var chartData = [];
...
function meta(params) {
  ...
  return (0, utils_1.flow)((0, common_1.scale)((_a = {}, _a[xField] = xAxis, _a[yField] = yAxis, _a), (_b = {}, _b[xField] = {
    type: 'cat'
  }, _b[yField] = tslib_1.__assign(tslib_1.__assign({}, (0, utils_1.adjustYMetaByZero)(data, yField)), percentYMeta), _b)))(params);
}
exports.meta = meta;
/**
 * axis 配置
...
function label(params) {
  ...
  if (!label) {
    ...
    geometry.label({
      ...
      }, (0, utils_1.transformLabel)(isRange ? tslib_1.__assign({
      ...
      tooltipOptions = tslib_1.__assign(tslib_1.__assign({}, tooltipOptions), {
        customItems: function (originalItems) {
          ...
          (0, util_1.each)(originalItems, function (item) {
            ...
            var datas = (0, util_1.filter)(data, function (d) {
              return (0, util_1.isMatch)(d, (0, utils_1.pick)(item.data, [xField, seriesField]));
            });
...
function adaptor(params, isBar) {
  ...
  var options = params.options;
  var seriesField = options.seriesField;
  return (0, utils_1.flow)(defaultOptions,
  // 处理默认配置
  common_1.theme,
