...
function geometry(params) {
  ...
  var bulletStyle = options.bulletStyle,
    ...
    label = options.label;
  // 处理数据
  var _a = (0, utils_2.transformData)(options),
    min = _a.min,
    max = _a.max,
    ds = _a.ds;
  chart.data(ds);
  ...
  var t = (0, utils_1.deepAssign)({}, params, {
    options: {
      ...
      point: {
        ...
        size: (0, util_1.isFunction)((0, util_1.get)(size, 'target')) ? function (data) {
          return (0, util_1.get)(size, 'target')(data) / 2;
...
function meta(params) {
  ...
  return (0, utils_1.flow)((0, common_1.scale)((_a = {}, _a[xField] = xAxis, _a[measureField] = yAxis, _a), (_b = {}, _b[measureField] = {
...
function label(params) {
  ...
  if ((0, util_1.get)(label, 'range')) {
    rangeGeometry.label("".concat(rangeField), tslib_1.__assign({
      layout: [{
        type: 'limit-in-plot'
      }]
    }, (0, utils_1.transformLabel)(label.range)));
  } else {
    rangeGeometry.label(false);
  }
  if ((0, util_1.get)(label, 'measure')) {
    measureGeometry.label("".concat(measureField), tslib_1.__assign({
      layout: [{
        type: 'limit-in-plot'
      }]
    }, (0, utils_1.transformLabel)(label.measure)));
  } else {
    measureGeometry.label(false);
  }
  if ((0, util_1.get)(label, 'target')) {
    targetGeometry.label("".concat(targetField), tslib_1.__assign({
      layout: [{
        type: 'limit-in-plot'
      }]
    }, (0, utils_1.transformLabel)(label.target)));
  } else {
