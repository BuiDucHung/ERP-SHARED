...
function facetAdaptor(params) {
  ...
  var restFacetCfg = (0, util_1.omit)(options, ['type', 'data', 'fields', 'eachView', 'axes', 'meta', 'tooltip', 'coordinate', 'theme', 'legend', 'interactions', 'annotations']);
  // 1. data
  chart.data(data);
  // 2. facet
  chart.facet(facetType, tslib_1.__assign(tslib_1.__assign({}, restFacetCfg), {
    fields: fields,
