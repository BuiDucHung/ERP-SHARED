...
function multiPlot(params) {
  ...
  (0, util_1.each)(plots, function (plot) {
    ...
    if (top) {
      (0, utils_2.execPlotAdaptor)(type, chart, tslib_1.__assign(tslib_1.__assign({}, options), {
        data: data
      }));
      return;
    }
    var viewOfG2 = chart.createView(tslib_1.__assign({
      region: region
    }, (0, utils_1.pick)(options, plot_1.PLOT_CONTAINER_OPTIONS)));
    if (tooltip) {
      // 配置 tooltip 交互
      viewOfG2.interaction('tooltip');
    }
    (0, utils_2.execPlotAdaptor)(type, viewOfG2, tslib_1.__assign({
      data: data
    }, options));
  });
  return params;
...
function adaptor(params) {
  return (0, utils_1.flow)(common_1.animation,
  // 多 view 的图，动画配置放到最前面
