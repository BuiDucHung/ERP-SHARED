...
function transformData(params) {
  ...
  var nodesData = nodes.map(function (node) {
    return tslib_1.__assign(tslib_1.__assign({}, (0, utils_1.pick)(node, tslib_1.__spreadArray(['id', 'x', 'y', 'name'], rawFields, true))), {
      isNode: true
    });
  });
  // 2. 生成 edge 使用数据 （同桑基图）
  var edgesData = links.map(function (link) {
    ...
    }, (0, utils_1.pick)(link, tslib_1.__spreadArray(['x', 'y', 'value'], rawFields, true))), {
      isNode: false
    });
  });
  return tslib_1.__assign(tslib_1.__assign({}, params), {
    ext: tslib_1.__assign(tslib_1.__assign({}, params.ext), {
...
function scale(params) {
  ...
  }, _a[constant_1.NODE_COLOR_FIELD] = {
    sync: 'color'
  }, _a[constant_1.EDGE_COLOR_FIELD] = {
    sync: 'color'
  }, _a));
  return params;
}
