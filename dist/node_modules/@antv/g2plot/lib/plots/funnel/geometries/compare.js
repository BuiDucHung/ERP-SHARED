...
function geometry(params) {
  ...
  chart.facet('mirror', {
    ...
    eachView: function (view, facet) {
      ...
      // 绘制图形
      var _a = (0, tooltip_1.getTooltipMapping)(tooltip, [xField, yField, compareField]),
        fields = _a.fields,
...
function compareConversionTag(params) {
  ...
  ((0, util_1.isNumber)(index) ? [chart] : chart.views).forEach(function (view, viewIndex) {
    ...
    var x = (0, util_1.map)(dataArray, function (item) {
      return (0, util_1.get)(item, ['0', 'nextPoints', '0', 'x']) * size - 0.5;
    });
