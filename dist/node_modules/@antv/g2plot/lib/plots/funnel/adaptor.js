  ...
  if (compareField || funnelStyle) {
    style = function (datum) {
      ...
      compareField && {
        lineWidth: 1,
        stroke: '#fff'
      }, (0, util_1.isFunction)(funnelStyle) ? funnelStyle(datum) : funnelStyle);
    };
  }
  return (0, utils_1.deepAssign)({
...
function meta(params) {
  ...
  var xAxis = options.xAxis,
    ...
    xField = options.xField,
    yField = options.yField;
  return (0, utils_1.flow)((0, common_1.scale)((_a = {}, _a[xField] = xAxis, _a[yField] = yAxis, _a)))(params);
}
exports.meta = meta;
/**
 * 坐标轴
...
function interaction(params) {
  ...
  if (!dynamicHeight) {
    chart.interaction(interactions_1.FUNNEL_LEGEND_FILTER, {
      start: [tslib_1.__assign(tslib_1.__assign({}, interactions_1.interactionStart), {
        arg: options
      })]
    });
  } else {
