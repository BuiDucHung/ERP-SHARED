...
function Sankey() {
  ...
  function computeNodeValues(_a) {
    ...
    for (var _i = 0, nodes_3 = nodes; _i < nodes_3.length; _i++) {
      var node = nodes_3[_i];
      node.value = node.fixedValue === undefined ? Math.max((0, helper_1.sumBy)(node.sourceLinks, value), (0, helper_1.sumBy)(node.targetLinks, value)) : node.fixedValue;
    }
  }
  function computeNodeDepths(_a) {
    ...
    if (depth) {
      var maxDepth = Math.max((0, helper_1.maxValueBy)(nodes, function (d) {
        return d.depth;
      }) + 1, 0);
      var node = void 0;
  ...
  function computeNodeLayers(_a) {
    var nodes = _a.nodes;
    var x = Math.max((0, helper_1.maxValueBy)(nodes, function (d) {
      return d.depth;
    }) + 1, 0);
    var kx = (x1 - x0 - dx) / (x - 1);
  ...
  function initializeNodeBreadths(columns) {
    var ky = (0, helper_1.minValueBy)(columns, function (c) {
      return (y1 - y0 - (c.length - 1) * py) / (0, helper_1.sumBy)(c, value);
    });
  ...
  function computeNodeBreadths(graph) {
    ...
    py = Math.min(dy, (y1 - y0) / ((0, helper_1.maxValueBy)(columns, function (c) {
      return c.length;
    }) - 1));
