...
function transformOptions(params) {
  ...
  return (0, utils_1.deepAssign)({}, {
    ...
    options: {
      ...
      // geometryOptions
      geometryOptions: [(0, option_1.getGeometryOption)(xField, yField[0], geometryOptions[0]), (0, option_1.getGeometryOption)(xField, yField[1], geometryOptions[1])],
      // annotations
...
function geometry(params) {
  ...
  // 包含配置，id，数据的结构
  var geometries = [tslib_1.__assign(tslib_1.__assign({}, geometryOptions[0]), {
    id: constant_1.LEFT_AXES_VIEW,
    data: data[0],
    yField: yField[0]
  }), tslib_1.__assign(tslib_1.__assign({}, geometryOptions[1]), {
    id: constant_1.RIGHT_AXES_VIEW,
    data: data[1],
    yField: yField[1]
  })];
...
function meta(params) {
  ...
  var xAxis = options.xAxis,
    ...
    xField = options.xField,
    yField = options.yField;
  (0, common_1.scale)((_a = {}, _a[xField] = xAxis, _a[yField[0]] = yAxis[0], _a))((0, utils_1.deepAssign)({}, params, {
    chart: (0, view_1.findViewById)(chart, constant_1.LEFT_AXES_VIEW)
  }));
  (0, common_1.scale)((_b = {}, _b[xField] = xAxis, _b[yField[1]] = yAxis[1], _b))((0, utils_1.deepAssign)({}, params, {
...
function theme(params) {
   ...
   */
  (0, common_1.theme)((0, utils_1.deepAssign)({}, params, {
    chart: (0, view_1.findViewById)(chart, constant_1.LEFT_AXES_VIEW)
  }));
  (0, common_1.theme)((0, utils_1.deepAssign)({}, params, {
    chart: (0, view_1.findViewById)(chart, constant_1.RIGHT_AXES_VIEW)
...
function animation(params) {
  var chart = params.chart;
  (0, common_1.animation)((0, utils_1.deepAssign)({}, params, {
    chart: (0, view_1.findViewById)(chart, constant_1.LEFT_AXES_VIEW)
  }));
  (0, common_1.animation)((0, utils_1.deepAssign)({}, params, {
    chart: (0, view_1.findViewById)(chart, constant_1.RIGHT_AXES_VIEW)
...
function legend(params) {
  ...
  if (legend === false) {
    ...
    // 均使用自定义图例
    chart.once('beforepaint', function () {
      var leftItems = data[0].length ? (0, legend_1.getViewLegendItems)({
        view: leftView,
        geometryOption: geometryOptions[0],
        yField: yField[0],
        legend: leftLegend_1
      }) : [];
      var rightItems = data[1].length ? (0, legend_1.getViewLegendItems)({
        view: rightView,
    ...
    chart.on('legend-item:click', function (evt) {
      ...
      if (delegateObject && delegateObject.item) {
        ...
        if (isGeometry) {
          var idx = (0, util_1.findIndex)(yField, function (yF) {
            return yF === field_1;
          });
          if (idx > -1) {
            ...
            (0, util_1.each)(groupScale, function (scale) {
              if (scale.values && scale.values.indexOf(field_1) > -1) {
                view.filter(scale.field, function (value) {
                  var curLegendItem = (0, util_1.find)(legendItem_1, function (item) {
