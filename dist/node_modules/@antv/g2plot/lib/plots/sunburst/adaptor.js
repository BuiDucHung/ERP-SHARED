...
function geometry(params) {
  ...
  var color = options.color,
    ...
    colorField = _a === void 0 ? constant_1.SUNBURST_ANCESTOR_FIELD : _a,
...
function label(params) {
  ...
  if (!label) {
    ...
    var _a = label.fields,
      ...
      cfg = tslib_1.__rest(label, ["fields", "callback"]);
    geometry.label({
      fields: fields,
      callback: callback,
...
function meta(params) {
  ...
  var hierarchyConfig = options.hierarchyConfig,
    meta = options.meta;
  return (0, utils_1.flow)((0, common_1.scale)({}, (_a = {}, _a[constant_1.SUNBURST_Y_FIELD] = (0, util_1.get)(meta, (0, util_1.get)(hierarchyConfig, ['field'], 'value')), _a)))(params);
}
exports.meta = meta;
/**
 * tooltip 配置
      ...
      tooltipOptions = (0, utils_1.deepAssign)({}, {
        customItems: function (items) {
          return items.map(function (item) {
            ...
            var pathFormatter = (0, util_1.get)(scales, [constant_1.SUNBURST_PATH_FIELD, 'formatter'], function (v) {
              return v;
            });
            var valueFormatter = (0, util_1.get)(scales, [constant_1.SUNBURST_Y_FIELD, 'formatter'], function (v) {
              return v;
            });
            return tslib_1.__assign(tslib_1.__assign({}, item), {
              name: pathFormatter(item.data[constant_1.SUNBURST_PATH_FIELD]),
    ...
    return (0, utils_1.deepAssign)({}, options, {
      interactions: tslib_1.__spreadArray(tslib_1.__spreadArray([], interactions, true), [{
        ...
        cfg: {
          ...
          transformData: utils_2.transformData
        }
      }], false)
    });
  }
