...
function meta(params) {
  ...
  var scales = (0, utils_1.deepAssign)(baseMeta, meta, (_b = {}, _b[xField] = (0, utils_1.pick)(xAxis, constant_1.AXIS_META_CONFIG_KEYS), _b[constant_2.Y_FIELD] = (0, utils_1.pick)(yAxis, constant_1.AXIS_META_CONFIG_KEYS), _b));
  chart.scale(scales);
  return params;
}
exports.meta = meta;
