...
function transformData(options) {
  ...
  var nodes = (0, pack_1.pack)(data, tslib_1.__assign(tslib_1.__assign({}, hierarchyConfig), {
    field: 'value',
    as: ['x', 'y', 'r']
  }));
  var result = [];
  nodes.forEach(function (node) {
    ...
    var nodeInfo = (0, utils_1.deepAssign)({}, node.data, tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, (0, utils_1.pick)(node.data, rawFields)), {
      path: path
    }), node));
