...
function geometry(params) {
  ...
  if (indicator) {
    ...
    var v1 = chart.createView({
      id: constants_1.INDICATEOR_VIEW_ID
    });
    v1.data(indicatorData);
    v1.point().position("".concat(constants_1.PERCENT, "*1")).shape(indicator.shape || 'gauge-indicator')
    // 传入指针的样式到自定义 shape 中
    .customInfo({
...
function meta(params) {
  ...
  }, _a[constants_1.PERCENT] = {}, _a)))(params);
}
/**
 * 统计指标文档
 * @param params
...
function statistic(params, updated) {
  ...
  if (statistic) {
    ...
    (0, utils_1.renderGaugeStatistic)(chart, {
