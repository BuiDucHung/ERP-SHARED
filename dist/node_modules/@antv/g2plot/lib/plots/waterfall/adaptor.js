...
function geometry(params) {
  ...
  geometry.customInfo(tslib_1.__assign(tslib_1.__assign({}, customInfo), {
...
function meta(params) {
  ...
  var xAxis = options.xAxis,
    ...
    yField = options.yField,
    meta = options.meta;
  var Y_FIELD_META = (0, utils_1.deepAssign)({}, {
    alias: yField
  }, (0, util_1.get)(meta, yField));
  return (0, utils_1.flow)((0, common_1.scale)((_a = {}, _a[xField] = xAxis, _a[yField] = yAxis, _a[constant_1.Y_FIELD] = yAxis, _a), (0, utils_1.deepAssign)({}, meta, (_b = {}, _b[constant_1.Y_FIELD] = Y_FIELD_META, _b[constant_1.DIFF_FIELD] = Y_FIELD_META, _b[constant_1.ABSOLUTE_FIELD] = Y_FIELD_META, _b))))(params);
}
/**
 * axis 配置
 * @param params
  ...
  if (legend === false) {
    ...
    if (total) {
      items.push({
        ...
        marker: {
          symbol: 'square',
          style: (0, utils_1.deepAssign)({}, {
            r: 5
          }, (0, util_1.get)(total, 'style'))
        }
      });
    }
