...
function meta(params) {
  ...
  chart.scale((_a = {}, _a[constant_1.SERIES_FIELD_KEY] = {
    sync: true,
    formatter: function (v) {
      return (0, util_1.get)(aliasMap, v, v);
    }
  }, _a));
  (0, common_1.scale)((_b = {}, _b[xField] = xAxis, _b[yField[0]] = yAxis[yField[0]], _b))((0, utils_1.deepAssign)({}, params, {
    chart: firstView
  }));
  (0, common_1.scale)((_c = {}, _c[xField] = xAxis, _c[yField[1]] = yAxis[yField[1]], _c))((0, utils_1.deepAssign)({}, params, {
    chart: secondView
  }));
  return params;
}
...
function axis(params) {
  ...
  if ((xAxis === null || xAxis === void 0 ? void 0 : xAxis.position) === 'bottom') {
    ...
    secondView.axis(xField, tslib_1.__assign(tslib_1.__assign({}, xAxis), {
      label: {
        formatter: function () {
          return '';
        }
  ...
  if (xAxis === false) {
    ...
    firstView.axis(xField, tslib_1.__assign({
      ...
      position: (0, utils_2.isHorizontal)(layout) ? 'top' : 'bottom'
    }, xAxis));
  }
  if (yAxis === false) {
...
function label(params) {
  ...
  if (!label) {
    ...
    var callback = label.callback,
      cfg_1 = tslib_1.__rest(label, ["callback"]);
    /** ---- 设置默认配置 ---- */
    // 默认居中
    if (!cfg_1.position) {
    ...
    if ((0, utils_2.isHorizontal)(layout)) {
      ...
      cfg_1.style = (0, utils_1.deepAssign)({}, cfg_1.style, {
        textAlign: textAlign
      });
      var textAlignMap = {
        left: 'right',
      ...
      leftLabelCfg.style = (0, utils_1.deepAssign)({}, leftLabelCfg.style, {
