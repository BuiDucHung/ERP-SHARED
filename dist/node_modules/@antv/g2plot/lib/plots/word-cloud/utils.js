  ...
  if ((0, util_1.isFunction)(placementStrategy)) {
    var result = words.map(function (word, index, words) {
      return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, word), {
        hasText: !!word.text,
        font: (0, word_cloud_1.functor)(options.font)(word, index, words),
        weight: (0, word_cloud_1.functor)(options.fontWeight)(word, index, words),
        rotate: (0, word_cloud_1.functor)(options.rotate)(word, index, words),
        size: (0, word_cloud_1.functor)(options.fontSize)(word, index, words),
        style: 'normal'
...
function getRotate(options) {
  ...
  if (!(0, util_1.isArray)(rotation)) return rotation;
  var min = rotation[0];
  var max = rotation[1];
