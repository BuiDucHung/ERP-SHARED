  ...
  if (!label) {
    ...
    if (labelCfg.content) {
      ...
      labelCfg.content = function (data, dataum, index) {
        ...
        content_1(tslib_1.__assign(tslib_1.__assign({}, data), {
          percent: percent
        }), dataum, index) : (0, util_1.isString)(content_1) ? (0, utils_1.template)(content_1, {
          value: value,
          name: name,
    ...
    geometry.label({
      ...
      cfg: tslib_1.__assign(tslib_1.__assign({}, labelCfg), {
        offset: (0, utils_2.adaptOffset)(labelCfg.type, labelCfg.offset),
        type: 'pie'
      })
    });
  }
...
function transformStatisticOptions(options) {
  ...
  if (innerRadius && statistic) {
    var _a = (0, utils_1.deepAssign)({}, contants_1.DEFAULT_OPTIONS.statistic, statistic),
      titleOpt_1 = _a.title,
    ...
    if (titleOpt_1 !== false) {
      titleOpt_1 = (0, utils_1.deepAssign)({}, {
        formatter: function (datum) {
          // 交互中, datum existed.
          var text = datum ? datum[colorField] : !(0, util_1.isNil)(titleOpt_1.content) ? titleOpt_1.content : i18n.get(['statistic', 'total']);
          var metaFormatter = (0, util_1.get)(meta, [colorField, 'formatter']) || function (v) {
            return v;
          };
    ...
    if (contentOpt_1 !== false) {
      contentOpt_1 = (0, utils_1.deepAssign)({}, {
        formatter: function (datum, data) {
          ...
          var metaFormatter = (0, util_1.get)(meta, [angleField, 'formatter']) || function (v) {
            return v;
          };
          // 交互中
          if (datum) {
...
function pieAnnotation(params) {
  ...
  /** 中心文本 指标卡 */
  if (innerRadius && statistic) {
    (0, utils_1.renderStatistic)(chart, {
      statistic: statistic,
      plotType: 'pie'
    });
  }
...
function tooltip(params) {
  ...
  if (tooltip === false) {
    ...
    chart.tooltip((0, utils_1.deepAssign)({}, tooltip, {
      shared: false
    }));
      ...
      if ((0, util_1.isEmpty)((0, util_1.get)(tooltip, 'fields'))) {
        ...
        formatter = formatter || function (datum) {
          return {
            ...
            value: (0, util_1.toString)(datum[angleField])
          };
        };
      }
  ...
  (0, util_1.each)(interactions, function (i) {
    ...
    if (i.enable === false) {
      ...
      (0, util_1.each)((_b = i.cfg) === null || _b === void 0 ? void 0 : _b.start, function (stage) {
        startStages_1.push(tslib_1.__assign(tslib_1.__assign({}, stage), {
          arg: {
            statistic: statistic,
            annotations: annotations
          }
      ...
      chart.interaction(i.type, (0, utils_1.deepAssign)({}, i.cfg, {
        start: startStages_1
      }));
    } else {
...
function adaptor(params) {
  ...
  return (0, utils_1.flow)((0, pattern_1.pattern)('pieStyle'), geometry, meta, common_1.theme, coordinate, common_1.legend, tooltip, label, common_1.state, /** 指标卡中心文本 放在下层 */
