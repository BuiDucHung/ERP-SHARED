...
function geometry(params) {
  ...
  var pointParams = (0, utils_1.deepAssign)({}, primary, {
    options: {
      tooltip: false,
      state: pointState
    }
...
function meta(params) {
  ...
  var xAxis = options.xAxis,
    ...
    data = options.data;
  var seriesData = (0, utils_2.getTinyData)(data);
  return (0, utils_1.flow)((0, common_1.scale)((_a = {}, _a[constants_1.X_FIELD] = xAxis, _a[constants_1.Y_FIELD] = yAxis, _a), (_b = {}, _b[constants_1.X_FIELD] = {
    type: 'cat'
  }, _b[constants_1.Y_FIELD] = (0, data_1.adjustYMetaByZero)(seriesData, constants_1.Y_FIELD), _b)))(params);
}
exports.meta = meta;
/**
 * 迷你面积图适配器
