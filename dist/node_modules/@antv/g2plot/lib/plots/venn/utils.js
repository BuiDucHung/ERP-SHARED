...
exports.getColorMap = (0, util_1.memoize)(function (colorPalette, data, blendMode, setsField) {
  ...
  data.forEach(function (d, idx) {
    if (d[setsField].length === 1) {
      ...
      colorMap.set(d[constant_1.ID_FIELD], colorArr.slice(1).reduce(function (a, b) {
        return (0, blend_1.blend)(a, b, blendMode);
      }, colorArr[0]));
    }
  });
  return colorMap;
...
function layoutVennData(options, width, height, padding) {
  ...
  var vennData = data.map(function (d) {
    var _a;
    return tslib_1.__assign(tslib_1.__assign({}, d), (_a = {
      sets: d[setsField] || [],
      size: d[sizeField]
    }, _a[constant_1.PATH_FIELD] = '', _a[constant_1.ID_FIELD] = '', _a));
  });
  // 1. 进行排序，避免图形元素遮挡
