...
function venn(areas, parameters) {
  ...
  var solution = (0, fmin_1.nelderMead)(function (values) {
    var current = {};
...
function getDistanceMatrices(areas, sets, setids) {
  ...
  var distances = (0, fmin_1.zerosM)(sets.length, sets.length),
    constraints = (0, fmin_1.zerosM)(sets.length, sets.length);
...
function constrainedMDSLayout(areas, params) {
  ...
  var norm = (0, fmin_1.norm2)(distances.map(fmin_1.norm2)) / distances.length;
  ...
  for (i = 0; i < restarts; ++i) {
    var initial = (0, fmin_1.zeros)(distances.length * 2).map(Math.random);
  ...
  for (var i = 1; i < mostOverlapped.length; ++i) {
    ...
    for (var j = 0; j < overlap.length; ++j) {
      ...
      for (var k = j + 1; k < overlap.length; ++k) {
        ...
        var extraPoints = (0, circleintersection_1.circleCircleIntersection)({
          x: p1.x,
          y: p1.y,
          radius: d1
        }, {
...
function orientateCircles(circles, orientation, orientationOrder) {
  ...
  if (circles.length == 2) {
    ...
    var dist = (0, circleintersection_1.distance)(circles[0], circles[1]);
