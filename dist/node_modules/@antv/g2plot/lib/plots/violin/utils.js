...
var transformViolinData = function (options) {
  ...
  if (!seriesField) {
    ...
    return Object.keys(group_1).map(function (x) {
      ...
      return tslib_1.__assign(tslib_1.__assign({
        x: x
      }, (0, exports.toViolinValue)(values, pdfOptions)), (0, exports.toBoxValue)(values));
    });
  }
  // 有拆分
  var resultList = [];
  ...
  Object.keys(seriesGroup).forEach(function (series) {
    ...
    return Object.keys(group).forEach(function (key) {
      ...
      resultList.push(tslib_1.__assign(tslib_1.__assign((_a = {
        x: key
      }, _a[seriesField] = series, _a), (0, exports.toViolinValue)(values, pdfOptions)), (0, exports.toBoxValue)(values)));
    });
  });
  return resultList;
};
