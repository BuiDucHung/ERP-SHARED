...
function boxView(params) {
  ...
  var quantileView = chart.createView({
    id: constant_2.QUANTILE_VIEW_ID
  });
  (0, geometries_1.interval)({
    chart: quantileView,
    options: {
...
function meta(params) {
  ...
  var meta = options.meta,
    ...
    yAxis = options.yAxis;
  var baseMeta = {};
  var scales = (0, utils_1.deepAssign)(baseMeta, meta, (_a = {}, _a[constant_2.X_FIELD] = tslib_1.__assign(tslib_1.__assign({
    sync: true
  }, (0, utils_1.pick)(xAxis, constant_1.AXIS_META_CONFIG_KEYS)), {
    // fix:  dodge is not support linear attribute, please use category attribute!
    // 强制 x 轴类型为分类类型
    type: 'cat'
  }), _a[constant_2.VIOLIN_Y_FIELD] = tslib_1.__assign({
    sync: true
  }, (0, utils_1.pick)(yAxis, constant_1.AXIS_META_CONFIG_KEYS)), _a[constant_2.MIN_MAX_FIELD] = tslib_1.__assign({
    sync: constant_2.VIOLIN_Y_FIELD
  }, (0, utils_1.pick)(yAxis, constant_1.AXIS_META_CONFIG_KEYS)), _a[constant_2.QUANTILE_FIELD] = tslib_1.__assign({
    sync: constant_2.VIOLIN_Y_FIELD
  }, (0, utils_1.pick)(yAxis, constant_1.AXIS_META_CONFIG_KEYS)), _a[constant_2.MEDIAN_FIELD] = tslib_1.__assign({
    sync: constant_2.VIOLIN_Y_FIELD
  }, (0, utils_1.pick)(yAxis, constant_1.AXIS_META_CONFIG_KEYS)), _a));
  chart.scale(scales);
  return params;
}
/**
...
function annotation(params) {
  ...
  (0, common_1.annotation)()(tslib_1.__assign(tslib_1.__assign({}, params), {
    chart: violinView
  }));
  return params;
}
