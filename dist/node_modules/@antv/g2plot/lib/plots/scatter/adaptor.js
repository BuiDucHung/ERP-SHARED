...
function meta(params) {
  ...
  return (0, utils_1.flow)((0, common_1.scale)((_a = {}, _a[xField] = xAxis, _a[yField] = yAxis, _a)))((0, utils_1.deepAssign)({}, params, {
    options: newOptions
  }));
}
exports.meta = meta;
  ...
  if (quadrant) {
    ...
    quadrants.forEach(function (_, index) {
      annotationOptions.push(tslib_1.__assign(tslib_1.__assign({
        ...
        style: (0, utils_1.deepAssign)({}, defaultConfig_1.regionStyle[index].style, regionStyle_1 === null || regionStyle_1 === void 0 ? void 0 : regionStyle_1[index])
      }), tslib_1.__assign({
        type: 'text',
        top: true
      }, (0, utils_1.deepAssign)({}, defaultConfig_1.labelStyle[index], labels_1 === null || labels_1 === void 0 ? void 0 : labels_1[index])));
    });
    // 生成坐标轴
      ...
      render: function (container, view) {
        ...
        if (showEquation_1) {
          group.addShape('text', {
            ...
            attrs: tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, defaulEquationStyle_1), equationStyle_1), {
              text: equation
            })
          });
        }
