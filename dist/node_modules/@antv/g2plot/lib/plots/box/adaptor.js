...
function field(params) {
  ...
  if (tooltipOptions !== false) {
    tooltipOptions = (0, utils_1.deepAssign)({}, {
      fields: (0, util_1.isArray)(yField) ? yField : []
    }, tooltipOptions);
  }
...
function outliersPoint(params) {
  ...
  var outliersView = chart.createView({
    padding: padding,
    id: constant_2.OUTLIERS_VIEW_ID
  });
...
function meta(params) {
  ...
  var scales = (0, utils_1.deepAssign)(baseMeta, meta, (_b = {}, _b[xField] = (0, utils_1.pick)(xAxis, constant_1.AXIS_META_CONFIG_KEYS), _b[yFieldName] = (0, utils_1.pick)(yAxis, constant_1.AXIS_META_CONFIG_KEYS), _b));
  chart.scale(scales);
  return params;
}
/**
