...
var DrillDownAction = /** @class */function (_super) {
  ...
  DrillDownAction.prototype.drill = function (nodeInfo) {
    ...
    var transformData = (0, util_1.get)(view, ['interactions', 'drill-down', 'cfg', 'transformData'], function (v) {
      return v;
    });
    // 重新 update 数据
    ...
    cache.forEach(function (record, index) {
      ...
      var textShape = _this.breadCrumbGroup.addShape({
        ...
        attrs: tslib_1.__assign(tslib_1.__assign({
          text: index === 0 && !(0, util_1.isNil)(config.rootText) ? config.rootText : record.name
        }, config.textStyle), {
          x: left,
          y: 0
        })
