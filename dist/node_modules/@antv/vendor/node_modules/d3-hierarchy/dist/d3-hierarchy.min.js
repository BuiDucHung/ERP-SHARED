...
!function (n, r) {
  "object" == typeof exports && "undefined" != typeof module ? r(exports) : "function" == typeof define && define.amd ? define(["exports"], r) : r((n = "undefined" != typeof globalThis ? globalThis : n || self).d3 = n.d3 || {});
}(this, function (n) {
  "use strict";
  ...
  function u(n, r) {
    n instanceof Map ? (n = [void 0, n], void 0 === r && (r = f)) : void 0 === r && (r = o);
    for (var t, e, i, u, a, l = new h(n), p = [l]; t = p.pop();) if ((i = r(t.data)) && (a = (i = Array.from(i)).length)) for (t.children = i, u = a - 1; u >= 0; --u) p.push(e = i[u] = new h(i[u])), e.parent = t, e.depth = t.depth + 1;
  ...
  h.prototype = u.prototype = {
    ...
    eachAfter: function (n, r) {
      for (var t, e, i, u = this, o = [u], f = [], a = -1; u = o.pop();) if (f.push(u), t = u.children) for (e = 0, i = t.length; e < i; ++e) o.push(t[e]);
  ...
  function y(n, r) {
    for (var t, e, i = 0, u = (n = function (n, r) {
        let t,
          e,
          i = n.length;
        for (; i;) e = r() * i-- | 0, t = n[i], n[i] = n[e], n[e] = t;
        return n;
      }(Array.from(n), r)).length, o = []; i < u;) t = n[i], e && w(e, t) ? ++i : (e = M(o = g(o, t)), i = 0);
    return e;
  }
  function g(n, r) {
    var t, e;
    if (_(r, n)) return [r];
    for (t = 0; t < n.length; ++t) if (m(r, n[t]) && _(z(n[t], r), n)) return [n[t], r];
    for (t = 0; t < n.length - 1; ++t) for (e = t + 1; e < n.length; ++e) if (m(z(n[t], n[e]), r) && m(z(n[t], r), n[e]) && m(z(n[e], r), n[t]) && _(B(n[t], n[e], r), n)) return [n[t], n[e], r];
    throw new Error();
  }
  function m(n, r) {
    var t = n.r - r.r,
  ...
  function B(n, r, t) {
    var e = n.x,
      ...
      q = 2 * (u + M * z + B * A),
      E = M * M + B * B - u * u,
      S = -(Math.abs(b) > 1e-6 ? (q + Math.sqrt(q * q - 4 * b * E)) / (2 * b) : E / q);
    return {
      x: e + M + z * S,
      y: i + B + A * S,
      r: S
  ...
  function A(n, r, t) {
    var e,
      ...
      a = n.y - r.y,
      c = f * f + a * a;
    c ? (i = r.r + t.r, i *= i, o = n.r + t.r, i > (o *= o) ? (e = (c + o - i) / (2 * c), u = Math.sqrt(Math.max(0, o / c - e * e)), t.x = n.x - e * f - u * a, t.y = n.y - e * a + u * f) : (e = (c + i - o) / (2 * c), u = Math.sqrt(Math.max(0, i / c - e * e)), t.x = r.x + e * f - u * a, t.y = r.y + e * a + u * f)) : (t.x = r.x + t.r, t.y = r.y);
  }
  function b(n, r) {
    var t = n.r + r.r - 1e-6,
      e = r.x - n.x,
  ...
  function E(n, r) {
    if (!(o = (t = n, n = "object" == typeof t && "length" in t ? t : Array.from(t)).length)) return 0;
    var t, e, i, u, o, f, a, c, h, l, p, d;
    if ((e = n[0]).x = 0, e.y = 0, !(o > 1)) return e.r;
    if (i = n[1], e.x = -i.r, i.x = e.r, i.y = 0, !(o > 2)) return e.r + i.r;
    A(i, e, u = n[2]), e = new Node(e), i = new Node(i), u = new Node(u), e.next = u.previous = i, i.next = e.previous = u, u.next = i.previous = e;
    n: for (c = 3; c < o; ++c) {
      A(e._, i._, u = n[c]), u = new Node(u), h = i.next, l = e.previous, p = i._.r, d = e._.r;
      do {
        if (p <= d) {
          if (b(h._, u._)) {
      ...
      for (u.previous = e, u.next = i, e.next = i.previous = i = u, f = q(e); (u = u.next) !== i;) (a = q(u)) < f && (e = u, f = a);
      i = e.next;
    }
  ...
  function O(n, r, t, e, i) {
    for (var u, o = n.children, f = -1, a = o.length, c = n.value && (e - r) / n.value; ++f < a;) (u = o[f]).y0 = t, u.y1 = i, u.x0 = r, u.x1 = r += u.value * c;
  }
  var R = {
      depth: -1
    },
  ...
  function U(n, r, t, e, i) {
    for (var u, o = n.children, f = -1, a = o.length, c = n.value && (i - t) / n.value; ++f < a;) (u = o[f]).x0 = r, u.x1 = e, u.y0 = t, u.y1 = t += u.value * c;
  }
  Q.prototype = Object.create(h.prototype);
  var V = (1 + Math.sqrt(5)) / 2;
  function W(n, r, t, e, i, u) {
    for (var o, f, a, c, h, l, p, d, s, v, x, y = [], g = r.children, m = 0, w = 0, _ = g.length, M = r.value; m < _;) {
      a = i - t, c = u - e;
      do {
        h = g[w++].value;
      } while (!h && w < _);
      for (l = p = h, x = h * h * (v = Math.max(c / a, a / c) / (M * n)), s = Math.max(p / x, x / l); w < _; ++w) {
        if (h += f = g[w].value, f < l && (l = f), f > p && (p = f), x = h * h * v, (d = Math.max(p / x, x / l)) > s) {
          h -= f;
          break;
        }
        s = d;
      ...
      }), o.dice ? O(o, t, e, i, M ? e += c * h / M : u) : U(o, t, e, M ? t += a * h / M : i, u), M -= h, m = w;
    }
    return y;
  }
  var X = function n(r) {
  ...
  var Y = function n(r) {
    function t(n, t, e, i, u) {
      if ((o = n._squarify) && o.ratio === r) for (var o, f, a, c, h, l = -1, p = o.length, d = n.value; ++l < p;) {
        for (a = (f = o[l]).children, c = f.value = 0, h = a.length; c < h; ++c) f.value += a[c].value;
        f.dice ? O(f, t, e, i, d ? e += (u - e) * f.value / d : u) : U(f, t, e, d ? t += (i - t) * f.value / d : i, u), d -= f.value;
  ...
  n.Node = h, n.cluster = function () {
    ...
    return f.separation = function (r) {
      return arguments.length ? (n = r, f) : n;
    }, f.size = function (n) {
      return arguments.length ? (o = !1, i = +n[0], u = +n[1], f) : o ? null : [i, u];
    }, f.nodeSize = function (n) {
      return arguments.length ? (o = !0, i = +n[0], u = +n[1], f) : o ? [i, u] : null;
    }, f;
    ...
    function i(i) {
      const u = x();
      return i.x = r / 2, i.y = t / 2, n ? i.eachBefore(k(n)).eachAfter(I(e, .5, u)).eachBefore(T(1)) : i.eachBefore(k(S)).eachAfter(I(d, 1, u)).eachAfter(I(e, i.r / Math.min(r, t), u)).eachBefore(T(Math.min(r, t) / (2 * i.r))), i;
    }
    return i.radius = function (r) {
      ...
      return arguments.length ? (e = "function" == typeof n ? n : s(+n), i) : e;
    }, i;
    ...
    function i(i) {
      ...
      return i.x0 = i.y0 = t, i.x1 = n, i.y1 = r / u, i.eachBefore(function (n, r) {
        return function (e) {
          e.children && O(e, e.x0, n * (e.depth + 1) / r, e.x1, n * (e.depth + 2) / r);
          var i = e.x0,
            u = e.y0,
            o = e.x1 - t,
            f = e.y1 - t;
          o < i && (i = o = (i + o) / 2), f < u && (u = f = (u + f) / 2), e.x0 = i, e.y0 = u, e.x1 = o, e.y1 = f;
        };
      }(r, u)), e && i.eachBefore(j), i;
    }
    ...
    function e(e) {
      ...
      if (null != n) {
        const r = s.map((r, t) => function (n) {
          ...
          t = r.map(P),
          i = new Set(r).add("");
        for (const n of t) i.has(n) || (i.add(n), r.push(n), t.push(P(n)), s.push(L));
        v = (n, t) => r[t], x = (n, r) => t[r];
      }
      for (o = 0, i = s.length; o < i; ++o) u = s[o], l = s[o] = new h(u), null != (p = v(u, o, e)) && (p += "") && (d = l.id = p, y.set(d, y.has(d) ? D : l)), null != (p = x(u, o, e)) && (p += "") && (l.parent = p);
      for (o = 0; o < i; ++o) if (p = (l = s[o]).parent) {
      ...
      if (null != n) {
        for (; f.data === L && 1 === f.children.length;) f = f.children[0], --i;
        for (let n = s.length - 1; n >= 0 && (l = s[n], l.data === L); --n) l.data = null;
      }
      if (f.parent = R, f.eachBefore(function (n) {
        n.depth = n.parent.depth + 1, --i;
      }).eachBefore(c), f.parent = null, i > 0) throw new Error("cycle");
      return f;
    }
    ...
    function i(i) {
      var a = function (n) {
        for (var r, t, e, i, u, o = new Q(n, 0), f = [o]; r = f.pop();) if (e = r._.children) for (r.children = new Array(u = e.length), i = u - 1; i >= 0; --i) f.push(t = r.children[i] = new Q(e[i], i)), t.parent = r;
        return (o.parent = new Q(null, 0)).children = [o], o;
      }(i);
      if (a.eachAfter(u), a.parent.m = -a.z, a.eachBefore(o), e) i.eachBefore(f);else {
        var c = i,
          h = i,
          l = i;
    ...
    function u(r) {
      ...
      r.parent.A = function (r, t, e) {
        if (t) {
          for (var i, u = r, o = r, f = t, a = u.parent.children[0], c = u.m, h = o.m, l = f.m, p = a.m; f = H(f), u = G(u), f && u;) a = G(a), (o = H(o)).a = r, (i = f.z + l - u.z - c + n(f._, u._)) > 0 && (J(K(f, r, e), r, i), c += i, h += i), l += f.m, c += u.m, p += a.m, h += o.m;
          f && !H(o) && (o.t = f, o.m += l - h), u && !G(a) && (a.t = u, a.m += c - p, e = r);
        }
        return e;
      }(r, i, r.parent.A || e[0]);
    }
    ...
    var n = X,
      ...
      c = d;
    function h(n) {
      return n.x0 = n.y0 = 0, n.x1 = t, n.y1 = e, n.eachBefore(l), i = [0], r && n.eachBefore(j), n;
    }
    function l(r) {
      var t = i[r.depth],
        e = r.x0 + t,
        ...
        l = r.x1 - t,
        p = r.y1 - t;
      l < e && (e = l = (e + l) / 2), p < h && (h = p = (h + p) / 2), r.x0 = e, r.y0 = h, r.x1 = l, r.y1 = p, r.children && (t = i[r.depth + 1] = u(r) / 2, e += c(r) - t, h += o(r) - t, (l -= f(r) - t) < e && (e = l = (e + l) / 2), (p -= a(r) - t) < h && (h = p = (h + p) / 2), n(r, e, h, l, p));
    }
    return h.round = function (n) {
      ...
      return arguments.length ? (u = "function" == typeof n ? n : s(+n), h) : u;
      ...
      return arguments.length ? (o = "function" == typeof n ? n : s(+n), h) : o;
    }, h.paddingRight = function (n) {
      return arguments.length ? (f = "function" == typeof n ? n : s(+n), h) : f;
    }, h.paddingBottom = function (n) {
      return arguments.length ? (a = "function" == typeof n ? n : s(+n), h) : a;
    }, h.paddingLeft = function (n) {
      return arguments.length ? (c = "function" == typeof n ? n : s(+n), h) : c;
    }, h;
  ...
  }, n.treemapDice = O, n.treemapResquarify = Y, n.treemapSlice = U, n.treemapSliceDice = function (n, r, t, e, i) {
    (1 & n.depth ? U : O)(n, r, t, e, i);
  }, n.treemapSquarify = X, Object.defineProperty(n, "__esModule", {
    value: !0
  });
});