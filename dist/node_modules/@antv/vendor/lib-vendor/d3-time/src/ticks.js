...
function ticker(year, month, week, day, hour, minute) {
  ...
  function ticks(start, stop, count) {
    ...
    var ref;
    if (reverse) ref = [stop, start], start = ref[0], stop = ref[1], ref;
  ...
  function tickInterval(start, stop, count) {
    ...
    var _tickIntervals_ = _sliced_to_array(tickIntervals[target / tickIntervals[i - 1][2] < tickIntervals[i][2] / target ? i - 1 : i], 2),
      t = _tickIntervals_[0],
      step = _tickIntervals_[1];
    return t.every(step);
  }
  return [ticks, tickInterval];
}
var _ticker = _sliced_to_array(ticker(_year.utcYear, _month.utcMonth, _week.utcSunday, _day.unixDay, _hour.utcHour, _minute.utcMinute), 2),
  utcTicks = _ticker[0],
  utcTickInterval = _ticker[1];
var _ticker1 = _sliced_to_array(ticker(_year.timeYear, _month.timeMonth, _week.timeSunday, _day.timeDay, _hour.timeHour, _minute.timeMinute), 2),
  timeTicks = _ticker1[0],
  timeTickInterval = _ticker1[1];