...
function transformer() {
  ...
  scale.domain = function (_) {
    var ref;
    return arguments.length ? (ref = _sliced_to_array(_, 2), x0 = ref[0], x1 = ref[1], ref, t0 = transform(x0 = +x0), t1 = transform(x1 = +x1), k10 = t0 === t1 ? 0 : 1 / (t1 - t0), scale) : [x0, x1];
  };
  ...
  function range(interpolate) {
    return function (_) {
      var r0, r1;
      var ref;
      return arguments.length ? (ref = _sliced_to_array(_, 2), r0 = ref[0], r1 = ref[1], ref, interpolator = interpolate(r0, r1), scale) : [interpolator(0), interpolator(1)];
    };
  }
