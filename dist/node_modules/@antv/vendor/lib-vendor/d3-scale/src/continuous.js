...
function transformer() {
  var domain = unit,
    range = unit,
    interpolate = _index1.interpolate,
    transform,
    untransform,
    unknown,
    clamp = identity,
  ...
  scale.invert = function (y) {
    return clamp(untransform((input || (input = piecewise(range, domain.map(transform), _index1.interpolateNumber)))(y)));
  };
  ...
  scale.rangeRound = function (_) {
    return range = Array.from(_), interpolate = _index1.interpolateRound, rescale();
  };
