...
function groupSort(values, reduce, key) {
  return (reduce.length !== 2 ? (0, _sort.default)((0, _group.rollup)(values, reduce, key), function (param, param1) {
    var _param = _sliced_to_array(param, 2),
      ak = _param[0],
      av = _param[1],
      _param1 = _sliced_to_array(param1, 2),
      bk = _param1[0],
      bv = _param1[1];
    return (0, _ascending.default)(av, bv) || (0, _ascending.default)(ak, bk);
  }) : (0, _sort.default)((0, _group.default)(values, key), function (param, param1) {
    var _param = _sliced_to_array(param, 2),
      ak = _param[0],
      av = _param[1],
      _param1 = _sliced_to_array(param1, 2),
