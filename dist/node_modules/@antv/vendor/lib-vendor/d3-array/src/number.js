...
function numbers(values, valueof) {
  ...
  return _ts_generator(this, function (_state) {
    switch (_state.label) {
      case 0:
        if (!(valueof === undefined)) return [3, 9];
      ...
      case 2:
        ...
        value = _step.value;
        if (!(value != null && (value = +value) >= value)) return [3, 4];
        return [4, value];
      case 3:
        _state.sent();
        _state.label = 4;
      ...
      case 9:
        ...
        _state.label = 10;
      case 10:
        _state.trys.push([10, 15, 16, 17]);
        _iterator1 = values[Symbol.iterator]();
        _state.label = 11;
      case 11:
        if (!!(_iteratorNormalCompletion1 = (_step1 = _iterator1.next()).done)) return [3, 14];
        value1 = _step1.value;
        if (!((value1 = valueof(value1, ++index, values)) != null && (value1 = +value1) >= value1)) return [3, 13];
        return [4, value1];
      case 12:
        _state.sent();
        _state.label = 13;
