...
function _default() {
  ...
  function force(_) {
    var i,
      n = nodes.length,
      tree = (nDim === 1 ? (0, _index.binarytree)(nodes, _simulation.x) : nDim === 2 ? (0, _index1.quadtree)(nodes, _simulation.x, _simulation.y) : nDim === 3 ? (0, _index2.octree)(nodes, _simulation.x, _simulation.y, _simulation.z) : null).visitAfter(accumulate);
  ...
  function apply(treeNode, x1, arg1, arg2, arg3) {
    ...
    if (w * w / theta2 < l) {
      if (l < distanceMax2) {
        ...
        if (nDim > 1 && y === 0) y = (0, _jiggle.default)(random), l += y * y;
        if (nDim > 2 && z === 0) z = (0, _jiggle.default)(random), l += z * z;
