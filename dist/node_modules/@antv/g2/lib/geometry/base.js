...
var Geometry = /** @class */function (_super) {
  ...
  Geometry.prototype.paint = function (isUpdate) {
    ...
    if (this.labelOption) {
      ...
      var callback = function () {
        return _this.renderLabels((0, util_1.flatten)(_this.dataArray), isUpdate);
      }.bind(this);
  ...
  Geometry.prototype.getXYFields = function () {
    var _a = tslib_1.__read(this.attributeOption.position.fields, 2),
      x = _a[0],
      y = _a[1];
    return [x, y];
  };
  ...
  Geometry.prototype.updateElements = function (mappingDataArray, isUpdate) {
    ...
    var _d = (0, diff_1.diff)(this.lastElementsMap, keys),
      added = _d.added,
      updated = _d.updated,
      removed = _d.removed;
    try {
