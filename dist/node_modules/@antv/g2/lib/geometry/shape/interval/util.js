...
function getBackgroundRectPath(cfg, points, coordinate) {
  ...
  if (coordinate.isRect) {
    ...
    if (radius) {
      ...
      var _a = tslib_1.__read(parseRadius(radius, Math.min(width, height)), 4),
        r1 = _a[0],
        r2 = _a[1],
        r3 = _a[2],
        r4 = _a[3];
...
function getRectWithCornerRadius(points, coordinate, radius) {
  ...
  // 获取 四个关键点
  var _h = tslib_1.__read(tslib_1.__spreadArray([], tslib_1.__read(points), false), 4),
    p0 = _h[0],
    p1 = _h[1],
    p2 = _h[2],
    p3 = _h[3];
  var _j = tslib_1.__read(typeof radius === 'number' ? Array(4).fill(radius) : radius, 4),
    r1 = _j[0],
    r2 = _j[1],
    r3 = _j[2],
    r4 = _j[3];
  ...
  _f = tslib_1.__read(parseRadius([r1, r2, r3, r4], Math.min(abs(p3.x - p0.x), abs(p1.y - p0.y))).map(function (d) {
    return abs(d);
