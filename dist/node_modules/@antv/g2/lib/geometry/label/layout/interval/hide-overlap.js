...
function intervalHideOverlap(items, labels, shapes) {
  ...
  var _b = tslib_1.__read(geometry.getXYFields(), 1),
    xField = _b[0];
  var dones = [];
  var todo = [];
  var groupedLabels = (0, util_1.groupBy)(filteredLabels, function (label) {
    return label.get('data')[xField];
  });
  var xValues = (0, util_1.uniq)((0, util_1.map)(filteredLabels, function (label) {
    return label.get('data')[xField];
  }));
  var xValue;
