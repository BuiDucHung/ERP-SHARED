...
(0, core_9.registerAction)('x-rect-multi-mask', dim_rect_2.default, {
  dim: 'x'
});
(0, core_9.registerAction)('y-rect-multi-mask', dim_rect_2.default, {
  dim: 'y'
});
...
(0, core_10.registerInteraction)('brush-x-multi', {
  ...
  processing: [{
    trigger: 'mousemove',
    isEnable: function (context) {
      return !(0, util_1.isMultipleMask)(context);
    },
