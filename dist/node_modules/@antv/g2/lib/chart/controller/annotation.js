...
var Annotation = /** @class */function (_super) {
  ...
  Annotation.prototype.parsePosition = function (p) {
    ...
    if ((0, util_1.isArray)(position)) {
      var _b = tslib_1.__read(position, 2),
        xPos = _b[0],
        yPos = _b[1];
      // 如果数据格式是 ['50%', '50%'] 的格式
  ...
  Annotation.prototype.getAnnotationCfg = function (type, option, theme) {
    ...
    if (type === 'arc') {
      var _a = option,
        start_1 = _a.start,
        end_1 = _a.end,
        rest = tslib_1.__rest(_a, ["start", "end"]);
      ...
      o = tslib_1.__assign(tslib_1.__assign({}, rest), {
      ...
      var _b = option,
        start_2 = _b.start,
        end_2 = _b.end,
        rest = tslib_1.__rest(_b, ["start", "end"]);
      o = tslib_1.__assign(tslib_1.__assign({}, rest), {
        start: sp,
        end: ep,
        src: option.src
      ...
      var _c = option,
        start_3 = _c.start,
        end_3 = _c.end,
        rest = tslib_1.__rest(_c, ["start", "end"]);
      o = tslib_1.__assign(tslib_1.__assign({}, rest), {
        start: sp,
        end: ep,
      ...
      var _d = option,
        start_4 = _d.start,
        end_4 = _d.end,
        rest = tslib_1.__rest(_d, ["start", "end"]);
      o = tslib_1.__assign(tslib_1.__assign({}, rest), {
        start: sp,
        end: ep
      });
      ...
      o = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, textPoint), rest), {
        content: textContent
      });
      ...
      var _f = option,
        ...
        rest = tslib_1.__rest(_f, ["position", "point", "line", "text", "autoAdjust", "direction"]);
      o = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, rest), textPoint), {
      ...
      var _g = option,
        ...
        rest = tslib_1.__rest(_g, ["start", "end", "region", "text", "lineLength"]);
      o = tslib_1.__assign(tslib_1.__assign({}, rest), {
      ...
      var _h = option,
        ...
        apply_1 = _h.apply,
        color = _h.color,
        rest = tslib_1.__rest(_h, ["start", "end", "apply", "color"]);
    ...
    // 合并主题，用户配置优先级高于默认主题
    var cfg = (0, util_1.deepMix)({}, theme, tslib_1.__assign(tslib_1.__assign({}, o), {
      top: option.top,
      style: option.style,
  ...
  Annotation.prototype.updateOrCreate = function (option) {
    ...
    if (co) {
      ...
      co.component.update(tslib_1.__assign(tslib_1.__assign({}, cfg || {}), {
        visible: !!cfg
      }));
