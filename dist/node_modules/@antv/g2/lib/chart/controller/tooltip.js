    ...
    try {
      for (var items_3 = tslib_1.__values(items), items_3_1 = items_3.next(); !items_3_1.done; items_3_1 = items_3.next()) {
        ...
        if (limitInPlot || (tooltipMarkersGroup === null || tooltipMarkersGroup === void 0 ? void 0 : tooltipMarkersGroup.getClip())) {
          var _b = (0, coordinate_1.getCoordinateClipCfg)(rootView.getCoordinate()),
            type = _b.type,
            attrs_1 = _b.attrs;
        ...
        var markerDefaultCfg = (0, util_1.get)(theme, ['components', 'tooltip', 'marker'], {});
        var attrs = tslib_1.__assign(tslib_1.__assign({
          fill: item.color,
          symbol: 'circle',
          shadowColor: item.color
        }, (0, util_1.isFunction)(marker) ? tslib_1.__assign(tslib_1.__assign({}, markerDefaultCfg), marker(item)) : marker), {
          x: x,
          y: y
        });
