...
var Scrollbar = /** @class */function (_super) {
  ...
  Scrollbar.prototype.layout = function () {
    ...
    if (this.scrollbar) {
      ...
      var y = void 0;
      if (cfg.isHorizontal) {
        var _a = tslib_1.__read((0, direction_1.directionToPosition)(this.view.viewBBox, bbox, constant_1.DIRECTION.BOTTOM), 2),
          x1 = _a[0],
          y1 = _a[1];
        var _b = tslib_1.__read((0, direction_1.directionToPosition)(this.view.coordinateBBox, bbox, constant_1.DIRECTION.BOTTOM), 2),
          x2 = _b[0],
          y2 = _b[1];
        x = x2;
        y = y1;
      } else {
        var _c = tslib_1.__read((0, direction_1.directionToPosition)(this.view.viewBBox, bbox, constant_1.DIRECTION.RIGHT), 2),
          x1 = _c[0],
          y1 = _c[1];
        var _d = tslib_1.__read((0, direction_1.directionToPosition)(this.view.viewBBox, bbox, constant_1.DIRECTION.RIGHT), 2),
          x2 = _d[0],
          y2 = _d[1];
        x = x2;
        y = y1;
  ...
  Scrollbar.prototype.getScrollbarTheme = function (style) {
    ...
    var _a = style || {},
      ...
      restStyles = tslib_1.__rest(_a, ["thumbHighlightColor"]);
    return {
      default: (0, util_1.deepMix)({}, (0, util_1.get)(theme, ['default', 'style'], {}), restStyles),
      hover: (0, util_1.deepMix)({}, (0, util_1.get)(theme, ['hover', 'style'], {}), {
  ...
  Scrollbar.prototype.getScrollbarComponentCfg = function () {
    ...
    var _b = this.getValidScrollbarCfg(),
      ...
      style = _b.style;
    var isHorizontal = type !== 'vertical';
    var _c = tslib_1.__read(padding, 4),
      paddingTop = _c[0],
      paddingRight = _c[1],
      paddingBottom = _c[2],
      paddingLeft = _c[3];
