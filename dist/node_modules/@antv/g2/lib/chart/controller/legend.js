...
var Legend = /** @class */function (_super) {
  ...
  Legend.prototype.layout = function () {
    ...
    (0, util_1.each)(this.components, function (co) {
      ...
      var _a = tslib_1.__read((0, direction_1.directionToPosition)(_this.view.viewBBox, bbox, direction), 2),
        x1 = _a[0],
        y1 = _a[1];
      var _b = tslib_1.__read((0, direction_1.directionToPosition)(_this.layoutBBox, bbox, direction), 2),
        x2 = _b[0],
        y2 = _b[1];
      var x = 0;
      var y = 0;
