...
var Constraint = /** @class */function () {
  ...
  Constraint.prototype.getGaussArr = function (variableMap) {
    ...
    this.elements.forEach(function (element) {
      var _a = tslib_1.__read(_this.parseElement(element), 2),
        a = _a[0],
        variable = _a[1];
  ...
  Constraint.prototype.parseElement = function (e) {
    ...
    if (Array.isArray(e)) {
      var mul = (0, gauss_1.multiply)(e.filter(function (i) {
        return (0, util_1.isNumber)(i);
      }));
      var variable = e.find(function (i) {
        return variable_1.Variable.isVariable(i);
      });
      return [mul, variable];
    }
    // 其他非法情况
