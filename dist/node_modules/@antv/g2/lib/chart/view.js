...
var View = /** @class */function (_super) {
  ...
  View.prototype.createView = function (cfg) {
    ...
    var v = new View(tslib_1.__assign(tslib_1.__assign({
      ...
      options: tslib_1.__assign(tslib_1.__assign({}, sharedOptions), (0, util_1.get)(cfg, 'options', {}))
    }));
    this.views.push(v);
    return v;
  };
  ...
  View.prototype.adjustCategoryScaleRange = function () {
    var _this = this;
    var xyScales = tslib_1.__spreadArray([this.getXScale()], tslib_1.__read(this.getYScales()), false).filter(function (e) {
      return !!e;
    });
    var coordinate = this.getCoordinate();
