...
var Labels = /** @class */function () {
  ...
  Labels.prototype.renderLabel = function (cfg, container) {
    ...
    var labelGroup = container.addGroup(tslib_1.__assign({
      ...
      animateCfg: this.animate === false || animate === null || animate === false ? false : (0, util_1.deepMix)({}, this.animate, animate)
    }, shapeAppendCfg));
    var labelShape;
    if (content.isGroup && content.isGroup() || content.isShape && content.isShape()) {
      ...
      labelShape = labelGroup.addShape('text', tslib_1.__assign({
        attrs: tslib_1.__assign(tslib_1.__assign({
          ...
          textBaseline: (0, util_1.get)(cfg, 'textBaseline', 'middle'),
          text: cfg.content
        }, cfg.style), {
          fill: (0, util_1.isNull)(fill) ? cfg.color : fill
        })
      }, shapeAppendCfg));
    }
    if (cfg.rotate) {
      ...
      if (!labelGroup.destroyed) {
        labelGroup.addShape('path', {
          ...
          attrs: tslib_1.__assign({
            path: path,
            stroke: labelItem.color ? labelItem.color : (0, util_1.get)(labelItem, ['style', 'fill'], '#000'),
            fill: null
          }, labelLineCfg.style),
          id: id,
    ...
    (0, util_1.each)(labelItems, function (labelItem) {
      ...
      if (!labelGroup.destroyed) {
        ...
        if (labelContentShape) {
          var _a = (0, util_2.getLabelBackgroundInfo)(labelGroup, labelItem, background.padding),
