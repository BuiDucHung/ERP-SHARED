 ...
 */
import { FederatedEvent, ERROR_MSG_METHOD_NOT_IMPLEMENTED, propertyMetadataCache, runtime, getAngle, CameraType, deg2rad, createVec3, Camera, Rectangle, isBrowser, Rect, Circle, Path, CustomElement, ElementEvent, Shape, PropertySyntax, CSS } from '@antv/g-lite';
...
import { clamp, isNumber, isNil, isString, isNumberEqual } from '@antv/util';
...
var ImageExporter = /*#__PURE__*/function () {
  ...
  return _createClass(ImageExporter, [{
        ...
        return _regeneratorRuntime().wrap(function (_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _options$clippingRegi = options.clippingRegion, clippingRegion = _options$clippingRegi === void 0 ? new Rectangle(0, 0, width, height) : _options$clippingRegi, beforeDrawImage = options.beforeDrawImage, afterDrawImage = options.afterDrawImage, _ignoreElements = options.ignoreElements, rest = _objectWithoutProperties(options, _excluded$1);
              _context.next = 1;
    ...
    value: function isSVG() {
      return isBrowser && this.options.canvas.getContextService().getDomElement() instanceof SVGSVGElement;
    }
  }, {
    key: "toSVGDataURL",
    value: function () {
...
var Arrow = /*#__PURE__*/function (_CustomElement) {
  ...
  return _createClass(Arrow, [{
    ...
    value: function handleBodyAttributeChanged(body) {
      var _this2 = this;
      body.addEventListener(ElementEvent.ATTR_MODIFIED, function (e) {
...
var Sector = /*#__PURE__*/function (_Path) {
  ...
  return _createClass(Sector, [{
    ...
    value: function updatePath() {
      ...
      var path = this.createPath(x, y, startAngle ? deg2rad(startAngle) : 0, endAngle ? deg2rad(endAngle) : Math.PI * 2, sr || 0, sr0 || 0, radius || [0, 0, 0, 0]);
...
export { AdvancedCamera, Animation, AnimationEvent, AnimationTimeline, Arrow, EasingFunctions, ImageExporter, KeyframeEffect, Sector, compareAnimations, defaultDotPatternCfg, defaultLinePatternCfg, defaultSquarePatternCfg, dots, lines, makeTiming, normalizeKeyframes, normalizeTimingInput, numericTimingToObject, squares };