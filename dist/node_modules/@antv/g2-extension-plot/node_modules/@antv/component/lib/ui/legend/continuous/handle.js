...
var Handle = /** @class */function (_super) {
  ...
  Handle.prototype.renderMarker = function (container) {
    ...
    var _a = this.attributes,
      ...
      _b = _a.markerSymbol,
      markerSymbol = _b === void 0 ? (0, utils_1.ifHorizontal)(orientation, 'horizontalHandle', 'verticalHandle') : _b;
    (0, util_1.ifShow)(!!markerSymbol, container, function (group) {
      var handleStyle = (0, util_1.subStyleProps)(_this.attributes, 'marker');
      var markerStyle = tslib_1.__assign({
        symbol: markerSymbol
      }, handleStyle);
      var markerClassName = (0, classname_1.getLegendClassName)(CLASS_NAMES.marker.name, classname_map_1.CLASSNAME_SUFFIX_MAP.handleMarker, classNamePrefix);
      _this.marker = group.maybeAppendByClassName(CLASS_NAMES.marker, function () {
        return new marker_1.Marker({
          style: markerStyle,
      ...
      if (classNamePrefix) {
        ...
        if (markerElement) {
          ...
          var legendClassName = (0, classname_1.getLegendClassName)(baseClass, classname_map_1.CLASSNAME_SUFFIX_MAP.handleMarker, classNamePrefix);
  ...
  Handle.prototype.renderLabel = function (container) {
    ...
    (0, util_1.ifShow)(showLabel, container, function (group) {
      var _a;
      var _b = (0, util_1.subStyleProps)(_this.attributes, 'label'),
        text = _b.text,
        labelStyle = tslib_1.__rest(_b, ["text"]);
      // adjust layout
      ...
      var _f = tslib_1.__read((0, utils_1.ifHorizontal)(orientation, [0, height + spacing, 'center', 'top'], [width + spacing, 0, 'start', 'middle']), 4),
        x = _f[0],
        y = _f[1],
        textAlign = _f[2],
        textBaseline = _f[3];
      var labelClassName = (0, classname_1.getLegendClassName)(CLASS_NAMES.label.name, classname_map_1.CLASSNAME_SUFFIX_MAP.handleLabel, classNamePrefix);
      group.maybeAppendByClassName(CLASS_NAMES.label, 'text').attr('className', labelClassName).styles(tslib_1.__assign(tslib_1.__assign({}, labelStyle), {
        x: x,
        y: y,
