...
var Layout = /** @class */function (_super) {
  ...
  Layout.prototype.getBBox = function () {
    var _a = this.attributes,
      ...
      width = _a.width,
      height = _a.height;
    var _d = tslib_1.__read(this.$margin, 4),
      marginTop = _d[0],
      marginRight = _d[1],
      marginBottom = _d[2],
      marginLeft = _d[3];
  ...
  Layout.prototype.getAvailableSpace = function () {
    var _a = this.attributes,
      width = _a.width,
      height = _a.height;
    var _b = tslib_1.__read(this.$padding, 4),
      paddingTop = _b[0],
      paddingRight = _b[1],
      paddingBottom = _b[2],
      paddingLeft = _b[3];
    var _c = tslib_1.__read(this.$margin, 4),
      marginTop = _c[0],
      marginLeft = _c[3];
  ...
  Layout.prototype.layout = function () {
    ...
    try {
      ...
      var bboxes_1 = (0, layout_1.calcLayout)(this.getAvailableSpace(), this.children.map(function (child) {
