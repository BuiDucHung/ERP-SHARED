...
var Switch = /** @class */function (_super) {
  ...
  Switch.prototype.render = function (attributes, container) {
    ...
    var _a = (0, util_1.get)(constant_1.SIZE_STYLE, size, constant_1.SIZE_STYLE.default),
    ...
    if (checkedChildren || unCheckedChildren) {
      (0, util_2.select)(group).maybeAppendByClassName('switch-tag', function () {
        return new tag_1.Tag({});
      }).call(function (selection) {
        var tagShape = selection.node();
        tagShape.update(tslib_1.__assign(tslib_1.__assign({
          cursor: cursor,
        ...
        backgroundStyle = tslib_1.__assign(tslib_1.__assign({}, sizeStyle), {
    ...
    // 背景 组件
    var backgroundShape = (0, util_2.select)(group).maybeAppendByClassName('switch-background', 'rect').styles(tslib_1.__assign({
    ...
    // 背景阴影动效 组件
    var backgroundStrokeShape = (0, util_2.select)(group).maybeAppendByClassName('switch-background-stroke', 'rect').styles(tslib_1.__assign({
    ...
    // 控件 组件
    (0, util_2.select)(group).maybeAppendByClassName('switch-handle', 'rect').styles({
      fill: '#fff',
      cursor: cursor
    }).call(function (selection) {
      var _a, _b;
