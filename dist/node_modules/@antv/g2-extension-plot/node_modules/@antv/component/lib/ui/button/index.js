...
var Button = /** @class */function (_super) {
  ...
  Button.prototype.render = function (attributes, container) {
    ...
    var _f = tslib_1.__read((0, util_2.parseSeriesAttr)(padding), 4),
      pt = _f[0],
      pr = _f[1],
      pb = _f[2],
      pl = _f[3];
    ...
    var style = tslib_1.__assign(tslib_1.__assign({}, markerStyle), {
      symbol: markerSymbol,
      x: x + pl + markerSize / 2,
      y: y + height / 2,
      size: markerSize
    });
    var markerShape = (0, util_2.maybeAppend)(container, '.marker', function () {
    ...
    this.textShape = (0, util_2.maybeAppend)(container, '.text', 'text').attr('className', 'text').styles(tslib_1.__assign(tslib_1.__assign({
    ...
    (0, util_2.select)(container).maybeAppendByClassName('.background', 'rect').styles(tslib_1.__assign(tslib_1.__assign({
      zIndex: -1
    }, buttonStyle), {
      x: x,
      y: y,
