...
var methods = {
  parity: function (items, _a) {
    ...
    return items.filter(function (item, i) {
      return i % seq ? ((0, util_1.hide)(item), false) : true;
    });
  }
};
var filterDefined = function (arr) {
  return arr.filter(util_1.defined);
};
function hideLabels(labels, overlapCfg, attr, utils) {
  ...
  var minLabelWidth = Math.min.apply(Math, tslib_1.__spreadArray([1], tslib_1.__read(labels.map(function (d) {
  ...
  reset(source);
  while (seq < labels.length && (0, test_1.boundTest)(filterDefined(last ? tslib_1.__spreadArray(tslib_1.__spreadArray([last], tslib_1.__read(target), false), [first], false) : tslib_1.__spreadArray([first], tslib_1.__read(target), false)), attr, overlapCfg === null || overlapCfg === void 0 ? void 0 : overlapCfg.margin).length) {
