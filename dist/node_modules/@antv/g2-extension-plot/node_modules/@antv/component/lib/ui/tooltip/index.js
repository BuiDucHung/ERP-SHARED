...
var Tooltip = /** @class */function (_super) {
    ...
    get: function () {
      ...
      return data.map(function (_a, idx) {
        var _b = _a.name,
          ...
          index = _a.index,
          rest = tslib_1.__rest(_a, ["name", "color", "index"]);
        var datum = tslib_1.__assign({
          name: name,
          color: color,
  ...
  Tooltip.prototype.renderCustomContent = function () {
    ...
    if (!content) return;
    if (typeof content === 'string') this.element.innerHTML = content;else (0, util_2.replaceChildren)(this.element, content);
  };
  /**
   * 更新 HTML 上的内容
   */
  ...
  Tooltip.prototype.getRelativeOffsetFromCursor = function (assignPosition) {
    ...
    finalPosition.forEach(function (pos) {
      var _a = tslib_1.__read(absolutelyOffset, 2),
        abs1 = _a[0],
        abs2 = _a[1];
      var _b = tslib_1.__read(positionScore[pos], 2),
        pos1 = _b[0],
        pos2 = _b[1];
  ...
  Tooltip.prototype.autoPosition = function (_a) {
    ...
    // 预期放置的位置
    var _e = tslib_1.__read([+cursorX + offsetX, +cursorY + offsetY], 2),
      expectLeft = _e[0],
      expectTop = _e[1];
    // 反方向
    var inversion = {
