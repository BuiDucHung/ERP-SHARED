...
var Option = /** @class */function (_super) {
  ...
  Option.prototype.renderLabel = function () {
    ...
    (0, util_1.select)(this.label).maybeAppend('.label', function () {
      return (0, util_1.renderExtDo)(label);
  ...
  Option.prototype.renderBackground = function () {
    ...
    this.background.attr(tslib_1.__assign(tslib_1.__assign({}, backgroundStyle), {
