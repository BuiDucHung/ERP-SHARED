...
var Scrollbar = /** @class */function (_super) {
  ...
  function Scrollbar(options) {
    ...
    _this.onTrackClick = function (e) {
      ...
      if (!slidable) return;
      var _a = tslib_1.__read(_this.getLocalPosition(), 2),
        x = _a[0],
        y = _a[1];
      var _b = tslib_1.__read(_this.padding, 4),
        top = _b[0],
        left = _b[3];
    ...
    _this.onThumbMouseenter = function (e) {
      _this.dispatchEvent(new g_1.CustomEvent('thumbMouseenter', {
        detail: e.detail
      }));
    };
    _this.onTrackMouseenter = function (e) {
      _this.dispatchEvent(new g_1.CustomEvent('trackMouseenter', {
        detail: e.detail
      }));
    };
    _this.onThumbMouseleave = function (e) {
      _this.dispatchEvent(new g_1.CustomEvent('thumbMouseleave', {
        detail: e.detail
      }));
    };
    _this.onTrackMouseleave = function (e) {
      _this.dispatchEvent(new g_1.CustomEvent('trackMouseleave', {
        detail: e.detail
      }));
    };
    return _this;
  ...
  Object.defineProperty(Scrollbar.prototype, "value", {
    get: function () {
      ...
      var _a = tslib_1.__read(this.range, 2),
        min = _a[0],
        max = _a[1];
  ...
  Object.defineProperty(Scrollbar.prototype, "trackLength", {
    get: function () {
      var _a = this.attributes,
        ...
        _b = _a.trackLength,
        trackLength = _b === void 0 ? viewportLength : _b;
      return trackLength;
    },
    enumerable: false,
    configurable: true
  ...
  Scrollbar.prototype.getValues = function (value) {
    ...
    var _a = this.attributes,
      viewportLength = _a.viewportLength,
      contentLength = _a.contentLength;
  ...
  Scrollbar.prototype.renderSlider = function (container) {
    ...
    var style = tslib_1.__assign(tslib_1.__assign({
      x: x,
      y: y,
      brushable: false,
    ...
    }, (0, util_2.superStyleProps)(trackStyle, 'track')), (0, util_2.superStyleProps)(selectionStyle, 'selection'));
    this.slider = (0, util_2.select)(container).maybeAppendByClassName('scrollbar', function () {
      return new slider_1.Slider({
        style: style
      });
    }).update(style).node();
  };
