...
var Sparkline = /** @class */function (_super) {
  ...
  Object.defineProperty(Sparkline.prototype, "data", {
    get: function () {
      if (this.attributes.isStack) return (0, utils_1.getStackedData)(this.rawData);
      return this.rawData;
    },
    enumerable: false,
    configurable: true
  ...
  Object.defineProperty(Sparkline.prototype, "baseline", {
    ...
    get: function () {
      var y = this.scales.y;
      var _a = tslib_1.__read(y.getOptions().domain || [0, 0], 2),
        y1 = _a[0],
        y2 = _a[1];
      if (y2 < 0) {
        return y.map(y2);
  ...
  Object.defineProperty(Sparkline.prototype, "linesStyle", {
    get: function () {
      ...
      var _b = this.scales,
        ...
        y = _b.y;
      // 线条Path
      var lines = (0, path_1.dataToLines)(data, {
        type: 'line',
        x: x,
        y: y
      });
      ...
      if (areaStyle) {
        ...
        if (isStack) {
          areas = smooth ? (0, path_1.linesToStackCurveAreaPaths)(lines, width, baseline) : (0, path_1.linesToStackAreaPaths)(lines, width, baseline);
        } else {
      ...
      return {
        lines: lines.map(function (line, idx) {
          return tslib_1.__assign({
            ...
            d: smooth ? (0, path_1.lineToCurvePath)(line) : (0, path_1.lineToLinePath)(line)
          }, lineStyle);
        }),
  ...
  Object.defineProperty(Sparkline.prototype, "columnsStyle", {
    get: function () {
      ...
      if (isStack) data = (0, utils_1.getStackedData)(data);
      var _b = this.createScales(data),
        x = _b.x,
        y = _b.y;
      var _c = tslib_1.__read((0, utils_1.getRange)(data), 2),
        minVal = _c[0],
        maxVal = _c[1];
  ...
  Sparkline.prototype.render = function (attributes, container) {
    ...
    (0, util_2.select)(container).selectAll('.spark').data([type]).join(function (enter) {
      return enter.append(function (type) {
        if (type === 'line') return new lines_1.Lines({
          className: className,
          style: style
        });
  ...
  Sparkline.prototype.createScales = function (data) {
    ...
    var _e = this.containerShape,
      width = _e.width,
      height = _e.height;
    var _f = tslib_1.__read((0, utils_1.getRange)(data), 2),
      minVal = _f[0],
      maxVal = _f[1];
