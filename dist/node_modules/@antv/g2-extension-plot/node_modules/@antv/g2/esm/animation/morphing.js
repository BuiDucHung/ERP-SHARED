...
function oneToOne(shape, from, to, timeEffect) {
  ...
  const fromKeyframes = Object.assign(Object.assign({}, attributeOf(from, attributeKeys)), {
    opacity: fromOpacity,
    strokeOpacity: fromStrokeOpacity,
    fillOpacity: fromFillOpacity
  });
  const toKeyframes = Object.assign(Object.assign({}, attributeOf(to, attributeKeys)), {
    opacity: toOpacity,
