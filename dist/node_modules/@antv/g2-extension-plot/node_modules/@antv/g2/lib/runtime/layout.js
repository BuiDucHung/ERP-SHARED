...
function computeLayout(components, options, theme, library) {
  ...
  if (size && !isTranspose && !labelTransform) {
    ...
    const adjustSide = (side, labelText, margin, padding) => {
      const labelWidth = (0, component_1.measureTextWidth)(labelText, {
        fontSize,
        fontFamily
      });
      ...
      if (diff > 0) {
        iw -= diff;
        if (side === 'left') pl += labelWidth / 2 - margin;else pr += labelWidth / 2 - margin;
      }
    };
...
function computeInset(components, options, theme, library) {
  ...
  const maxLabelSpacing = (0, d3_array_1.max)(styles, d => {
    var _a;
...
function createSection({
  ...
  const xySection = {
    top: [pl, 0, innerWidth, pt, 'vertical', true, d3_array_1.ascending, marginLeft, plotWidth],
    right: [width - pr, pt, pr, innerHeight, 'horizontal', false, d3_array_1.ascending],
    bottom: [pl, height - pb, innerWidth, pb, 'vertical', false, d3_array_1.ascending, marginLeft, plotWidth],
    ...
    'bottom-left': [pl, height - pb, innerWidth, pb, 'vertical', false, d3_array_1.ascending],
    'bottom-right': [pl, height - pb, innerWidth, pb, 'vertical', false, d3_array_1.ascending],
