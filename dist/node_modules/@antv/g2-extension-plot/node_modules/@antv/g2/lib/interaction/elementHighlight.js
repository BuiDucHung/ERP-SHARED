...
function elementHighlight(root, {
  ...
  state = {},
  region = false,
  regionEleFilter = el => utils_1.VALID_FIND_BY_X_MARKS.includes(el.markType) // some elements can not be highlighted by region, like shapes in pie.
}) {
  var _a, _b;
  ...
  const [appendLink, removeLink] = (0, utils_1.renderLink)(Object.assign({
    elements,
    valueof,
    link,
    coordinate
  }, (0, helper_1.subObject)(state.active, 'link')));
  const [appendBackground, removeBackground, isBackground] = (0, utils_1.renderBackground)(Object.assign({
    document: root.ownerDocument,
    scale,
    coordinate,
    background,
    valueof
  }, (0, helper_1.subObject)(state.active, 'background')));
...
function ElementHighlight(_a) {
  ...
  return (context, _, emitter) => {
    ...
    return elementHighlight(plotArea, Object.assign({
      ...
      regionGroupKey: createRegionGroup ? createRegionGroup(view) : (0, utils_1.createXKey)(view),
      coordinate,
      scale,
      state: (0, utils_1.mergeState)(options, [['active', background ? {} : {
        lineWidth: '1',
        stroke: '#000'
      }], 'inactive']),
      background,
