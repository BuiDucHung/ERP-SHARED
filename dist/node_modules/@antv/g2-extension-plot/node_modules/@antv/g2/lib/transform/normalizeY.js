...
const NormalizeY = (options = {}) => {
  ...
  return (I, mark) => {
    ...
    const Yn = Object.entries(rest).filter(([k]) => k.startsWith('y')).map(([k]) => [k, (0, helper_2.columnOf)(encode, k)[0]]);
    ...
    return [I, (0, util_1.deepMix)({}, mark, Object.assign({
      encode: Object.fromEntries(newYn.map(([k, v]) => [k, (0, helper_2.column)(v, (0, helper_2.columnOf)(encode, k)[1])]))
