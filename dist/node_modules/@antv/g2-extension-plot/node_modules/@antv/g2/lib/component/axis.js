...
function createFisheye(position, coordinate) {
  ...
  return tick => {
    if (!(0, coordinate_1.isFisheye)(coordinate)) return tick;
...
function createInset(position, coordinate) {
  if ((0, coordinate_1.isPolar)(coordinate)) return d => d;
...
function getData(scale, domain, tickCount, defaultTickFormatter, tickFilter, tickMethod, position, coordinate) {
  ...
  if ((0, coordinate_1.isPolar)(coordinate) || (0, coordinate_1.isTranspose)(coordinate)) {
    return filteredTicks.map((d, i, array) => {
      ...
      const shouldReverse = (0, coordinate_1.isRadial)(coordinate) && position === 'center' || (0, coordinate_1.isTranspose)(coordinate) && ((_b = scale.getTicks) === null || _b === void 0 ? void 0 : _b.call(scale)) && isHorizontal(position) || (0, coordinate_1.isTranspose)(coordinate) && isVertical(position);
      return {
...
function inferGrid(value, coordinate, scale) {
  if ((0, coordinate_1.isTheta)(coordinate) || (0, coordinate_1.isParallel)(coordinate)) return false;
...
const ArcAxisComponent = options => {
  const {
    ...
    rest = __rest(options, ["order", "size", "position", "orientation", "labelFormatter", "tickFilter", "tickCount", "tickMethod", "tickLength", "important", "style", "indexBBox", "title", "grid"]);
  return ({
    scales: [scale],
    value,
    coordinate,
    ...
    const finalStyle = (0, utils_1.adaptor)((0, util_1.deepMix)({}, axisTheme, axisArc, defaultStyle, Object.assign(Object.assign(Object.assign({
      type: 'arc',
      data: labels,
      titleText: (0, utils_1.titleContent)(title),
      grid,
...
function inferThemeStyle(scale, coordinate, theme, direction, position, orientation) {
  ...
  const positionStyle = ['top', 'right', 'bottom', 'left'].includes(position) ? theme[`axis${(0, helper_1.capitalizeFirst)(position)}`] : theme.axisLinear;
...
function inferDefaultStyle(scale, coordinate, theme, direction, position, orientation) {
  ...
  if (position === 'center') {
    return Object.assign(Object.assign(Object.assign(Object.assign({}, themeStyle), {
      ...
      titleSpacing: (0, utils_1.isVertical)(orientation) ? 10 : 0,
...
const LinearAxisComponent = options => {
  const {
    ...
    userDefinitions = __rest(options, ["direction", "important", "labelFormatter", "order", "orientation", "actualPosition", "position", "size", "style", "title", "tickCount", "tickFilter", "tickMethod", "tickLength", "transform", "indexBBox"]);
  return ({
    scales,
    value,
    coordinate,
...
const axisFactor = axis => {
  return options => {
    ...
    return context => {
      ...
      const labelFormatter = typeof useDefinedLabelFormatter === 'string' ? (0, d3_format_1.format)(useDefinedLabelFormatter) : useDefinedLabelFormatter;
