...
function applyDataTransform(I, mark, context) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    return [Array.isArray(transformedData) ? (0, array_1.indexOf)(transformedData) : [], Object.assign(Object.assign({}, mark), {
      data: newData
    })];
  });
}
...
function maybeVisualChannel(I, mark, context) {
  ...
  const newEncode = (0, array_1.mapObject)(encode, (channel, name) => {
    ...
    if (type !== 'constant' || (0, scale_1.isPosition)(name)) return channel;
...
function normalizeTooltip(I, mark, context) {
  ...
  if ((0, helper_1.isUnset)(tooltip)) return [I, mark];
...
function extractTooltip(I, mark, context) {
  ...
  const valueOf = item => {
    ...
    if ((0, helper_1.isStrictObject)(item)) {
      ...
      // Support d3-format.
      const normalizedValueFormatter = typeof valueFormatter === 'string' ? (0, d3_format_1.format)(valueFormatter) : valueFormatter;
      // Field name.
    ...
    if (typeof item === 'function') {
      ...
      for (const i of I) {
        ...
        if ((0, helper_1.isStrictObject)(v)) values[i] = Object.assign(Object.assign({}, v), {
          [exports.CALLBACK_ITEM_SYMBOL]: true
        });else values[i] = {
          value: v
        };
      }
...
function normalizedDataSource(data) {
  ...
  if ((0, util_1.isNumber)(data)) return {
    type: 'inline',
    value: data
  };
