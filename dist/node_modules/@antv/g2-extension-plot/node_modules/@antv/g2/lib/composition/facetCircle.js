...
const FacetCircle = () => {
  return options => {
    const newOptions = container_1.Container.of(options).call(facetRect_1.toCell).call(setEncode).call(facetRect_1.inferColor).call(setCoordinate).call(facetRect_1.setData).call(facetRect_1.setChildren, subLayoutFacetCircle, createGuideFacetCircle, createGuideFacetCircle, {
      frame: false
    }).call(facetRect_1.setAnimation).call(facetRect_1.setStyle).call(setScale).value();
    return [newOptions];
  };
};
