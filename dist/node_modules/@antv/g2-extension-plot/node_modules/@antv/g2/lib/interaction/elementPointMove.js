...
const getIntervalDataRatioTransformFn = element => {
  ...
  const isNormalizeY = (0, util_1.find)(transform, ({
    type
  }) => type === 'normalizeY');
...
function ElementPointMove(elementPointMoveOptions = {}) {
  ...
  return (context, _, emitter) => {
    ...
    const isTranspose = !!(0, util_1.find)(transform, ({
      type
    }) => type === 'transpose');
    const isPolar = coordinateType === 'polar';
    const isTheta = coordinateType === 'theta';
    const isArea = !!(0, util_1.find)(elements, ({
      markType
    }) => markType === 'area');
    if (isArea) {
        ...
        points.forEach((p, index) => {
          ...
          circle.addEventListener('mousedown', e => {
            ...
            const pointMousemove = e => {
              ...
              if (isArea) {
                ...
                if (isPolar) {
                  ...
                  const newPath = (0, utils_1.getPointsPath)([points[lastIndex], [newX, newY], seriesTitle[nextIndex] && points[nextIndex]]);
                  ...
                  const newPath = (0, utils_1.getPointsPath)([points[index - 1], [p[0], newCy], seriesTitle[index + 1] && points[index + 1]]);
                  labelShape.attr('text', ratioTransform(scaleY.invert(y)).toFixed(precision));
                  pathShape.attr('d', newPath);
                ...
                const newPath = (0, utils_1.getPointsPath)([points[index - 1], [p[0], newCy], points[index + 1]]);
            ...
            const mouseupFn = () => __awaiter(this, void 0, void 0, function* () {
              ...
              if ((0, util_1.isUndefined)(labelShape.attr('text'))) return;
        ...
        circle.addEventListener('mousedown', e => {
          ...
          const pointMousemove = e => {
            if (isTranspose) {
              ...
              const newPath = (0, utils_1.getPointsPath)([[newCx, points[0][1]], [newCx, points[1][1]], points[2], points[3]], true);
              ...
              const newPath = (0, utils_1.getPointsPath)([[points[0][0], newCy], [points[1][0], newCy], points[2], points[3]], true);
              labelShape.attr('text', ratioTransform(scaleY.invert(y)).toFixed(precision));
              pathShape.attr('d', newPath);
              circle.attr('cy', newCy);
            }
