...
function TreemapDrillDown(drillDownOptions = {}) {
  ...
  return context => {
    ...
    const drillDownClick = (path, depth) => __awaiter(this, void 0, void 0, function* () {
      ...
      if (depth) {
        ...
        drillTexts.forEach((item, index) => {
          // Last drillText
          if (index === (0, util_1.size)(drillTexts) - 1) return;
    ...
    const createDrillClick = e => {
      ...
      if (markType !== 'rect' && nodeName !== g_1.Shape.TEXT) return;
      const key = nodeName === g_1.Shape.TEXT && (0, util_1.get)(attributes, 'isTreemapLabel') === true ? keyofLabel(item) : keyofRect(item);
