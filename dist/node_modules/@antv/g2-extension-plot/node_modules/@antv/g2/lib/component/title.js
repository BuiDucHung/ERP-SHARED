...
const Title = (0, utils_2.createComponent)({
  render(attributes, container) {
    ...
    const mainTitle = (0, utils_2.maybeAppend)(container, '.title', 'text').attr('className', 'title').call(utils_1.applyStyle, Object.assign(Object.assign(Object.assign({}, inferStyleByAlign(0, 0, width, align)), {
      fontSize: 14,
      textBaseline: 'top',
      text: title
    }), titleStyle)).node();
    const bounds = mainTitle.getLocalBounds();
    (0, utils_2.maybeAppend)(container, '.sub-title', 'text').attr('className', 'sub-title').call(selection => {
...
const TitleComponent = options => {
  return ({
    ...
    return new Title({
      style: (0, util_1.deepMix)({}, theme.title, Object.assign({
        x,
        y,
        width,
        height
