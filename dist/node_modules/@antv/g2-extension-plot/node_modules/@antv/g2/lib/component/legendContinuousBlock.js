...
const LegendContinuousBlock = options => {
  return (...args) => (0, legendContinuous_1.LegendContinuous)(Object.assign({}, {
    block: true
  }, options))(...args);
};
exports.LegendContinuousBlock = LegendContinuousBlock;
exports.LegendContinuousBlock.props = Object.assign(Object.assign({}, legendContinuous_1.LegendContinuous.props), {
  defaultPosition: 'top',
