...
function useLibrary(namespace, publicLibrary) {
  ...
  const use = (options, context) => {
    ...
    if (!type) (0, helper_1.error)(`Plot type is required!`);
...
function documentOf(library) {
  ...
  return (canvas === null || canvas === void 0 ? void 0 : canvas.document) || (group === null || group === void 0 ? void 0 : group.ownerDocument) || (0, helper_1.error)(`Cannot find library document`);
}