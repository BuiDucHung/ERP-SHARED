...
const Treemap = (options, context) => {
  ...
  const treemapDrillDown = (0, util_1.get)(markOptions, ['interaction', 'treemapDrillDown']) || (0, util_1.get)(markOptions, ['marks', 0, 'interaction', 'treemapDrillDown']);
  // Layout
  ...
  return (0, util_1.deepMix)({}, GET_DEFAULT_OPTIONS(width, height), Object.assign(Object.assign({
    ...
    encode,
    tooltip: (0, mark_1.maybeTooltip)(tooltip, DEFAULT_TOOLTIP_OPTIONS),
    axis: false
  }), treemapDrillDown ? {
