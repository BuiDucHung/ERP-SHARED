...
exports.AXIS_HOT_AREA_CLASS_NAME = exports.AXIS_MAIN_CLASS_NAME = exports.AXIS_LINE_CLASS_NAME = exports.AXIS_CLASS_NAME = void 0;
...
;
  ...
  for (let i = 0; i < axes.length; i++) {
    ...
    const brushHandler = (0, brushHighlight_1.brush)(hotZone, Object.assign(Object.assign({}, brushStyle), {
      reverse,
      brushRegion,
      brushended(emit) {
...
function BrushAxisHighlight(options) {
  return (target, _, emitter) => {
    ...
    return brushAxisHighlight(container, Object.assign({
      ...
      state: (0, utils_1.mergeState)(viewOptions, ['active', ['inactive', {
        opacity: 0.5
      }]]),
      coordinate,
      emitter
