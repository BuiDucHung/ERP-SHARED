...
function partitionLayout(data, options = {}) {
  ...
  data.forEach(rootData => {
    ...
    const calculateLayout = (node, parentStartX = 0, isRootNode = false, parentWidth = 0) => {
      ...
      const sortedChildren = sort ? [...node.children].sort((a, b) => sort(a.data, b.data)) : node.children;
    ...
    const processNode = node => {
      ...
      return Object.assign(Object.assign({}, (0, util_1.pick)(node.data, [valueField])), {
        [exports.PARTITION_PATH_FIELD]: path,
        [exports.PARTITION_ANCESTOR_FIELD]: (_c = (_b = (_a = ancestorNode.parent) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b[nameField]) !== null && _c !== void 0 ? _c : node.data[nameField],
...
const Partition = options => {
  const {
    ...
    resOptions = __rest(options, ["encode", "data", "layout"]);
  const {
    fillParent = true,
    sort
  } = layout;
