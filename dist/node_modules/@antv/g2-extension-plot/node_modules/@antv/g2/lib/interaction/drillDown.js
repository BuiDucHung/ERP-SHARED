...
function DrillDown(drillDownOptions = {}) {
  ...
  return context => {
    ...
    const drillDownClick = path => __awaiter(this, void 0, void 0, function* () {
      ...
      setState('drillDown', viewOptions => {
        ...
        const newMarks = marks.map(mark => {
          if (mark.id !== partition_1.PARTITION_TYPE && mark.type !== 'rect') return mark;
    ...
    const createDrillClick = e => {
      ...
      if (markType !== 'rect' || partitionType !== partition_1.PARTITION_TYPE || !childNodeCount) {
        return;
      }
