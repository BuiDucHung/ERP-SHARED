...
const Image = (options, context) => {
  ...
  return (points, value, defaults) => {
    ...
    return (0, selection_1.select)(document.createElement('image', {})).call(utils_1.applyStyle, rest).style('x', x).style('y', y).style('src', src).style('stroke', color).style('transform', transform).call(utils_1.applyStyle, options).style('width', width).style('height', height).node();
  };
};
exports.Image = Image;
exports.Image.props = {
