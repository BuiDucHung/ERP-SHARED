...
function SliderFilter({
  initDomain = {},
  className = exports.SLIDER_CLASS_NAME,
  prefix = 'slider',
    ...
    for (const slider of sliders) {
      ...
      const domainsOf = event => {
        if (event.data) {
          ...
          return isX ? [(0, scale_1.domainOf)(scaleX, X, ratioX), (0, scale_1.domainOf)(scaleY, Y, ratioY)] : [(0, scale_1.domainOf)(scaleY, Y, ratioY), (0, scale_1.domainOf)(scaleX, X, ratioX)];
        }
        const {
          value: values
        } = event.detail;
      ...
      const emitHandler = event => {
        ...
        const V = isX ? (0, scale_1.sliderAbstractOf)(X, scaleX) : (0, scale_1.sliderAbstractOf)(Y, scaleY);
        setValue(slider, V);
      };
...
function createValueChangeHandler({
  ...
  return (0, util_1.throttle)(event => __awaiter(this, void 0, void 0, function* () {
    ...
    const {
      markDataPairs
    } = (0, utils_1.extractChannelValues)(view);
