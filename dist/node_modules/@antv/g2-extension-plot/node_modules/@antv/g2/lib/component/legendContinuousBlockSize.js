...
const LegendContinuousBlockSize = options => {
  return (0, legendContinuousSize_1.LegendContinuousSize)(Object.assign({}, {
    block: true
  }, options));
};
exports.LegendContinuousBlockSize = LegendContinuousBlockSize;
exports.LegendContinuousBlockSize.props = Object.assign(Object.assign({}, legendContinuous_1.LegendContinuous.props), {
  defaultPosition: 'top',
