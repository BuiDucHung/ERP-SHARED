...
const Box = () => {
  return (index, scale, value, coordinate) => {
    ...
    const P = Array.from(index, i => {
      ...
      const P13 = [[x - width / 2, high], [x + width / 2, high], [x, high], [x, q3],
      // idx = 3
      [x - width / 2, q3], [x + width / 2, q3], [x + width / 2, q1], [x - width / 2, q1], [x - width / 2, median],
      // idx = 8
      [x + width / 2, median], [x, q1],
      // idx = 10
      [x, low], [x - width / 2, low], [x + width / 2, low]];
...
exports.Box.props = {
  ...
  composite: false,
  shape,
  channels: [...(0, utils_1.baseGeometryChannels)({
