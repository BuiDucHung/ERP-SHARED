...
exports.inferColor = (0, utils_1.useOverrideAdaptor)(options => {
  ...
  const domainColor = () => {
    ...
    if (values.some(d => typeof d === 'number')) return [(0, d3_array_1.extent)(values)];
...
exports.setChildren = (0, utils_1.useOverrideAdaptor)((options, subLayout = subLayoutRect, createGuideX = createGuideXRect, createGuideY = createGuideYRect, childOptions = {}) => {
  ...
  const createChildren = (visualData, scale, layout) => {
    ...
    const maxDataDomain = shareData ? (0, d3_array_1.max)(facetData2d, data => data.length) : undefined;
    ...
    return index.flatMap(i => {
      ...
      return children.map(_a => {
        ...
        return Object.assign(Object.assign({
          ...
          scale: (0, util_1.deepMix)(defaultScale, scale, newScale),
          axis: (0, util_1.deepMix)({}, axis, newAxis),
...
function createInnerGuide(guide, data) {
  return data.length ? (0, util_1.deepMix)({
    title: false,
    tick: null,
    label: null
  }, guide) : (0, util_1.deepMix)({
    title: false,
    tick: null,
    label: null,
    grid: null
...
const FacetRect = () => {
  return options => {
    const newOptions = container_1.Container.of(options).call(exports.toCell).call(exports.inferColor).call(exports.setAnimation).call(setScale).call(exports.setStyle).call(exports.setData).call(exports.setChildren).value();
    return [newOptions];
  };
};
