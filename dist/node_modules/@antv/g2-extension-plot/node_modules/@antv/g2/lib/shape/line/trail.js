...
const Trail = (options, context) => {
  ...
  return (P, value, defaults) => {
    ...
    for (let i = 0; i < P.length - 1; i++) {
      ...
      if ([...p0, ...p1].every(helper_1.defined)) stroke(path, p0, p1, s0, s1);
    }
    return (0, selection_1.select)(document.createElement('path', {})).call(utils_1.applyStyle, rest).style('fill', color || defaultColor).style('d', path.toString()).call(utils_1.applyStyle, options).node();
  };
};
exports.Trail = Trail;
exports.Trail.props = Object.assign(Object.assign({}, curve_1.Curve.props), {
  defaultMarker: 'line'
});