...
const getElementsSunburst = plot => {
  return plot.querySelectorAll(".element").filter(item => (0, util_1.get)(item, ["style", sunburst_1.SUNBURST_TYPE_FIELD]) === sunburst_1.SUNBURST_TYPE);
};
...
function DrillDown(drillDownOptions = {}) {
  ...
  return context => {
    ...
    const drillDownClick = (path, depth) => __awaiter(this, void 0, void 0, function* () {
      ...
      setState("drillDown", viewOptions => {
        ...
        const newMarks = marks.map(mark => {
          if (mark.id !== sunburst_1.SUNBURST_TYPE && mark.type !== "rect") return mark;
          ...
          return (0, util_1.deepMix)({}, mark, isFixedColor ? {
            data: newData,
            scale: newScale
          } : {
            data: newData
    ...
    const createDrillClick = e => {
      ...
      if ((0, util_1.get)(item, ["style", sunburst_1.SUNBURST_TYPE_FIELD]) !== sunburst_1.SUNBURST_TYPE || (0, util_1.get)(item, ["markType"]) !== "rect" || !(0, util_1.get)(item, ["style", partition_1.CHILD_NODE_COUNT])) return;
