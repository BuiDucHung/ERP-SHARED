...
var Scrollbar = /** @class */function (_super) {
  ...
  function Scrollbar() {
    ...
    _this.bindLaterEvent = function () {
      ...
      if (_this.isMobile) {
        ...
        events = [dom_util_1.addEventListener(containerDOM, 'mousemove', _this.onMouseMove), dom_util_1.addEventListener(containerDOM, 'mouseup', _this.onMouseUp),
  ...
  Scrollbar.prototype.renderTrackShape = function (group) {
    ...
    var _c = util_1.deepMix({}, exports.DEFAULT_THEME, theme).default,
      lineCap = _c.lineCap,
      trackColor = _c.trackColor,
      themeSize = _c.size;
    var size = util_1.get(this.cfg, 'size', themeSize);
  ...
  Scrollbar.prototype.renderThumbShape = function (group) {
    var _a = this.cfg,
      ...
      thumbLen = _a.thumbLen,
      theme = _a.theme;
    var _b = util_1.deepMix({}, exports.DEFAULT_THEME, theme).default,
      themeSize = _b.size,
      lineCap = _b.lineCap,
