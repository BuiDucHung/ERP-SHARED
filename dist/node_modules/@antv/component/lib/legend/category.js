...
var Category = /** @class */function (_super) {
  ...
  Category.prototype.drawItemText = function (container, textName, cfg, item, itemHeight, xPosition, index) {
    ...
    }, textStyle), util_1.isFunction(style) ? style(item, index, this.getItems()) : style);
  ...
  Category.prototype.drawNavigation = function (group, layout, text, styleCfg) {
    ...
    var _a = util_1.get(styleCfg.marker, 'style', {}),
      _b = _a.size,
      size = _b === void 0 ? 12 : _b,
      arrowStyle = tslib_1.__rest(_a, ["size"]);
    ...
    var textShape = this.addShape(subGroup, {
      ...
      attrs: tslib_1.__assign({
        ...
        text: text,
        textBaseline: 'middle'
      }, util_1.get(styleCfg.text, 'style'))
    });
