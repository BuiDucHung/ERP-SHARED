...
exports.createMSkuDetails = void 0;
/**
 * @param {*} skuDetails 
 ...
 */
const createMSkuDetails = skuDetails => Object.values(skuDetails.reduce(groupByName, {})).map(toMSkuGroup);

/* Nhóm theo name, giữ lại id + value duy nhất */
exports.createMSkuDetails = createMSkuDetails;
